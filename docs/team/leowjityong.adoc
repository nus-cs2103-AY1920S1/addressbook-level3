...
developer guide to aid in the illustration of the key features I have implemented.
...
* *Code contributed*: https://nus-cs2103-ay1920s1.github.io/tp-dashboard/#search=&sort=groupTitle&sortWithin=title&since=2019-09-06&timeframe=commit&mergegroup=false&groupSelect=groupByRepos&breakdown=false&tabOpen=true&tabType=authorship&tabAuthor=jityong&tabRepo=AY1920S1-CS2103T-F11-3%2Fmain%5Bmaster%5D[Code]

* *Other contributions*:

** Project management:
*** Contributed to the implementation of the key encryption and decryption utility classes. (Pull request https://github.com/AY1920S1-CS2103T-F11-3/main/pull/36[#36])
** Enhancements to existing features:
*** Updated GUI with editable split planes. (Pull requests  https://github.com/AY1920S1-CS2103T-F11-3/main/pull/68[#68])
