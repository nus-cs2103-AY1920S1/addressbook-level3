...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + ANSWER_DESC_2 + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + RATING_DESC_1 + QUESTION_DESC_1 + TAG_DESC_FRIEND;
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        String userInput = targetIndex.getOneBased() + ANSWER_DESC_1 + RATING_DESC_1 + EMAIL_DESC_AMY
                + TAG_DESC_FRIEND + ANSWER_DESC_1 + RATING_DESC_1 + EMAIL_DESC_AMY + TAG_DESC_FRIEND
                + ANSWER_DESC_2 + RATING_DESC_2 + EMAIL_DESC_BOB + TAG_DESC_HUSBAND;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withAnswer(VALID_ANSWER_2)
                .withEmail(VALID_EMAIL_BOB).withRating(VALID_RATING_2).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
