...
The figure below shows the sequence diagram on what happens from a simple execution of `task shower -d 1.min.later` user command: +

image::AddTaskEventSequenceDiagram.png[]
