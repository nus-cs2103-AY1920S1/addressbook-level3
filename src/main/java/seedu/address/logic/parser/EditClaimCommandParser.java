...
import seedu.address.logic.commands.EditClaimCommand.EditClaimDescriptor;
...
public class EditClaimCommandParser implements Parser<EditClaimCommand> {
    ...
    public EditClaimCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_DESCRIPTION, PREFIX_CASH, PREFIX_NAME, PREFIX_TAG);
        ...
        try {
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, EditClaimCommand.MESSAGE_USAGE), pe);
        }
        ...
        return new EditClaimCommand(index, editClaimDescriptor);
    }
