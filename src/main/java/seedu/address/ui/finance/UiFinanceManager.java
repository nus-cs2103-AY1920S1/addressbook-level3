 ...
 */
public class UiFinanceManager implements Ui {

    public static final String ALERT_DIALOG_PANE_FIELD_ID = "alertDialogPane";

    private static final Logger logger = LogsCenter.getLogger(UiFinanceManager.class);
    private static final String ICON_APPLICATION = "/images/modulo.png";

    private Logic logic;
    private MainWindow mainWindow;

    public UiFinanceManager(Logic logic) {
        super();
        this.logic = logic;
    }
    ...
    private static void showAlertDialogAndWait(Stage owner, AlertType type, String title, String headerText,
        ...
        alert.getDialogPane().getStylesheets().add("view/finance/Finance.css");
