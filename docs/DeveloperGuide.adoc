...
|`* * *` |user |find a book by title |locate details of books without having to go through the entire list

|`* *` |user |hide <<private-contact-detail,private contact details>> by default |minimize chance of someone else seeing them by accident

|`*` |user with many books in the catalog |sort books by title |locate a book easily
|=======================================================================
