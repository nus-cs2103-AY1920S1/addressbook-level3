...
import static seedu.address.commons.core.Messages.MESSAGE_INVALID_SPENDING_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    public void setUp() {
        JsonAddressBookStorage addressBookStorage =
                new JsonAddressBookStorage(temporaryFolder.resolve("moneygowhere.json"));
