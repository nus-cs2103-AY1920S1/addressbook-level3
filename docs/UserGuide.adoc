...
Let's say you took a timed trial for Tao Li on 2nd November 2019 under the freestyle 50m event,
...
As seen in the orange box in the diagram below, Tao Li has index `3` in the active list. Hence, `3` is used
the the `INDEX`.
