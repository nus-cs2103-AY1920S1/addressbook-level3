...
Your likes and dislikes will be saved into your hard disk for your convenience.

To list your likes and dislikes, use the command without providing any arguments.
