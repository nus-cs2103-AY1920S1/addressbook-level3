...
The GUI should appear within a few seconds. Starting up, there should be no prior data pre-stored in the application.
The GUI should look like this:

.Initial GUI of PalPay
image::startingUp.png[]

. Your overall balance is reflected at the right bottom of PalPay window.
...
=== Settling Up with a Friend : `receive`
...
to display the remaining amount of budget. If you overspend beyond a set budget, the overspent budget will be displayed in red.
