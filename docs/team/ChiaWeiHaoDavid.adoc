...
this would yield varying effects on the application's overall speed performance. Ultimately, the design of the current implementation was chosen as it is relatively easy to implement and
...
Additionally, I added an extra Pastel color theme for users who prefer brighter themes (Pull request https://github.com/AY1920S1-CS2103T-F12-4/main/pull/104[#104])
