...
Format: `*delete* FROM_FOLDER​_NAME t/TO_FOLDER_NAME`

// How to use the command (what should you see) i.e. before/after
For example:

* You recently broke up, and want to edit the folder `Dear` containing all your previous memories to `Ex`.
+
