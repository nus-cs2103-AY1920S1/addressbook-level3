...
[TIP]
Information here are things the user can learn so that they have a faster experience with +Woork 
...
** Highlights: As of the latest release, the kbd:[shift] key will toggle the caret to make user interactions with the command line much quicker. 


* *Minor enhancement*:
** Created UI for the help page for new users to interact and understand +Work easily
...
** Project management
*** Set up the project management tool, Trello, at the start of the project to facilitate ease of communication and clear division of roles. 
...
** Documentation
*** Wrote parts of the +Work User Guide relating to https://github.com[Quick Start], https://github.com[Introduction] and https://github.com[Autocomplete].
*** Wrote parts of the +Work Developer Guide relating to https://github.com[Autocomplete] and https://github.com[Help]. 
