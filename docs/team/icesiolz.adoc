...
.Calendar Feature +
image::icesiolz/UG2.png[]

The calendar feature provides a more user friendly way to look at a list of events. Typing `show C` will bring up the calendar view.
