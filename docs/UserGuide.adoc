...
This is to ensure no one can tamper with the data in the inventory while a purchase is being made. If you wish to alter any
existing items in inventory, please enter the "clear" command on Cashier tab.
