...
.Snake game [EASY] of ELISA
image::SnakeGame.PNG[Snake, 600, 600]

+++<u>Rules:</u>+++

Control your snake by pressing the key commands `UP`, `DOWN`, `LEFT`, `RIGHT`. Bite your own tail or hit the walls and it will be GAME OVER!

There are 2 modes to this game: Easy and Hard. To access hard mode, simply type `game hard` in the command box or press the `H` key after you die!

.Snake game [HARD] of Elisa
image::snakegamehard.PNG[SnakeHard, 600, 600]

Hitting the `ESC` key will exit the game and return you to your list of tasks!
...
image::BeforePriority.PNG[600,600]
...
image::AfterPriority.PNG[600, 600]
