...
image::view-current.png[width="2000"]
...
image::view-main.png[width="2000"]

.Items in replenish list viewed
image::view-replenish.png[width="2000"]
...
image::delete-quantity.png[width="2000"]
...
image::set-reminder.png[width="2000"]
...
image::sort-date.png[width="2000"]
