...
* has a need to manage a significant number of bookmarks
...
|`* * *` |user |find a bookmark by name, URL or tag |locate details of bookmarks without having to go through the entire list
...
|`* * *` |user |auto tag a bookmark based on certain conditions (such as domain) |save time from tagging bookmarks from the same domain with the same tag

|`* * *` |user with many bookmarks |organise all the bookmarks in a folder structure |

|`* * *` |user |move a bookmark to a different folder |
...
|`* * *` |user |keep old offline copies |can still refer to them

|`* * *` |user |remove an specific offline copy |remove <<cache,cache>> that I no longer need

|`* * *` |user |highlight and annotate specific paragraphs in a bookmark |refer to my notes easily

|`* * *` |user |edit highlighting and annotations |

|`* * *` |user |remove highlighting and annotations |

|`* * *` |user |add reminders for a bookmark |remember to visit certain bookmarks at specified time

|`* * *` |user |edit a reminder |

|`* * *` |user |delete a reminder |

|`* * *` |user |export and import all the bookmark data |easily migrate to another computer

|`* *` |user |favorite a bookmark |
...
|`* *` |user |automatically clean up old or outdated bookmarks |
...
[discrete]
=== Use case 08: Make a bookmark available offline
...
=== Use case: UC09 - Browse

=== Use case: UC10 - Annotate offline documents
*MSS*
1. User requests to annotate document.
2. Mark shows annotated document.
+
Use case ends.

*Extensions*
* 1a. Mark detects invalid bookmark index.
** 1a1. Mark gives warning.
+
Use case ends.

* 1b. Mark detects invalid paragraph index.
** 1b1. Mark gives warning.
+
Use case ends.

* 1c. Mark detects invalid highlight colour.
** 1c1. Mark gives warning.
+
Use case ends.

* 2a. User requests to undo changes made to annotation.
** 2a1. Mark undoes most recent annotation.
+
Use case ends.
...
.  Should be able to hold up to 1000 bookmarks without a noticeable sluggishness in performance for typical usage.
