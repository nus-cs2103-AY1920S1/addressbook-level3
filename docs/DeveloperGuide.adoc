...
=== [underline]#`WordBank` Management Feature#
...
Alongside with word bank's data structure, they lay the foundation for the other complementary sections of WordBank Management.
...
_Pros:_ +
User's modification to their _WordBanks_ and _Cards_ requires very different methods. These two data structure
