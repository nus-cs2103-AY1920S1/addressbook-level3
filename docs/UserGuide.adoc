...
image::AssignCommandExample1.png[height="200", width="600"]
...
image::AssignCommandExample2.png[height="200", width="600"]
//end::assign[]
...
image::RemoveCommandExample1.png[height="200", width="600"]
...
image::RemoveCommandExample2.png[height="200", width="600"]
//end::remove[]
