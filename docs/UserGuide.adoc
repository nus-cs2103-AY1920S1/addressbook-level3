...
* Input `*annotate* 24 p/p1 n/summary of paragraph h/orange` into the command box (boxed in orange).

image::ui-screenshots/AddAnnotationCommandUi1.png[350,350]
// offline tab, showing result after   annotate 1 p/p2

* Observe that paragraph P2 is now highlighted orange and a note with content “summary of paragraph” is attached to it.

image::ui-screenshots/AddAnnotationCommandUi2.png[350,350]
