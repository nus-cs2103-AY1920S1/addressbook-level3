...
public class SortTaskCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        case 1:
            ...
            SortingOrder.setCurrentSortingOrderByAlphabeticalOrder();
            break;

        case 2:
            sortType = " increasing date/time.";
            SortingOrder.setCurrentSortingOrderByDate();
            break;

        case 3:
            sortType = "  whether tasks are done.";
            SortingOrder.setCurrentSortingOrderByDone();
            break;

        case 4:
            sortType = "  whether tasks are done and then by increasing date/time.";
            SortingOrder.setCurrentSortingOrderByDoneThenDate();
            break;
