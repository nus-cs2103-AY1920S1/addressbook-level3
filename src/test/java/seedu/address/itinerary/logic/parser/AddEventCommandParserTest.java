...
class AddEventCommandParserTest {
    ...
    public static final String TITLE_DESC_EVENT = " " + PREFIX_TITLE + VALID_TITLE_EVENT.toString();
    public static final String TITLE_DESC_EVENT2 = " " + PREFIX_TITLE + VALID_TITLE_EVENT2.toString();
    public static final String DATE_DESC_EVENT = " " + PREFIX_DATE + VALID_DATE_EVENT.getOriginalDate();
    public static final String DATE_DESC_EVENT2 = " " + PREFIX_DATE + VALID_DATE_EVENT2.getOriginalDate();
    public static final String TIME_DESC_EVENT = " " + PREFIX_TIME + VALID_TIME_EVENT.getOriginalTime();
    public static final String TIME_DESC_EVENT2 = " " + PREFIX_TIME + VALID_TIME_EVENT2.getOriginalTime();
    public static final String LOCATION_DESC_EVENT = " " + PREFIX_LOCATION + VALID_LOCATION_EVENT.toString();
    public static final String LOCATION_DESC_EVENT2 = " " + PREFIX_LOCATION + VALID_LOCATION_EVENT2.toString();
    public static final String DESCRIPTION_DESC_EVENT = " " + PREFIX_DESCRIPTION + VALID_DESCRIPTION_EVENT.toString();
    public static final String DESCRIPTION_DESC_EVENT2 = " " + PREFIX_DESCRIPTION + VALID_DESCRIPTION_EVENT2.toString();

    public static final String COMBINATION1 = TITLE_DESC_EVENT + DATE_DESC_EVENT + TIME_DESC_EVENT
            + LOCATION_DESC_EVENT + DESCRIPTION_DESC_EVENT;
    public static final String COMBINATION2 = TITLE_DESC_EVENT2 + DATE_DESC_EVENT2 + TIME_DESC_EVENT2
    ...
    public static final String INVALID_TIME_DESC = " " + PREFIX_TIME + "2450"; // Time not formatted correctly
    ...
    @Test
    public void all_fields_tag_null_pointer() {
