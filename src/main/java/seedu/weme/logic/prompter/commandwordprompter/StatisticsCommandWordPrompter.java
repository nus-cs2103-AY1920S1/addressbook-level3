...
/**
 * Prompt possible command word under statistics context.
 */
public class StatisticsCommandWordPrompter implements Prompter {
    @Override
    public CommandPrompt prompt(Model model, String arguments) throws PromptException {
        String similarCommands = findSimilarStrings(STATISTICS_COMMANDS, arguments);
