...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_USERNAME_DESC, Username.MESSAGE_CONSTRAINTS);// invalid un
        assertParseFailure(parser, "1" + INVALID_PASSWORD_DESC, Password.MESSAGE_CONSTRAINTS);// invalid pw
