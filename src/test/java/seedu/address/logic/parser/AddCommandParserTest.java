...
public class AddCommandParserTest {
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, QUESTION_DESC_1 + ANSWER_DESC_1,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_QUESTION_2 + ANSWER_DESC_2,
                expectedMessage);

        // missing answer prefix
        assertParseFailure(parser, QUESTION_DESC_2 + VALID_ANSWER_2,
                expectedMessage);


        // all prefixes missing
        assertParseFailure(parser, VALID_QUESTION_2 + VALID_ANSWER_2,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_QUESTION_DESC + ANSWER_DESC_2
                + CATEGORY_DESC_LOCATION + CATEGORY_DESC_HISTORY, Question.MESSAGE_CONSTRAINTS);

        // invalid answer
        assertParseFailure(parser, QUESTION_DESC_2 + INVALID_ANSWER_DESC
                + CATEGORY_DESC_LOCATION + CATEGORY_DESC_HISTORY, Answer.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, QUESTION_DESC_2 + ANSWER_DESC_2
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + QUESTION_DESC_2 + ANSWER_DESC_2
                + CATEGORY_DESC_LOCATION + CATEGORY_DESC_HISTORY,
