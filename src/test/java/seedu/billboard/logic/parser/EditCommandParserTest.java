...
import static seedu.billboard.logic.commands.CommandTestUtil.ADDRESS_DESC_BOB;
import static seedu.billboard.logic.commands.CommandTestUtil.EMAIL_DESC_AMY;
import static seedu.billboard.logic.commands.CommandTestUtil.EMAIL_DESC_BOB;
import static seedu.billboard.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static seedu.billboard.logic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
import static seedu.billboard.logic.commands.CommandTestUtil.INVALID_NAME_DESC;
import static seedu.billboard.logic.commands.CommandTestUtil.INVALID_PHONE_DESC;
...
import static seedu.billboard.logic.commands.CommandTestUtil.PHONE_DESC_BOB;
import static seedu.billboard.logic.commands.CommandTestUtil.TAG_DESC_FRIEND;
import static seedu.billboard.logic.commands.CommandTestUtil.TAG_DESC_HUSBAND;
...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditExpenseDescriptor descriptor = new EditExpenseDescriptorBuilder().withName(VALID_NAME_AMY)
                .withDescription(VALID_PHONE_BOB).withAmount(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditExpenseDescriptor descriptor = new EditExpenseDescriptorBuilder().withDescription(VALID_PHONE_BOB)
                .withAmount(VALID_EMAIL_AMY).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditExpenseDescriptorBuilder().withDescription(VALID_PHONE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // email
        userInput = targetIndex.getOneBased() + EMAIL_DESC_AMY;
        descriptor = new EditExpenseDescriptorBuilder().withAmount(VALID_EMAIL_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        EditExpenseDescriptor descriptor = new EditExpenseDescriptorBuilder().withDescription(VALID_PHONE_BOB)
                .withAmount(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        EditExpenseDescriptor descriptor = new EditExpenseDescriptorBuilder().withDescription(VALID_PHONE_BOB).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_PHONE_DESC + ADDRESS_DESC_BOB
                + PHONE_DESC_BOB;
        descriptor = new EditExpenseDescriptorBuilder().withDescription(VALID_PHONE_BOB).withAmount(VALID_EMAIL_BOB)
