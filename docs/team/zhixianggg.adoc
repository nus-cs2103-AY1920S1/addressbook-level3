...
** ~5k functional: https://nus-cs2103-ay1920s1.github.io/tp-dashboard/#search=zhixianggg
** 6k+ test: https://nus-cs2103-ay1920s1.github.io/tp-dashboard/#search=zhixianggg
...
** Project management:
*** Managed releases `v1.3.1`, `v1.3.2` and `v1.4.1` (3 releases) on GitHub
