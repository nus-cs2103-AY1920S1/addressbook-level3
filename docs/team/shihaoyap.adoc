...
test cases
(Pull requests https://github.com/AY1920S1-CS2103T-T11-3/main/pull/233[#233])
*** Assisted in implementing AddMin+ tab recognition, to reduce any unusual app behavior, optimise user experience by allowing
users to edit list on different tabs, as well as disallow certain commands depending on which tab the user is on.
