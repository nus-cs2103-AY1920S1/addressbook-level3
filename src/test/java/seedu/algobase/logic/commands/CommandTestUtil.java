...
public class CommandTestUtil {
    ...
    public static final String VALID_AUTHOR_AMY = "11111111";
    public static final String VALID_AUTHOR_BOB = "22222222";
    public static final String VALID_WEBLINK_AMY = "amy@example.com";
    public static final String VALID_WEBLINK_BOB = "bob@example.com";
    ...
    public static final String INVALID_AUTHOR_DESC = " " + PREFIX_AUTHOR + "911a"; // 'a' not allowed in authors
    public static final String INVALID_WEBLINK_DESC = " " + PREFIX_WEBLINK + "bob!yahoo"; // missing '@' symbol
    ...
    public static final EditCommand.EditProblemDescriptor DESC_AMY;
    public static final EditCommand.EditProblemDescriptor DESC_BOB;

    static {
        DESC_AMY = new EditProblemDescriptorBuilder().withName(VALID_NAME_AMY)
                .withAuthor(VALID_AUTHOR_AMY).withWeblink(VALID_WEBLINK_AMY).withDescription(VALID_DESCRIPTION_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditProblemDescriptorBuilder().withName(VALID_NAME_BOB)
                .withAuthor(VALID_AUTHOR_BOB).withWeblink(VALID_WEBLINK_BOB).withDescription(VALID_DESCRIPTION_BOB)
    ...
    /**
     * Updates {@code model}'s filtered list to show only the Problem at the given {@code targetIndex} in the
     * {@code model}'s algobase.
     */
    public static void showProblemAtIndex(Model model, Index targetIndex) {
