...
|===
||*Alternative 1:* Make extensions to `[green]#Athletick#` by storing and tagging each `[green]#Person#` with
...
|Allows storing of specific training information without depending on the `[green]#Athletick#`. This also allows new
