...
** Cons: Requires dealing with commands that have already been undone: We must remember to skip these commands. Violates Single Responsibility Principle and Separaifferent things.tion of Concerns as `HistoryManager` now needs to do two d
// end::undo/redo[]
