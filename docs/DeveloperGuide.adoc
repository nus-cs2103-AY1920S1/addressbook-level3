...
1.  User requests to delete a specific event from the already displayed list
...
2.  Horo replies that the Event has been added
...
* 4a. User decides the to Redo the added Event
+
[none]
** 3a1. Horo replies that the added Event has been redone
+
Use case ends
...
* Lack of visualization of the Events
