...
* *Minor enhancement*:
** Created the User Interface (UI) for members in +Work, which can include members' profile photos, as well as list tasks allocated to
...
image::GetStatisticsSequenceDiagram.png[width="600"]
...
image::MemberClassDiagram.png[width="500"]
...
image::SetImageActivityDiagram.png[width="500"]
