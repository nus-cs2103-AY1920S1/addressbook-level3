...
Displays the list of all spending with date range between `01/09/2019 and 30/09/2019`, tagged `groceries` and cost ranging from `20 to 100`. The entries are sorted by date in descending order (most recent on top).
