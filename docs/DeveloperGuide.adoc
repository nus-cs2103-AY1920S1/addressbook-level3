...
image::expense/developerguide/DoneEditExpenseCommandSequenceDiagram.png[title=Sequence diagram showing the execution of DoneEditCommand]
...
==== Aspect : Model
[[expense_class_diagram]]
image::expense/developerguide/CurrencyModelClassDiagram.png[title=Class diagram showing the currency model]
...
image::expense/developerguide/CurrencyUIClassDiagram.png[title=Class diagram showing the user interface of currency]
