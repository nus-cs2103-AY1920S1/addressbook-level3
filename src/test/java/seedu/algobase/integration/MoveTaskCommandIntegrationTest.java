...
public class MoveTaskCommandIntegrationTest {
    @TempDir
    ...
    @Test
    public void movetask_allConstraints() throws CommandException, ParseException {
        logicManager.execute("movetask task/1 from/1 to/2\n");
    }
}
