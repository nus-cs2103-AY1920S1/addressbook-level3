...
the category shown, as well as whether only expenditure/income items are shown. On startup, there is only
a month and year filter. This filter is generated based on the latest transaction you have recorded,
up to
