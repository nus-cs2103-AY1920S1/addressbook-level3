...
. You want to do an `add` command but carelessly type in `plus` instead and hit in Enter to execute.
+
image::step1.png[width="700", align="left"]
...
+
image::step2.png[width="700", align="left"]
[NOTE]
...
+
image::step3.png[width="700", align="left"]
...
+
image::step1Delete.png[width="700", align="left"]

. The result box informs you that they've deleted the custom command `plus`.
+
image::step2Delete.png[width="700", align="left"]
