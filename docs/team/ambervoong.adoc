...
====
* `undo`:  Dark red text with monospace font indicates that this text is a command or part of a command that can be entered into the CLI.
* `[purple]#GenReportCommand.java#`: Purple text in monospace font indicates a component, class, function or object in the application's architecture.
====
...
For instance, the [purple]`Body` class contains 16 fields. To make updating more efficient and easy to undo or redo, `update` makes use of special descriptors
to store the fields' values.

*Minor enhancement*: I added storage functionality for Mortago's entities.

** What it does: The storage functionality allows Mortago's [purple]`Body`, [purple]`Worker`, [purple]`Fridge`, and [purple]`Photo` objects to be stored on the user's
...
=== Code Contributed
You can view my code at the link here: https://nus-cs2103-ay1920s1.github.io/tp-dashboard/#search=&sort=groupTitle&sortWithin=title&since=2019-09-06&timeframe=commit&mergegroup=falsegroupSelect=groupByRepos&breakdown=false&tabOpen=true&tabType=authorship&tabAuthor=ambervoong&tabRepo=AY1920S1-CS2103T-T13-2%2Fmain%5Bmaster%5D[(via Reposense)]

=== Other contributions
Other contributions I have made to the team and the project are listed in this section, along with relevant links.

** Project management:
*** Maintained the issue tracker and project discussion board on GitHub (https://github.com/AY1920S1-CS2103T-T13-2/main/issues?q=is%3Aissue+is%3Aclosed[link to issue tracker], https://github.com/AY1920S1-CS2103T-T13-2/main/projects/1[link to discussion board])
*** Managed release `v1.2` on GitHub. (https://github.com/AY1920S1-CS2103T-T13-2/main/pull/88[#88])
** Enhancements to existing features:
*** Added storage functionality for Mortago's [purple]`Body`, [purple]`Worker`, [purple]`Fridge`, and [purple]`Photo` classes (Pull requests https://github.com/AY1920S1-CS2103T-T13-2/main/pull/128[#128], https://github.com/AY1920S1-CS2103T-T13-2/main/pull/91[#91])
** Documentation:
*** Wrote the UG and DG for the `undo`, `redo`, and `update` features (Pull requests https://github.com/AY1920S1-CS2103T-T13-2/main/pull/113[#113], https://github.com/AY1920S1-CS2103T-T13-2/main/pull/119[#119], https://github.com/AY1920S1-CS2103T-T13-2/main/pull/229/files[#229], https://github.com/AY1920S1-CS2103T-T13-2/main/pull/70[#70])
*** Morphed the AB3 User Guide for Mortago (https://github.com/AY1920S1-CS2103T-T13-2/main/pull/22[#22])
...
These sections of the Developer Guide explains to a developer how the undo/redo feature works, its architecture, and important considerations made during its design.
