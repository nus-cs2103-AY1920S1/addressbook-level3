 ...
 */
public class JsonAdaptedMcqFlashcard extends JsonAdaptedFlashcard {
    ...
    /**
     * Constructs a {@code JsonAdaptedMcqFlashcard} with the given flashcard details.
     */
    @JsonCreator
    public JsonAdaptedMcqFlashcard(@JsonProperty("question") String question,
     ...
     */
    public JsonAdaptedMcqFlashcard(McqFlashcard source) {
        super(source);
     ...
     */
    @Override
    public McqFlashcard toModelType() throws IllegalValueException {
        ...
        return new McqFlashcard(card.getQuestion(), modelChoices, card.getDefinition(), card.getTags(), card.getAnswer());
    }
}
