...
Allows you to navigate to different _pages_ (from any page), with the possible pages being:
...
IMPORTANT: The above commands can also be executed from the other _pages_.
