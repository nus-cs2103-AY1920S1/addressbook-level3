...
This feature allows you to assign tags to your expenses. Expenses with the same tag will be grouped together which allows you to search for related expenses easily.
