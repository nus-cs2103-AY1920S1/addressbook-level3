...
Typee is an engagement management application, where users can manage engagments and schedule accordingly. Our main users are targeted in corporation's receptionists and secretaries
...
* *Code contributed*: [https://github.com/nordic96/main[Functional code]] [https://github.com[Test code]]
