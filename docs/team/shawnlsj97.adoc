...
** Implemented sorting of the team list. (Pull request https://github
.com/AY1920S1-CS2103T-T12-3/main/pull/62[#62])
...
** Created style guide for diagrams for the team to adhere to. (https://docs.google
.com/presentation/d/1JprrBR5HnnOQio1M9YEgheEYldplHqL18q4IQCGqyMk/edit#slide=id.p[Link])
* Community:
