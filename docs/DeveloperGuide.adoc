...
[discrete]
=== Use case: Indicate that a doctor is on-duty and able to tend to patients (UC5)
...
[discrete]
=== Use case: Editing Information in GUI (UC6)
