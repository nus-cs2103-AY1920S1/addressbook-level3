...
*Value proposition*: Keep track of your contactNumber, orders and customers faster than a typical mouse/GUI driven app
...
|`* * *`|handphone seller|delete a contactNumber that I am no longer selling| get rid of it on the database.
...
[discrete]
=== Use case: Add new contactNumber (UC02)

*MSS*

1. Actor input contactNumber name and quantity.
...
[discrete]
=== Use case: Check quantity of contactNumber (UC03)

*MSS*

1. Actor requests to check stock of a contactNumber.
2. System displays the stock status for a contactNumber.

*Extensions*

[none]
* 1a. System is unable to find the contactNumber as it does not exist.
+
Use case ends.
[none]
** 1a1. System shows error message that contactNumber does not exist.
+
Use case resumes at step 1.
...
1. Actor requests to check stock of a contactNumber (UC03).
...
[[order]] Order::
A order consisting of customer and contactNumber
