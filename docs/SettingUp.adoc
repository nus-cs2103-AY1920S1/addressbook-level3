...
== Setting up $aveNUS in your computer
...
. Run the `seedu.savenus.Main` and try a few commands
...
When you are ready to start coding, we recommend that you get some sense of the overall design by reading about <<DeveloperGuide#Design-Architecture, $aveNUS's architecture>>.
//end::settingup[]
