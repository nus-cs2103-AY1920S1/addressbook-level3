...
|Whether to merge Graph and Statistics into one command
|Distinct Graph and Statistics commands +
...
|Merge Graph implementation with Statistics +
*Pros:* Reduces code duplication due to  similarity of implementation. +
*Cons:* Another parameter needed to ask user which mode he would like to view his statistics, whether in a pie chart or a graph.
Difficult to extend Graph feature in the future to behaviours that are distinct from Statistics.
