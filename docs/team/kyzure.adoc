...
|===
|_The following sections are an excerpt of my contribution to the User Guide to indicate my ability for writing readable help sections to the user._
|===
...
|===
|_The following sections are an excerpt of my contribution to the Developer Guide to showcase my prowess in the technical aspect of the project._
|===
