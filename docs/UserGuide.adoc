...
Uploads a PNG or JPG file to set as the display picture of the student at the specified index in the student list of the current class. +
This will prompt the user to select a PNG or JPG file from their computer to set as the new display picture of the student. +
