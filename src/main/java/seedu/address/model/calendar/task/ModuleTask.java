...
public class ModuleTask extends Task{
     ...
     * @param week
     */
    public ModuleTask(TaskTitle taskTitle, TaskDay taskDay, TaskDescription taskDescription, TaskDeadline taskDeadline, TaskTime taskTime, Set<TaskTag> taskTags, int week) {
