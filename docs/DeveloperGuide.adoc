...
:repoURL: https://github.com/kerwin97/main
...
|`* * *` |tutor |check the time I spent on preparing tutorial materials |ask for salary

|`* *` |forgetful tutor |be reminded before my tutorials |go for the tutorials on time
