...
** Pros: The logic of parsing in `IchiFundParser` is clearer.
...
While Alternative 2 is much simpler to implement, we decided to choose
Alternative 1 as it preserves the independence of `Logic` from `Ui`.
