...
*Pre-conditions*: Module and Tutorial already exists in the system.

*MSS*

1.  User requests to add a student
2.  T.A.rence adds the student
+
Use case ends.
...
[none]
* 1a. Module or tutorial doesn't exist.
** 1a1. T.A.rence shows an error message.
** 1a2. Use case resumrs at step 1.
+
Use case ends.
...
[none]
* 1a. Invalid module code is entered eg `CS101010`
** 1a1. T.A.rence shows an error message.
...
[none]
* 1a. Invalid Tutorial details entered such as invalid time `2500` or invalid day `Friyay`
** 1a1. T.A.rence shows an error message.
** 1a2. Use case resumes at setp 1.
...
1. User requests to view list of students in a particular tutorial.
2. T.A.rence displays list.
3. User specifies which student to be deleted.
4. T.A.rence deletes the selected student.
+
Use case ends.
...
[none]
* 3a. Student does not exist.
** 3a1. T.A.rence shows an error message.
...
1. User requests to view list of students for a particular tutorial
2. T.A.rence displays the list.
+
Use case ends.
...
.  Should be able to support up to 50 module and tutorial slots without a noticeable sluggishness in performance for typical usage.
.  A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.
.  Should be easily usable by a new TA.
.  Should work without requiring an Internet connection.
.  Application's functionalities  should be easily testable.
