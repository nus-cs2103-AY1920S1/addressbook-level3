...
team's attendance and performance. *Athletick* also features a calendar for coaches and captains to plan their
schedules, and supports the sorting, filtering, and finding of athletes in their database.
...
*Enhancement added (major):*  I added the ability to _add_, _delete_, and _view_ events and records.
