...
<<UG-NoShortcutexample>>, <<UG-NoShortcutResult>> shows what you can expect to see after typing in the example: `add_conagtact`.
[[UG-NoShortcutexample]]
[reftext="Figure 3.11.1"]
[caption="Figure 3.11.1: "]
.When a user enters an accidental typo
image::UG-NoShortcut1.png[width="800"]

[[UG-NoShortcutResult]]
[reftext="Figure 3.11.2"]
[caption="Figure 3.11.2: "]
...
[reftext="Figure 3.11.6"]
[caption="Figure 3.11.6: "]
...
You can delete a shortcut that you have created by using the delete income command by entering the keyword `delete_shortcut` followed by shortcut name.
