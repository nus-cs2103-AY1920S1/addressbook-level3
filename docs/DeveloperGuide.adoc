...
Athletick was developed as part of CS2103T, a software engineering module taken in the National University of Singapore.
We were tasked to morph a generic https://se-education.org/addressbook-level3/[address book application] that manages
contacts into an application that manages something else. At the end of the project, it should be ready to be
continued by future developers.
...
. **Friendlier Syntax**
+
In order to cater to beginner and experienced users of Athletick, we have provided shorter aliases for our command
words. This helps new users to use intuitive and self-explanatory commands, while advanced users can accomplish their
tasks more quickly with a shorter command syntax.
