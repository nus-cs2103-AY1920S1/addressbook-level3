...
The following sequence diagram shows how the `AddCommand` works and is the reference from <<GeneralLogicSD>>:
...
a filtered list. It is not initialised by a specific command parser as shown in as shown in <<GeneralLogicSD>>
