...
WARNING: All rules will be executed from the bottom of the list upwards.
Typically, this is order in which the rules were added.
...
Rules will be executed from the bottom of the list upwards.
