...
public class SampleDataUtil {
    public static Eatery[] getSampleEateries() {
        return new Eatery[]{
            new Eatery(new Name("Alex Yeoh"), new Address("Blk 30 Geylang Street 29, #06-40"),
                        getTagSet("friends")),
            new Eatery(new Name("Bernice Yu"), new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                        getTagSet("colleagues", "friends")),
            new Eatery(new Name("Charlotte Oliveiro"), new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                        getTagSet("neighbours")),
            new Eatery(new Name("David Li"), new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                        getTagSet("family")),
            new Eatery(new Name("Irfan Ibrahim"), new Address("Blk 47 Tampines Street 20, #17-35"),
                        getTagSet("classmates")),
            new Eatery(new Name("Roy Balakrishnan"), new Address("Blk 45 Aljunied Street 85, #11-31"),
