...
You can also choose whether to open the bookmark.
The default setting is open.

Format: `reminder INDEX t/TIME_DATE [d/DESCRIPTION] [n/NOTE=Open]`
...
Adds a reminder for bookmark 1, and set the time at 02/07/2019.
It will also open the bookmark for you.

* `reminder 1 t/2359 02/07/2019 n/Close` +
Adds a reminder for bookmark 1, and set the time at 23:59 of 02/07/2019.
The reminder would not open the bookmark for you.

* `reminder 1 t/2359 02/07/2019 d/Read announcements` +
Adds a reminder for bookmark 1, and set the time at 02/07/2019.
...
Format: `reminder edit INDEX [t/TIME_DATE] [d/DESCRIPTION] [n/NOTE]`
...
* DESCRIPTION is the description of the reminder that you want to edit.
* NOTE is the setting that you want to edit. It is whether you want to open the bookmark.

* `reminder edit 1 t/2359 02/07/2019` +
Edit reminder of bookmark in index 1. Reset the time of the reminder to 23:59 of 02/07/2019.

* `reminder 1 t/2359 02/07/2019 n/Close` +
Edit reminder of bookmark in index 1. Reset the time of the reminder to 23:59 of 02/07/2019.
Reset to not to open the bookmark.

* `reminder 1 t/2359 02/07/2019 d/Check daily news` +
Edit reminder of bookmark in index 1. Reset the time of the reminder to 23:59 of 02/07/2019.
Reset the description to check daily news.
...
* `reminder delete 1` +
Delete the reminder of the bookmark at index 1.
...
=== Autocomplete commands `[coming in v2.0]`
Auto-completes search for commands line if the command is unique.

=== Share bookmarks and notes via Email/ Telegram `[coming in v2.0]`
Shares your bookmarks and mots to your friends via Email or Telegram.
...
* *Reminder*: `reminder INDEX t/TIME_DATE [d/DESCRIPTION] [n/NOTE=Open]`
* *Reminder*: `reminder edit INDEX [t/TIME_DATE] [d/DESCRIPTION] [n/NOTE]`
