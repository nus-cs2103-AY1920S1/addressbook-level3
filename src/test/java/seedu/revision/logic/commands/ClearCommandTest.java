...
public class ClearCommandTest {
    ...
    public void execute_nonEmptyAddressBook_success() throws ParseException {
        Model model = new ModelManager(getMcqRevisionTool(), new UserPrefs(), new History());
        Model expectedModel = new ModelManager(getMcqRevisionTool(), new UserPrefs(), new History());
