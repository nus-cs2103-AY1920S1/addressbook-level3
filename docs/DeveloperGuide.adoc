...
.Object Diagram of `Plan` created by `AddPlanCommand` in Step 2
image::plan/PlanObjectDiagram.png
...
.Sequence Diagram for the execution of `FindPlanCommand`
image::plan/FindPlanSequenceDiagram.png
