...
public class MainWindow extends UiPart<Stage> {
    ...
    public MainWindow(Stage primaryStage, GameManager gameManager, CommandBoxHelper commandBoxHelper) {
    ...
    void fillInnerParts() {
        ...
        //Set up command box
        commandBox = new CommandBox(this::executeCommand, commandBoxHelper);
