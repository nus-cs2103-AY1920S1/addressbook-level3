...
view of their itinerary. For more budget-minded users, they are able to use the Optimise feature and optimises the schedule to make it conflict-free and at a low overall cost!
