...
of an integer. If it exceeds 2,147,483, 647, please key in a smaller quantity or checkout items separately.
...
1. To edit by index, enter the command with an index and description specified as shown in the screenshot below:
...
2. To edit by description, enter the required description and quantity as shown below:
