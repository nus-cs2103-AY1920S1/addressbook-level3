...
Friendly tip 1 :bulb: +
If you type `help` without any other parameters, a help window such as the one below will appear and display a command
list with similar instructions to this page!

[[UG-HelpWindow]]
[reftext="Figure 3.1.1"]
[caption="Figure 3.1.1: "]
.The help window that appears when the user asks for the default form of `help`
image::UG-HelpWindow.png[width="600"]
...
image::UG-HelpLocation.png[width="400"]
...
image::UG-BudgetExample2.PNG[width="800"]
