...
The ackAppointment command will mark the patient's the most upcoming appointment's status as Acknowledge when the patient is reaching and it will update `UniqueEventList` to display the rest appointments that are belong to the patient.
