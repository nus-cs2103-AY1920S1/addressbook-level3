...
by using the `recommend` command again (see <<Recommend>>).
...
==== Removing likes and dislikes from the recommendation system: `removelike` and `removedislike`
...
| Dislike <<Adding likes and dislikes to the recommendation system: `like` or `dislike`>>
...
| Info <<Info>>
| Displays the information of the command specified.
| Like <<Adding likes and dislikes to the recommendation system: `like` or `dislike`>>
| Specifies the user's liked categories, tags and locations
| List <<List>>
| List all saved food items
| Recommend <<Getting a list of recommended food items: `recommend`>>
| Recommend a food item, based on the user's budget.
| Redo <<Redo>>
| Redo a command a specified number of times.
| Removedislike <<Removing likes and dislikes from the recommendation system: `removelike` and `removedislike`>>
| Remove dislikes from the user's specified dislikes or clears the dislikes list
| Removelike <<Removing likes and dislikes from the recommendation system: `removelike` and `removedislike`>>
