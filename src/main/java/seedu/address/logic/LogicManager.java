...
import seedu.address.logic.parser.ExpiryDateTrackerParser;
...
public class LogicManager implements Logic {
    ...
    private final ExpiryDateTrackerParser expiryDateTrackerParser;

    public LogicManager(Model model, Storage storage) {
        this.model = model;
        this.storage = storage;
        expiryDateTrackerParser = new ExpiryDateTrackerParser();
    }
    ...
    public CommandResult execute(String commandText) throws CommandException, ParseException {
        ...
        Command command = expiryDateTrackerParser.parseCommand(commandText);
