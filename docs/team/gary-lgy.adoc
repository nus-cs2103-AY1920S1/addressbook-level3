...
** Highlights: This enhancement required extending all levels of the architecture: model and storage components were extended to support storing templates; UI was extended to display templates and the current meme creation session.
...
* *Minor enhancement*:
** Implement front-end for tabs [https://github.com/AY1920S1-CS2103-T16-3/main/pull/50[#50]]
