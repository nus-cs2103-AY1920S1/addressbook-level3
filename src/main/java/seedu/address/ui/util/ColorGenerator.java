...
public class ColorGenerator {
    private static ArrayList<String> listOfColors = new ArrayList<String>(List.of("#FF8A80", "#FF80AB", "#F06292", "#EA80FC",
            "#B388FF", "#8C9EFF", "#80D8FF", "#18FFFF", "#64FFDA", "#00E676", "#69F0AE", "#FFFF00", "#FFC400", "#FFAB40",
            "#FF9E80", "#90A4AE", "#BCAAA4", "66FCF1"));
