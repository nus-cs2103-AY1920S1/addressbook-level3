...
===== Aspect: Saving of image under Member (url or image object)

* **Alternative 1 (current choice):** Save the image file path under each member object
** Pros: Easy to implement, centralised class for all statistics
** Cons: May have performance issues due to calculations involving large amounts of tasks and members.
* **Alternative 2:** Save the image itself under each member object
