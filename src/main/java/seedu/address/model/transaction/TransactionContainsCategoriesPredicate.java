...
public class TransactionContainsCategoriesPredicate implements Predicate<BankAccountOperation> {
     ...
     */
    private boolean isCategoryInsideCategories(BankAccountOperation transaction, String keyCategory) {
        return transaction
                .getCategories()
                .stream()
                .anyMatch(category -> StringUtil.containsWordIgnoreCase(category.getCategoryName(), keyCategory));
    }
