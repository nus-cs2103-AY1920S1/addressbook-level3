...
The `Model` represents an encapsulation of all data in Jarvis. It is central
to the application as the `Ui` requires updates from the `Model` and `Logic`
requires `Model` to modify data. Shown below is the structure of the `Model`
component.
