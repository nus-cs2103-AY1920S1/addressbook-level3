    ...
    public static Password[] getSamplePasswords() {
        return new Password[] {
            new Password(new Description("Gmail"), new Username("Randomguy"),
                        new PasswordValue("password"), new ModifiedAt(new Date()), getTagSet("SocialMedia")),
            new Password(new Description("Gmail1"), new Username("Randomguy1"),
                        new PasswordValue("password1"), new ModifiedAt(new Date()), getTagSet("Work")),
            new Password(new Description("Gmail2"), new Username("Randomguy2"),
                        new PasswordValue("password2"), new ModifiedAt(new Date()), getTagSet("SocialMedia")),
            new Password(new Description("Gmail3"), new Username("Randomguy3"),
                        new PasswordValue("password3"), new ModifiedAt(new Date()), getTagSet("Game")),
            new Password(new Description("Gmail4"), new Username("Randomguy4"),
                        new PasswordValue("password4"), new ModifiedAt(new Date()), getTagSet("Help")),
        };
    }
