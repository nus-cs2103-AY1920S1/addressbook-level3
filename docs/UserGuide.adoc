...
=== Viewing help : `help`
Displays all commands available for this application. +
Format: `help`
...
MYMorise supports auto-complete feature (i.e. when you type `ad`, the program will auto-complete to `add` for you)
