...
image::Activity.png[Activity, 400, 400]
...
image::../images/InviteExample.png[InviteExample, 450, 400]

Step 2: Observe the output in result box and the activity details box.

image::InviteOutput.png[InviteOutput, 400, 400]
...
image::DisinviteExample.png[DisinviteExample, 300, 300]
...
image::DisinviteCommand.png[DisinviteCommand, 450, 400]

Step 2: Observe the output in result box and the activity details box.

image::DisinviteOutput.png[DisinviteOutput, 400, 400]
