...
image::tip.png[width = "80", float = "left"]
--
You will never have to worry about going over budget, as FinSec will warn you when that happens.
...
image::tip.png[width = "80", float = "left"]
--
Clicking on one of the data-points of any line will cause a tooltip similar to the one shown in the picture above to pop
up.
