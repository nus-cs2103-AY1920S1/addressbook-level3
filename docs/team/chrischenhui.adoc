...
= image:chrischenhui.png[width="140", height="12", align="left"] Chen Hui - Project Portfolio
...
. *User Commands*: +
Allows user to customise cards/word banks through `CardCommands` / `WordBankCommands`.

. *Drag and drop*: +
Allows user to export their word bank out of their computer simply by dragging it out of _Dukemon_. +
Likewise, it allows user to import a word bank file from their computer by dragging it into _Dukemon_.
...
features that builds on top of it. (statistics, game, settings)
...
** There exists multiple ways to design and implement word bank management. Throughout _Dukemon_'s development,
...
** Discussed with team member, Paul, who is in-charge of UI, on _Observer Pattern_ usage to display word banks and cards that automatically
update itself.

** Discussed with team member, Jason, on how I can best leverage his statistics feature to streamline my revision word bank implementation.
...
and design concepts such as _Observer Pattern_ and _MVC_ within cards and word banks.
...
*** Multiple user friendly word banks for user to try out. (pokemon, arithmetic, trivia, graph, cs2103t)
*** They are created on the first launch of _Dukemon_ (implemented through preferences.json file), and behaves like normal word bank. (Can be edited and removed)
...
*** Folders required for related files are created if not present.

=== Other contributions
* *Code contributed*:
** Overall: [https://github.com/AY1920S1-CS2103T-T11-2/main/commits?author=chrischenhui[All Commits]] [https://nus-cs2103-ay1920s1.github.io/tp-dashboard/#search=&sort=groupTitle&sortWithin=title&since=2019-09-06&timeframe=commit&mergegroup=false&groupSelect=groupByRepos&breakdown=false&tabOpen=true&tabType=authorship&tabAuthor=chrischenhui&tabRepo=AY1920S1-CS2103T-T11-2%2Fmain%5Bmaster%5D[RepoSense]]
** Functional:
...
*** Data for Dukemon: [https://github.com/AY1920S1-CS2103T-T11-2/main/blob/master/src/main/java/seedu/address/model/util/SampleDataUtil.java[Default data]]
...
* *Other contributions* :
** Discovered and fixed huge amount of bugs across different parts of _Dukemon_. [https://github.com/AY1920S1-CS2103T-T11-2/main/issues?page=1&q=is%3Aissue+is%3Aclosed+assignee%3Achrischenhui[Issues resolved by me]] [https://github.com/AY1920S1-CS2103T-T11-2/main/pull/185[Bugs fixed]]
...
*** Took the initiative to kick start the project when team members were not taking the project seriously.

//** Enhancements to existing features:
//*** Wrote additional tests for existing features to increase coverage from 88% to 92% (Pull requests https://github.com[#36], https://github.com[#38])

** *Documentation:*
*** Apart from my own section within UG, I wrote a major chunk of User Guide's skeleton for my teammates: [https://github.com/AY1920S1-CS2103T-T11-2/main/pull/100/files[UG heavy update 1]] [https://github.com/AY1920S1-CS2103T-T11-2/main/pull/128/files[UG heavy update 2]] [https://github.com/AY1920S1-CS2103T-T11-2/main/commit/5601a170c8fc889278a7a7cdb2c7b2f05b42ecbd[UG heavy update 3]]
...
*** Reported bugs in the form of issues for other teams in the class [https://github.com/chrischenhui/ped/issues[Njar]]

** *Tools:*
*** JUnit testing +
*** https://github.com/AY1920S1-CS2103T-https://www.netlify.com/-2/main/pull/218[Netlify]
...
{empty} [https://ay1920s1-cs2103t-t11-2.github.io/main/UserGuide.html#command-summary[Full command summary.]]
...
{empty} [https://ay1920s1-cs2103t-t11-2.github.io/main/DeveloperGuide.html#word-bank-s-data-structure-and-its-storage-system[Detailed implementation for Word bank's data structure and its
 storage system.]]
