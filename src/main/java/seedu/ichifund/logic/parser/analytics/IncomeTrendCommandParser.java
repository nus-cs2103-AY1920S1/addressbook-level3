 ...
 */
public class IncomeTrendCommandParser implements Parser<IncomeTrendCommand> {
     ...
     */
    public IncomeTrendCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_YEAR);

        if (!argMultimap.getPreamble().isEmpty()) {
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, IncomeTrendCommand.MESSAGE_USAGE));
        }
        Year year = null;
        ...
        return new IncomeTrendCommand(optionalYear);
    }
}
