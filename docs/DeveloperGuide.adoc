...
|`* * *` |competitive student |add some questions and answers that I have learnt today |read again and attempt it before exam
...
. Deleting a module while timetable is displayed
//.. Prerequisites: List all persons using the `list` command. Multiple persons in the list.
.. Test case: `delete CS2102` +
   Expected: Module is deleted from the timetable.
.. Test case: `delete CC2103` , module doesnt exist on the timetable +
