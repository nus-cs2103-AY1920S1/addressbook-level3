...
.Activity Diagram of state commit
...
Additionally, a state pointer that initially point to the end of cmdList will be maintain for Up(`&uarr;`)/Down(`&darr;`) key feature(See <<Up-Down-Feature>>)
...
Step 2. The user then execute the
