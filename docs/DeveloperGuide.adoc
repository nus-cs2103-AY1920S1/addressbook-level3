...
image::EditCommandActivity.png[width=400]
...
image::EditIncidentCommand.png[width=500]
...
image::addVehicleCommand.png[width=500]
...
image::deleteVehicleCommand.png[width=500]
//end::vehicledelete[]
