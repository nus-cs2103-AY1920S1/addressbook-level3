...
* View your main branch's deployed documentation on the site title given by Netlify (customizable as shown <<Changing the site title of your project, below>>).
+
image:netlify/temp_site_name.png[Temporary site title, width = 630]
+
...
== Changing the site title of your project
If you don't like the site title given by Netlify, you can change it as follows:

. Click on `Settings`.
+
. Then click `Change site title` and fill in your desired site title.
+
image:netlify/change_site_name.png[Change site title, width = 630]
