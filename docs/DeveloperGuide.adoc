...
=== Getting statistics
. Getting statistics
.. Prerequisites: Some questions with difficulty level easy and subject CS2040 have been answered
using the Quiz mode feature. There are no questions with difficulty level hard done.
.. Test case: `stats` +
Expected: The command result bar will show "Here are the statistics:"
All notes, tasks and questions will be hidden, a panel containing a pie chart will appear.
.. Test case: `stats d/easy s/cs2040` +
Expected: The command result bar will show "Here are the statistics: [easy] [cs2040]"
All notes, tasks and questions will be hidden, a panel containing a pie chart will appear.
.. Test case: `stats d/hard` +
Expected: Error details will be showm in the command result bar. The main window stays the same.
.. Test case: `stats d/easy d/hard` (more than one difficulty is provided) +
