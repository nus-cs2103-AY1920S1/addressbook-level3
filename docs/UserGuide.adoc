...
Format: `edit { [id/K0001] [n/NAME] [p/PHONE_NUMBER] [e/email] }`
...
* *Edit a borrower's particulars* : `edit { [id/BORROWER_ID] [n/NAME] [p/PHONE_NUMBER] [e/email] }` +
e.g. `edit id/K0001 p/91234567 e/jane@austen.com`
