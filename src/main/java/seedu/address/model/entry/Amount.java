...
public class Amount {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Amount should only contain numbers, "
            + "and it should be only 2 decimal points at maximum.\n"
            + "It should also non-zero and not be bigger than " + MAX_VALUE;
