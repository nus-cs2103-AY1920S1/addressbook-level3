...
EzWatchlist was built with ease in mind hence our interface represents this design philosophy.

.EzWatchlist graphical interface
...
Typing a command into the interface and entering it (by pressing kbd:[Enter] or clicking `_Go!_`) are the main way of interaction in the application.
