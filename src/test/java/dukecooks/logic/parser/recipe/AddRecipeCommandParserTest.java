...
public class AddRecipeCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        CommandParserTestUtil.assertParseSuccess(parser, CommandTestUtil.PREAMBLE_WHITESPACE + CommandTestUtil.NAME_DESC_BURGER
                 + CommandTestUtil.INGREDIENT_DESC_BURGER + CommandTestUtil.CALORIES_DESC_BURGER + CommandTestUtil.CARBS_DESC_BURGER + CommandTestUtil.FATS_DESC_BURGER
                 + CommandTestUtil.PROTEIN_DESC_BURGER, new AddRecipeCommand(expectedRecipe));

        // multiple names - last name accepted
        CommandParserTestUtil.assertParseSuccess(parser, CommandTestUtil.NAME_DESC_FISH + CommandTestUtil.NAME_DESC_BURGER
                + CommandTestUtil.INGREDIENT_DESC_BURGER + CommandTestUtil.CALORIES_DESC_BURGER + CommandTestUtil.CARBS_DESC_BURGER + CommandTestUtil.FATS_DESC_BURGER
                + CommandTestUtil.PROTEIN_DESC_BURGER, new AddRecipeCommand(expectedRecipe));
        ...
        Recipe expectedRecipeMultipleIngredients = new RecipeBuilder(BURGER)
                ...
                .build();
        CommandParserTestUtil.assertParseSuccess(parser, CommandTestUtil.NAME_DESC_BURGER + CommandTestUtil.INGREDIENT_DESC_BURGER + CommandTestUtil.INGREDIENT_DESC_FISH
                + CommandTestUtil.CALORIES_DESC_BURGER + CommandTestUtil.CARBS_DESC_BURGER + CommandTestUtil.FATS_DESC_BURGER
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.INVALID_FOOD_NAME_DESC + CommandTestUtil.INGREDIENT_DESC_BURGER
                + CommandTestUtil.CALORIES_DESC_BURGER + CommandTestUtil.CARBS_DESC_BURGER + CommandTestUtil.FATS_DESC_BURGER
                + CommandTestUtil.PROTEIN_DESC_BURGER, Name.MESSAGE_CONSTRAINTS);

        // invalid ingredient
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.NAME_DESC_BURGER + CommandTestUtil.INVALID_INGREDIENT_DESC
                + CommandTestUtil.CALORIES_DESC_BURGER + CommandTestUtil.CARBS_DESC_BURGER + CommandTestUtil.FATS_DESC_BURGER
                + CommandTestUtil.PROTEIN_DESC_BURGER, Ingredient.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.INVALID_FOOD_NAME_DESC + CommandTestUtil.INVALID_INGREDIENT_DESC
                        + CommandTestUtil.CALORIES_DESC_BURGER + CommandTestUtil.CARBS_DESC_BURGER + CommandTestUtil.FATS_DESC_BURGER
                        + CommandTestUtil.PROTEIN_DESC_BURGER, Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.PREAMBLE_NON_EMPTY + CommandTestUtil.NAME_DESC_BURGER + CommandTestUtil.INVALID_INGREDIENT_DESC
                        + CommandTestUtil.CALORIES_DESC_BURGER + CommandTestUtil.CARBS_DESC_BURGER + CommandTestUtil.FATS_DESC_BURGER + CommandTestUtil.PROTEIN_DESC_BURGER,
