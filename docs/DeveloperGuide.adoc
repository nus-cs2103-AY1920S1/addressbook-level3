...
[discrete]
=== Use case: UC2 - Checkout to a project to work on
...
[discrete]
=== Use case: UC05 - Store team members’ availability
...
[discrete]
=== Use case: UC06 - Generate time slot where all team members are available for meeting
