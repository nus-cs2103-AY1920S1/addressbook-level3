...
Our application, +Work, is a roject management tool aimed at NUS project leaders who are in charge of a small project
...
Shown down below are symbols that appear in my Project Portfolio, and their significance.
...
** Justification: This feature improves increases the functionality of +Work because it gives the user a broad overview of the project's progress and members' responsibility allocation at a glance. This makes it easier for the user to plan out future tasks and allocate them accordingly to members so that everyone has close to equal responsibility, which is one of the main goals of effective project management.
...
** What it does: This feature allows the user to add project members to +Work, so that he can keep track of and manage both project tasks and members in one application.
** Justification: This feature improves the product significantly because adds another aspect of project managmenet (member management) into +Work, and allows 
** Highlights: This enhancement affects existing commands and commands to be added in future. It required an in-depth analysis of design alternatives. The implementation too was challenging as it required changes to existing commands.
