...
A violation of the above will produce the following error message:
****
...
image::project2.png[]
+
. Should a transaction be deleted, the number of transactions being projected upon will fall below 5,
and thus, the projection will automatically be deleted.
+
