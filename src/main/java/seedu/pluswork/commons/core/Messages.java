package seedu.pluswork.commons.core;
...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_CALENDAR_MEMBER_NAME =
            "The member name provided does not match any calendar";
    public static final String MESSAGE_INVALID_MEMBER_ID = "The member id provided is invalid";
