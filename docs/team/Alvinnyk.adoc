...
* *Minor enhancement*: added a select command that allows the user to navigate each time slot on the schedule

** *Select Command*:
*** Allows the user to select any time slot on the schedule. It will generate a pop up window that shows the user
details of the time slot such as the event name, timings and the location on Google Maps.

** *Implemented Websocket*:
*** Allows the application to access external data sources such as NUSmods and GoogleMaps API.
...
*** Wrote tests for model and logic component and increased coverage by a total of 13% (Pull requests https://github.com/AY1920S1-CS2103T-T10-4/main/pull/257[#257], https://github.com/AY1920S1-CS2103T-T10-4/main/pull/262[#262], https://github.com/AY1920S1-CS2103T-T10-4/main/pull/266[#266])
...
include::../DeveloperGuide.adoc[tag=schedule-generator]
