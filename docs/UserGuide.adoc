...
the archive name of your choice so that you would be able to group your archived expenses into an appropriate archive.

[NOTE]
Do note that you would be *unable to edit archived expenses* as they are not considered current and "active" expenses. +
To edit an archived expense, you would need to *unarchive it first*.

The following are all the archive commands, descriptions of how they work and their usage.
You could view a list of all supported archive commands by typing `archive` and pressing enter.
...
Archives the expense at the 3rd index into an archive named “MBS casino winnings” +
{nbsp} +
...
This command allows you to view the expense list of a specified archive by
displaying the list of expenses in your specified archive. +
{nbsp} +
Usage:
...
+
[NOTE]
Do not that you do not need to prepend the archive prefix `arc/` to the archive name as there are no other
arguments (like index) to be entered for this command.
+
Example: +
`archive list 2018 expenses` +
Lists out all the expenses in the “2018 expenses” archive +
{nbsp} +
...
Deletes the expense at the 5th index in the “2018 expenses” archive +
{nbsp} +

. _Revert/unarchive an archived record: archive revert_ +
This command allows you to unarchive the expense at the specified index from your specified archive, transferring it back to your current list of expenses. +
...
Unarchives the expense at the 5th index in the “2018 expenses” archive +
{nbsp} +
// end::archive[]
