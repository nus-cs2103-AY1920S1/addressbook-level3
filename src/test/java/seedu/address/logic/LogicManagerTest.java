...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonExpenseListStorage addressBookStorage =
                new JsonExpenseListStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        JsonExpenseListStorage addressBookStorage =
                new JsonExpenseListIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionAddressBook.json"));
