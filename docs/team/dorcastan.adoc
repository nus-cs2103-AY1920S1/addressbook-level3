...
named Mark, which aims to help computing students manage their web browsing activities. Mark was conceptualised and
implemented over a period of 8 weeks. It is written in Java and has a Graphical User Interface (GUI) that was
...
** Justification
*** It is troublesome for users to have to manually tag similar bookmarks individually.
The autotag feature allows them to do so in a single step. They can also set up an autotagging system to categorise
