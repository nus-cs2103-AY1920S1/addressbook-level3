...
public CommandResult execute(Model model) throws CommandException {
    ...
    Person editedCustomer = createEditedPerson(personToEdit, editPersonDescriptor);
    if (!personToEdit.isSamePerson(editedCustomer) && model.hasPerson(editedCustomer)) {
        throw new CommandException(MESSAGE_DUPLICATE_PERSON);
    }
    model.setPerson(personToEdit, editedCustomer);
