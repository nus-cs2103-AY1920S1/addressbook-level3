...
public class TypicalIndexes {
    ...
    public static final Index INDEX_FIRST_MEALPLAN = Index.fromOneBased(1);
    public static final Index INDEX_SECOND_MEALPLAN = Index.fromOneBased(2);
    public static final Index INDEX_THIRD_MEALPLAN = Index.fromOneBased(3);
    public static final Index INDEX_FAILURE_MEALPLAN = Index.fromOneBased(20);
    ...
    public static final Index INDEX_THIRD_DASHBOARD = Index.fromOneBased(3);
}
