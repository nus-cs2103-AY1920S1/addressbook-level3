...
[TIP]
Use this to transfer any items tagged `#Expired` to your replenish list.
...
Transfers the 3rd item from the replenish list to the tracking list with expiry date `29/3/2020` and quantity `1`

* `shift|2|11/2/2020|4` +
Transfers the 2nd item from the replenish list to the tracking list with expiry date `11/2/2020` and quantity `4`
