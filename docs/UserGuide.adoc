...
.  Double-click the file to start the app. The User Interface (UI) should appear in a few seconds. ClerkPro is pre-loaded with sample data to allow you to explore and familiarize with the application.
+
image::Ui.png[]
+
