...
public class StudyPlanBuilder {
    ...
    public StudyPlanBuilder(StudyPlan studyPlanToCopy) {
        name = studyPlanToCopy.getName();
        phone = studyPlanToCopy.getPhone();
        email = studyPlanToCopy.getEmail();
        address = studyPlanToCopy.getAddress();
    ...
    /**
     * Sets the {@code Address} of the {@code StudyPlan} that we are building.
     */
    public StudyPlanBuilder withAddress(String address) {
        this.address = new Address(address);
        return this;
    }

    /**
     * Sets the {@code Phone} of the {@code StudyPlan} that we are building.
     */
    public StudyPlanBuilder withPhone(String phone) {
        this.phone = new Phone(phone);
        return this;
    }

    /**
     * Sets the {@code Email} of the {@code StudyPlan} that we are building.
     */
    public StudyPlanBuilder withEmail(String email) {
