 ...
 */
public class WorkoutPlannerWindow extends UiPart<Stage> {

    private static final String FXML = "WorkoutPlannerWindow.fxml";
    ...
    public WorkoutPlannerWindow(Stage primaryStage, Logic logic) {
