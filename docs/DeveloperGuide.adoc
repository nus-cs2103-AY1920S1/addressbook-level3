...
The Generate Schedule Feature is implemented to allow users to have an overview of all dates that has an event and the
...
they are representing. These DistinctDate Objects are then used, to create `DateCard` which will be displayed on the GUI.
...
image::GenerateScheduleClassDiagram.png[align="center", width = "300"]
