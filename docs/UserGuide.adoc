...
accurate recommendations with your preferences. Note: You can have any number
of categories, tags or locations
...
Example: `dislike c/Chinese c/Western t/Healthy l/Univeristy Town`
