...
|===
|_We had to update the original addressbook user guide to match our morphed application, ModuleBook. The following section are sections from my contribution to this task. They showcase my ability to write documentation targeting end-users._
|===
