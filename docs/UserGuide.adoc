...
* **`add_task`**`c/CS2103T Lecture mark/Y tt/20/90/2019 16:00, 20/90/2019 18:00` : adds a classId named CS2103T that is on 20th September 2019 4pm.
...
* Check both task list and reminder list to see if there is any task with same Class Id before add a new task.
****
