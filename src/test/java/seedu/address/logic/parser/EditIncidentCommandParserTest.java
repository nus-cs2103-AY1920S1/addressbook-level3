...
public class EditIncidentCommandParserTest {
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditIncident descriptor = new EditIncidentBuilder().withDistrict(VALID_DISTRICT)
                .withDesc(VALID_DESCRIPTION).build();

        EditIncidentCommand expectedCommand = new EditIncidentCommand(targetIndex, descriptor);
