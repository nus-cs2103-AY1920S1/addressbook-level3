...
When the rank feature is used, RankCommand interacts with other classes to return an athlete's report card. See the sequence diagram for a depiction of how RankCommand interacts with other classes.
