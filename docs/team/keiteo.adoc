...
exclusively using the keyboard. In addition, this is a desktop application, to be used only on a computer.

This is a 6-week software engineering project, where we worked in a team of 5 with students from the NUS School of Computing.
...
image::annotatedUi.png[width="1200"]

Please note the following symbol used in this document.
