...
Have you ever felt like there should be more kinds of flashcards you could create in order to learn different things? 
Unlike traditional pen-and-paper flashcards or even existing flashcard apps like Anki, FlashCard Pro supports flashcards that require you to complete code snippets, and even flashcards with multiple choices!
