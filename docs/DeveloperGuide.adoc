...
====
[.text-center]
_Class diagrams for various logic classes:_

image:CommandLogicClassDiagram.png[width="400"]
image:ProgramSubmissionLogicClassDiagram.png[width="400"]
image:NotesLogicClassDiagram.png[width="400"]
image:QuestionsLogicClassDiagram.png[width="400"]
====
...
image::CommandLogicManager.png[align="center" width="250"]
...
image::QuestionsLogicManager.png[align="center" width="200"]
...
image::ProgramSubmissionLogicManager.png[align="center" width="800"]
...
image::ProgramSubmissionSequence.png[align="center" width="800"]
...
image::NotesLogicManager.png[align="center" width="800"]
...
image::SketchManagerClassDiagram.png[align="center" width="200"]
...
image::NoteSavingSequence.png[align="center" width="800"]
...
The evaluation of a user's program is done in 4 main steps, each handled by a specialized interface. The 3 steps include:
...
The 3 specialized interfaces are `CompilerEnvironment`, `Compiler` and `ProgramExecutor`. They provided through dependency injection in the `TestExecutor` constructor.
...
image::CompilerEnvironment.png[align="center" width="800"]
...
image::Compiler.png[align="center" width="800"]
...
image::ProgramExecutor.png[align="center" width="800"]
...
image::TestExecutorSequenceDiagram.png[align:center width="800"]
