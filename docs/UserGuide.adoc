...
* Words in `UPPER_CASE` are the parameters to be supplied by the user e.g. in `addtx de/DESCRIPTION a/AMOUNT`, `DESCRIPTION` and `AMOUNT` are parameters which can be used as `addtx de/AirPods a/299.0`.
