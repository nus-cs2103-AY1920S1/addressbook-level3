...
=== Setting a reminder for an item: `set reminder`

Set a reminder threshold for the specified item +
...
* To delete a reminder, reset the reminder threshold to 0. e.g. `set reminder|1|0` will delete the reminder for item 1.
****
