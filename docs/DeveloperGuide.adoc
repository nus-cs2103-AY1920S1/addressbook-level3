...
| `* * *` | busy student  | exit the flashcard mode at any time  | perform other tasks  
...
| `* * *` | meticulous student | sort my subjects manner.  | study subjects in an orderly 
...
| `* * *` | meticulous student | a mock test timer to simulate exam situation | be prepared for my upcoming exams 
