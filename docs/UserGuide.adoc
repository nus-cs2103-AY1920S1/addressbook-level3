...
** _Details Tabs_  – shows details of a specific item
...
image::find_rule_1.png[width="70%"]
...
* `findsplan task/Sequences` +
Finds plans that contain a task names 'Sequences'.
// end::plan[]
...
image::gui/TabsOverview1.png[align="center", width=70%, scaledwidth=12cm]
...
image::gui/EditPlanUiAction0Annotated.png[align="center", width=70%, scaledwidth=12cm]
// tag::gui[]
...
image::gui/EditPlanUiAction1Annotated.png[align="center", width=70%, scaledwidth=12cm]
...
image::gui/EditPlanUiAction2Annotated.png[align="center", width=70%, scaledwidth=12cm]
...
image::gui/DeleteProblemUiAction0Annotated.png[align="center", width=70%, scaledwidth=12cm]
// tag::gui[]
...
image::gui/DeleteProblemUiAction1Annotated.png[align="center", width=70%, scaledwidth=12cm]

**Step 3:** Click on _Confirm_.

.The problem is successfully deleted.
image::gui/DeleteProblemUiAction2Annotated.png[align="center", width=70%, scaledwidth=12cm]
