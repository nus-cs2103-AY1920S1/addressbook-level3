...
This document serves as an overview of my contributions to the StudyBuddyPro project. Moreover,
...
fields to supplement their revision. StudyBuddyPro aims to consolidate
...
• There is a clear and concise description of
the application (X is a what that does
what…, includes mention of desktop
application and CLI in terms that a 3rd
