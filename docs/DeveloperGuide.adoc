...
* The Activity Diagram shown below will provide a visual representation of the two alternative Transaction routes
...
===== Aspect: Update can not edit Ledger Operations
...
*** Will require several conditional user inputs to differentiate between the various repeated entities that the user wishes to ammend.
// end::update[]
