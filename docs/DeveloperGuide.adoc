...
(ii) `BudgetListPanel`, which displays a list of `BudgetCard` -- called through `ListBudgetsCommand`;
...
[discrete]
=== Use case: Adding a budget and switching to it
