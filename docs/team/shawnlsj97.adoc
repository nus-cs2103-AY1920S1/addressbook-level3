...
the planning of training programmes in advance. The implementation was also challenging because it required the `[green]#Training#` and `[green]#Performance#` features to incorporate a date for the calendar to utilise and the construction of a calendar is complex.
...
** Updated the GUI layout and color scheme. (Pull request https://github.com/AY1920S1-CS2103T-T12-3/main/pull/68[#68], https://github.com/AY1920S1-CS2103T-T12-3/main/pull/87[#87], 
https://github.com/AY1920S1-CS2103T-T12-3/main/pull/201[#201])
* Documentation
...
** Came up with style guide for diagrams for team to adhere to. (https://docs.google.com/presentation/d/1JprrBR5HnnOQio1M9YEgheEYldplHqL18q4IQCGqyMk/edit#slide=id.p[Link])
* Community:
