...
image::TabCommandClassDiagram.png[width="550"]
...
[.text-center]
.Tab Class Diagram
image::TabClassDiagram.png[width="400"]
...
image::fetchTabInformationActivityDiagram.png[]
