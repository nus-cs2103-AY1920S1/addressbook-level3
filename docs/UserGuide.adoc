...
Insurelytics is a Command Line Interface (CLI) application for you to manage your contacts and policies. Here is a quick tutorial to help you get started using the application!
...
User can simply enter the command `redo` to redo the most recent undone address book change.
