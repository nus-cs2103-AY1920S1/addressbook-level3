...
public class TypicalAnswerables {
    ...
    // Manually added
    public static final Answerable H_ANSWERABLE = new AnswerableBuilder().withQuestion("Hoon Meier")
            .withDifficulty("1").withCorrectAnswerList(defaultCorrectAnswerList)
            .withWrongAnswerList(defaultWrongAnswerList).build();
    public static final Answerable I_ANSWERABLE = new AnswerableBuilder().withQuestion("Ida Mueller")
            .withDifficulty("1").withCorrectAnswerList(defaultCorrectAnswerList)
            .withWrongAnswerList(defaultWrongAnswerList).build();
