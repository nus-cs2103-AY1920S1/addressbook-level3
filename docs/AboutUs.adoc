...
Responsibilities: Intellij expert, Deliverables and deadlines, Scheduling and tracking, Documentation
...
Responsibilities: Git expert, Data modelling, Software Architecture
