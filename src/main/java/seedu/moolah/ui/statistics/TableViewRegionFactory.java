...
public class TableViewRegionFactory implements StatisticsRegionFactory {
    ...
    public TableView createRegion() {
        ...
        overlapAmountColumn.setCellValueFactory(cellData ->
                Bindings.format("%.2f",

                        cellData.getValue().getOverlapAmount()));
        ...
        differenceAmountColumn.setCellValueFactory(cellData ->
                Bindings.format("%.2f",

                        cellData.getValue().getDifferenceAmount()));
