 ...
 */
public class AssignMentorCommandParser implements Parser<AssignMentorCommand> {
     ...
     */
    public AssignMentorCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ...
        try {
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                    AssignMentorCommand.MESSAGE_USAGE), pe);
        }
        return new AssignMentorCommand(mentorId, teamId);
    }
}
