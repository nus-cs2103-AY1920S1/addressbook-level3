...
image::SortSequenceDiagram.png[Sort Sequence Diagram]
...
image::SortActivityDiagram.png[Sort Activity Diagram]
...
'''
[discrete]
=== UC09 Import external data from a CSV file
...
'''
[discrete]
=== UC10 Export data to a CSV file
