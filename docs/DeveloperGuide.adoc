...
=== Use case: [.underline]#UC2# Checkout to a project to work on

*MSS*
1. User requests to list projects
2. MyProject shows a list of projects
3. User request to switch to a project in the list to work on
4. MyProject swich to the project for the user.
+
Use case ends.
...
=== Use case: [.underline]#UC3# Edit Project
...
==Use case: [.underline]#UC03# Edit a member
*MSS*
1. User [.underline]#checkout to a project(UC02)#
...
==Use case: [.underline]#UC04# Send reminder
...
==Use case: [.underline]#UC05# Store team members’ availability
Actor: Team leader, team members
*MSS*
1. Team members send to user their respective timetable as a text file
2. User [.underline]#checkout to a project(UC02)#
3. Team leader store timetable for the respective team member
...
==Use case: [.underline]#UC06# Generate time slot where all team members are available for meeting
*MSS*
1. User [.underline]#stores all team members’ availability (UC4)#
