...
public class JsonAdaptedBudgetTest {
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedBudget budget =
                new JsonAdaptedBudget(INVALID_DESCRIPTION, VALID_AMOUNT,
                        VALID_START_DATE, VALID_END_DATE, VALID_PERIOD, VALID_EXPENSES, VALID_IS_PRIMARY, VALID_PROPORTION_USED);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        JsonAdaptedBudget budget =
                new JsonAdaptedBudget(null, VALID_AMOUNT,
                        VALID_START_DATE, VALID_END_DATE, VALID_PERIOD, VALID_EXPENSES, VALID_IS_PRIMARY, VALID_PROPORTION_USED);
    ...
    public void toModelType_invalidAmount_throwsIllegalValueException() {
        JsonAdaptedBudget budget =
                new JsonAdaptedBudget(VALID_DESCRIPTION, INVALID_AMOUNT,
                        VALID_START_DATE, VALID_END_DATE, VALID_PERIOD, VALID_EXPENSES, VALID_IS_PRIMARY, VALID_PROPORTION_USED);
    ...
    public void toModelType_nullAmount_throwsIllegalValueException() {
        JsonAdaptedBudget budget =
                new JsonAdaptedBudget(VALID_DESCRIPTION, null,
                        VALID_START_DATE, VALID_END_DATE, VALID_PERIOD, VALID_EXPENSES, VALID_IS_PRIMARY, VALID_PROPORTION_USED);
    ...
    public void toModelType_invalidStartDate_throwsIllegalValueException() {
        JsonAdaptedBudget budget =
                new JsonAdaptedBudget(VALID_DESCRIPTION, VALID_AMOUNT,
                        INVALID_START_DATE, VALID_END_DATE, VALID_PERIOD, VALID_EXPENSES, VALID_IS_PRIMARY, VALID_PROPORTION_USED);
    ...
    public void toModelType_nullStartDate_throwsIllegalValueException() {
        JsonAdaptedBudget budget =
                new JsonAdaptedBudget(VALID_DESCRIPTION, VALID_AMOUNT,
                        null, VALID_END_DATE, VALID_PERIOD, VALID_EXPENSES, VALID_IS_PRIMARY, VALID_PROPORTION_USED);
    ...
    public void toModelType_invalidEndDate_throwsIllegalValueException() {
        JsonAdaptedBudget budget =
                new JsonAdaptedBudget(VALID_DESCRIPTION, VALID_AMOUNT,
                        VALID_START_DATE, INVALID_END_DATE, VALID_PERIOD, VALID_EXPENSES, VALID_IS_PRIMARY, VALID_PROPORTION_USED);
        String expectedMessage = Timestamp.MESSAGE_CONSTRAINTS_DATE;
        assertThrows(IllegalValueException.class, expectedMessage, budget::toModelType);
    }
    ...
    public void toModelType_nullEndDate_throwsIllegalValueException() {
        JsonAdaptedBudget budget =
                new JsonAdaptedBudget(VALID_DESCRIPTION, VALID_AMOUNT,
                        VALID_START_DATE, null, VALID_PERIOD, VALID_EXPENSES, VALID_IS_PRIMARY, VALID_PROPORTION_USED);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT, Timestamp.class.getSimpleName());
        assertThrows(IllegalValueException.class, expectedMessage, budget::toModelType);
    }
    ...
    public void toModelType_invalidPeriod_throwsIllegalValueException() {
        JsonAdaptedBudget budget =
                new JsonAdaptedBudget(VALID_DESCRIPTION, VALID_AMOUNT,
                        VALID_START_DATE, VALID_END_DATE, INVALID_PERIOD, VALID_EXPENSES, VALID_IS_PRIMARY, VALID_PROPORTION_USED);
    ...
    public void toModelType_nullPeriod_throwsIllegalValueException() {
        JsonAdaptedBudget budget =
                new JsonAdaptedBudget(VALID_DESCRIPTION, VALID_AMOUNT,
                        VALID_START_DATE, VALID_END_DATE, null, VALID_EXPENSES, VALID_IS_PRIMARY, VALID_PROPORTION_USED);
    ...
    public void toModelType_invalidProportionUsed_throwsIllegalValueException() {
        JsonAdaptedBudget budget =
                new JsonAdaptedBudget(VALID_DESCRIPTION, VALID_AMOUNT,
                        VALID_START_DATE, VALID_END_DATE, VALID_PERIOD, VALID_EXPENSES, VALID_IS_PRIMARY, INVALID_PROPORTION_USED);
    ...
    public void toModelType_nullProportionUsed_throwsIllegalValueException() {
        JsonAdaptedBudget budget =
                new JsonAdaptedBudget(VALID_DESCRIPTION, VALID_AMOUNT,
                        VALID_START_DATE, VALID_END_DATE, VALID_PERIOD, VALID_EXPENSES, VALID_IS_PRIMARY, null);
