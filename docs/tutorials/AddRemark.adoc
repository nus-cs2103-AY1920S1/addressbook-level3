...
import seedu.address.addressModel.Model;
...
public class RemarkCommand extends Command {
    ...
    @Override
    public CommandResult execute(Model addressModel) {
...
----
    ...
    @Override
    public CommandResult execute(Model addressModel) throws CommandException {
...
Create a new `Remark` in `seedu.address.addressModel.person`. Since a `Remark` is a field that is similar to `Address`, we can reuse a significant bit of code.
