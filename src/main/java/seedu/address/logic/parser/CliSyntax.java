...
public class CliSyntax {
    ...
    public static final Prefix[] USER_PREFIXES = new Prefix[]{
        ...
        PREFIX_TAG, PREFIX_DESCRIPTION, PREFIX_COVERAGE, PREFIX_START_AGE, PREFIX_END_AGE, PREFIX_PRICE,
        PREFIX_CRITERIA, PREFIX_ON, PREFIX_OFF, PREFIX_INDICATOR, PREFIX_FORMAT, PREFIX_SECONDS, PREFIX_MINUTES,
        PREFIX_HOURS, PREFIX_DAYS, PREFIX_MONTHS, PREFIX_YEARS
    };
}
