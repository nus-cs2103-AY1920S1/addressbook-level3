...
==== Finding participations in a competition: `findParticipation`
Finds and lists all athletes in the participation list, who participate in a competition(s) with some keyword(s).

Format: `findParticipation [KEYWORD 1] ... [KEYWORD N]`

Examples:

* `findParticipation NUS Open 2019`
