...
image::newCommandAutoYBeforeSS.png[width="400"]

* Expected outcome: In this case, there is no vehicle available in district 1.

image::newCommandAutoYAfterSS.png[width="400"]
...
image::newCommandAutoNPromptSS.png[width="400"]

image::newCommandAutoNAfterPromptSS.png[width="400"]

image::newCommandAutoNAfterSS.png[width="400"]
...
image::findVDsBeforeSS.png[width="400"]
image::findVDsAfterSS.png[width="400"]
...
image::findVVnumBeforeSS.png[width="400"]
image::findVVnumAfterSS.png[width="400"]
...
image::findVVtypeBeforeSS.png[width="400"]
image::findVVtypeAfterSS.png[width="400"]
