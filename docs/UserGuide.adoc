...
* **`add`** `t/appointment s/09/11/2019/1200 e/09/11/2019/1330 l/NUS a/Jason|Harry d/Meeting on Monday p/HIGH` : Adds an engagement to the
engagements list with the following details: +
Engagement type: Appointment
Start time: 09/11/2019 at 1200 hours
End time: 09/11/2019 at 1330 hours
Location: NUS
Attendees: Jason and Harry
Descrption: Meeting on Monday
Priority: High
