...
image::clear.png[width="400"]

Format : `clear`

*What you should see*

image::afterclear.png[width="400"]
...
image::beforehelp.png[width="400"]
Format: `help`

*What you should see*

image::afterhelp.png[width="400"]
