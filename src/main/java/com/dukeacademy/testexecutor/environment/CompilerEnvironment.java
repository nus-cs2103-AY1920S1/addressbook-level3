...
public interface CompilerEnvironment {
     ...
     * @throws IncorrectCanonicalNameException if the canonical name derived
     * from the program does not match its source code.
     */
    JavaFile createJavaFile(UserProgram program) throws JavaFileCreationException,
     ...
     */
    JavaFile getJavaFile(String canonicalName) throws FileNotFoundException;
     ...
     */
    void clearEnvironment() throws ClearEnvironmentException;
