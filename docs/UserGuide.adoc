...
image::AddExerciseWithMuscle.png[]
...
2. `add t/exercise n/Run d/02/11/2019 c/200 q/10 u/km m/Legs r/8`
...
image::NullMessage.png[width="400"]
...
image::LongNamesTooltip.png[width="400"]
