...
[NOTE]
Users might experience some truncated detail on smaller laptop screens. As such, we advice users to not input
names with many characters, description, etc.

[IMPORTANT]
Ensure that your screen setting is set to a display size of 100%, as a higher setting might result in texts being cut off.
...
Displays the help window that allows users to view the list of commands available.
It also allows users to open up the user guide by clicking the `Guide` button within the help window.
...
image::HistoryUI.png[width=600, align="center"]
...
image::InfoEditUI.png[width=450, align="center"]
...
.Example of new food added into the app
image::addsuccess.png[align="center"]
...
.Example of listing all food items
image::listsuccess.png[align="center"]
...
.Example of edited food item
image::editsuccess.png[align="center"]
...
.Example of finding food
image::findsuccess.png[align="center"]
...
.Example of filtering food successfully
image::filtersuccess.png[align="center"]
...
.Example of deleting food sucessfully
image::deletesuccess.png[align="center"]
...
.Example of calling `clear` in the app.
image::clearsuccess.png[align="center"]
...
.Example of sorting the food items successfully
image::sortsuccess.png[align="center"]
...
.Example of success message when custom comparator successfully created.
image::makesortsuccess.png[align="center"]
...
.Example of successful custom sort
image::customsortsuccess.png[align="center"]
...
.Example of successful autosort.
image::autosortsuccess.png[align="center"]
...
.Example of success message when user request to view the custom comparator
image::viewsortsuccess.png[align="center"]
...
.Example of setting the food items in default order
image::defaultsuccess.png[align="center"]
...
image::wallet.png[width = "300", align="center"]
...
The savings account and the savings history is presented to the user in the display as shown in figure below.

.GUI display of $aveNUS
image::SavingsDisplay.png[align="center"]
...
image::SavingsAdded.png[width=450, align="center"]

.Example success message that appears after keying a successful saving.
image::SavingsSuccessMessage.png[width=450, align="center"]
...
==== Setting a savings target: `target` _(Coming in v2.0)_

Another feature that many students want is to set their personal savings target
in which they can be constantly be reminded of whenever they open up the application.
It can further encourage them to take up certain savings habits and cut down on certain unnecessary expenditures.

****
*Format*: `target AMOUNT [r/REASON] [by/DATE]` +
*Example*: `target 4000.00 r/For BTO by/06062019`

*Note*: +
`AMOUNT` cannot be a negative number.
`r/REASON` and `by/DATE` are optional fields.
****

[width="100%",cols="5%,95%", grid=none]
|===
ifdef::env-github[| :white_check_mark: a| You will see a success message in the Results Display]
ifndef::env-github[a| icon:check[role="green", size="2x"] a| You will see a success message in the Results Display and your target shall be updated below your Savings Account display in the UI.]

For example, executing `target 4000.00 r/For BTO by/06062019`, the following confirmation message shall appear: "Your savings target is
set at: $4000.00 For BTO expiring 6th June 2019".
...
[NOTE]
Only the date shall be entered, no time is required.

//tag::purchasing[]
=== Purchasing

.Example User's PurchaseHistory
image::PurchaseHistory.png[width=400, align="center"]
...
.Example of the recommend command displaying a list of recommendations
image::recommend.png[align="center"]
{empty}
|===
...
.Example success message that appears after listing likes or dislikes.
...
.Example success message that appears after adding likes.
...
.Example success message that appears after adding dislikes.
...
.Example success message that appears after removing likes.
...
.Example success message that appears after removing dislikes.
...
.Example success message that appears after clearing likes.
...
.Example success message that appears after clearing dislikes.
...
| ```show savings```
| <<Changing the application's theme: `theme`, `theme`>>
| Allows user to change the theme of the application.
| ```theme dark```
