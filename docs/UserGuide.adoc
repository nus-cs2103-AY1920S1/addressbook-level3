...
==== Add a member’s calendar: `import-calendar`
...
Using this command, you can toggle the theme of +Work between light and dark to suit your viewing preferences.
...
==== Switching the clock of +Work: `clock`

Using this command, you can toggle the clock format of +Work between 24 hour and 12 hour format.
By default, the clock format is set to 24 hour.

Note that this does not affect the input of deadlines
for tasks. They still need to be entered in 24 hour format.
...
* *Import calendar*: `import-calendar [mi/MEMBER_ID] [c/PATH_TO_ICS]` (Coming in v1.3)

* *Generate timings*: `generate-timings` (Coming in v1.3)

* *add meeting*: `add-meeting [at/ dd-mm-yyyy hh:mm - hh:mm]  [l/LOCATION]` (Coming in v1.3)
...
* *Switch to light theme*: `theme light` (Coming in v1.3)

* *Switch to dark theme*: `theme dark` (Coming in v1.3)

* *Switch to 12 hour clock*: `clock twelve` (Coming in v1.3)

* *Switch to 24 hour clock*: `clock twenty_four` (Coming in v1.3)
