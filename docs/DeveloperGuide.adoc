...
One of the ways that was initially considered was actually to maintain a running statistic
counter upon loading of the main app, update this counter when calculation is needed
and then display this counter. This implementation would have been easy to implement within the existing AB3 code
