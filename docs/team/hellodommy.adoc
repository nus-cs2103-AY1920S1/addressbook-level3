...
their schedules, and supports the _sorting_, _filtering_, and `searching` of athletes in their database.

Like Address Book, *Athletick* uses the command-line as its main method of input and a JavaFX Graphical User
Interface for display. Some constraints of the project were that it should _have a command-line input_, and
it should be _used by a single user only_. The full list of constraints can be found
...
https://nus-cs2103-ay1920s1.github.io/tp-dashboard/#search=&sort=groupTitle&sortWithin=title&since=2019-09-06&timeframe=commit&mergegroup=false&groupSelect=groupByRepos&breakdown=false&tabOpen=true&tabType=authorship&tabAuthor=hellodommy&tabRepo=AY1920S1-CS2103T-T12-3%2Fmain%5Bmaster%5D[[RepoSense]]
...
|===
|_Given below are extracts of sections I contributed to in the User Guide.
They showcase my ability to write documentation targeting end-users.
The full User Guide can be found
https://ay1920s1-cs2103t-t12-3.github.io/main/UserGuide.html[here].

My key contributions include the documentation for
https://ay1920s1-cs2103t-t12-3.github.io/main/UserGuide.html#deleting-an-athlete-code-delete-p-code[deleting an athlete],
https://ay1920s1-cs2103t-t12-3.github.io/main/UserGuide.html#performance[performance-related commands],
https://ay1920s1-cs2103t-t12-3.github.io/main/UserGuide.html#filtering-athletes-by-their-tags-code-filter-code[filtering]
and
https://ay1920s1-cs2103t-t12-3.github.io/main/UserGuide.html#finding-athletes-by-their-name-code-find-code[finding]
athletes._
|===
...
|===
|_Given below are extracts of sections I contributed to in the Developer Guide.
...
My key contributions include the documentation for the
https://ay1920s1-cs2103t-t12-3.github.io/main/DeveloperGuide.html#Design-Storage[Storage component],
https://ay1920s1-cs2103t-t12-3.github.io/main/DeveloperGuide.html#performance-feature[Performance
implementation] and
https://ay1920s1-cs2103t-t12-3.github.io/main/DeveloperGuide.html#filter-feature[Filter implementation]._
|===
