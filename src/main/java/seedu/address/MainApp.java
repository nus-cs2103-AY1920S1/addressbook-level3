...
public class MainApp extends Application {
    ...
    /**
     * Returns a {@code ModelManager} with the data from {@code storage}'s contacts book and {@code userPrefs}. <br>
     * The data from the sample contacts book will be used instead if {@code storage}'s contacts book is not found,
