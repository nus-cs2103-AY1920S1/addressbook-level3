...
public class JsonAdaptedEarningsTest {
    ...
    public void toModelType_invalidDate_throwsIllegalValueException() {
        JsonAdaptedEarnings earnings =
                ...
                VALID_AMOUNT, VALID_TYPE, VALID_CLAIM);
    ...
    public void toModelType_nullDate_throwsIllegalValueException() {
        JsonAdaptedEarnings earnings =
                new JsonAdaptedEarnings(null, VALID_CLASSID, VALID_AMOUNT, VALID_TYPE, VALID_CLAIM);
    ...
    public void toModelType_invalidType_throwsIllegalValueException() {
        JsonAdaptedEarnings earnings =
                new JsonAdaptedEarnings(VALID_DATE, VALID_CLASSID,
                        VALID_AMOUNT, INVALID_TYPE, VALID_CLAIM);
    ...
    public void toModelType_nullType_throwsIllegalValueException() {
        JsonAdaptedEarnings earnings =
                new JsonAdaptedEarnings(VALID_DATE, VALID_CLASSID, VALID_AMOUNT, null, VALID_CLAIM);
    ...
    public void toModelType_nullClassId_throwsIllegalValueException() {
        JsonAdaptedEarnings earnings =
                new JsonAdaptedEarnings(VALID_DATE, null, VALID_AMOUNT, VALID_TYPE, VALID_CLAIM);
    ...
    public void toModelType_invalidAmount_throwsIllegalValueException() {
        JsonAdaptedEarnings earnings =
                new JsonAdaptedEarnings(VALID_DATE, VALID_CLASSID,
                        INVALID_AMOUNT, VALID_TYPE, VALID_CLAIM);
    ...
    public void toModelType_nullAmount_throwsIllegalValueException() {
        JsonAdaptedEarnings earnings =
                new JsonAdaptedEarnings(VALID_DATE, VALID_CLASSID, null, VALID_TYPE, VALID_CLAIM);
    ...
    public void toModelType_invalidClaim_throwsIllegalValueException() {
        JsonAdaptedEarnings earnings =
                new JsonAdaptedEarnings(VALID_DATE, VALID_CLASSID,
                        VALID_AMOUNT, VALID_TYPE, INVALID_CLAIM);
    ...
    public void toModelType_nullClaim_throwsIllegalValueException() {
        JsonAdaptedEarnings earnings =
                new JsonAdaptedEarnings(VALID_DATE, VALID_CLASSID, VALID_AMOUNT, VALID_TYPE, null);
