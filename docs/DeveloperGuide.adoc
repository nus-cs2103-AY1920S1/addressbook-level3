...
implementation of the Parser and Command can be found below in Section 3: Implementation.

. `Logic` uses the `Parser` classes to parse the user command.
...
Specifics to how `Command` executes can be found within 3. Implementation, under the respective package.
