...
/**
 * Finds and lists all autoexpenses in guiltTrip with fields matching any of the predicates.
...
public class FindAutoExpenseCommand extends Command {
    ...
    /**
     * Filters the list of AutoExpenses by the conjuction of the existing predicates.
