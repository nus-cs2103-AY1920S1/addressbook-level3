...
public class ParserUtilTest {
    ...
    private static final String INVALID_USERNAME = "Big Daddy";
    private static final String INVALID_PASSWORD = "p@ss word";
    ...
    public void parseIndex_validInput_success() throws Exception {
        // No whitespaces
        assertEquals(INDEX_FIRST_ENTITY, ParserUtil.parseIndex("1"));
    ...
    public void parsePassword_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtil.parsePassword((String) null));
    }

    @Test
    public void parsePassword_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parsePassword(INVALID_PASSWORD));
    }
    ...
    @Test
    public void parsePassword_validValueWithWhitespace_returnsTrimmedPassword() throws Exception {
        String passwordWithWhitespace = WHITESPACE + VALID_PASSWORD + WHITESPACE;
        Password expectedPassword = new Password(VALID_PASSWORD);
        assertEquals(expectedPassword, ParserUtil.parsePassword(passwordWithWhitespace));
    }
