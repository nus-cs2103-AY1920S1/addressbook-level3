...
* Pros: More flexible. Furthermore, it can be implemented in a way that allows users to leave out the month and year information if they are referring to the current month and year. 
