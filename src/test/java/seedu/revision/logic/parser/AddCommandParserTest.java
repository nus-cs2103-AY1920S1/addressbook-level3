...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        String userInput = (PREAMBLE_WHITESPACE + QUESTION_TYPE_MCQ + QUESTION_DESC_BETA + DIFFICULTY_DESC_BETA
                + CORRECT_ANSWER_DESC + MCQ_WRONG_ANSWER_DESC + CATEGORY_DESC_UML);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + QUESTION_TYPE_MCQ + QUESTION_DESC_BETA
                + DIFFICULTY_DESC_BETA + CORRECT_ANSWER_DESC + MCQ_WRONG_ANSWER_DESC + CATEGORY_DESC_GREENFIELD
                + CATEGORY_DESC_UML, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));
    }
}
