...
A `Savings` object is instantiated in the `SaveCommand` with the user's input. It contains information about the how much `Money`
...
The following sequence diagram shows how the making of a savings works:
