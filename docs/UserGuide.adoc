...
****
* `AMOUNT` input accepts a non-negative value lesser than 1,000,000 of the expenditure.
...
****
* `AMOUNT` input accepts a non-negative value lesser than 1,000,000 of the income.
...
* `CATEGORY` accepts the CATEGORY for the budget. A budget can be created without any `CATEGORY`.
****
