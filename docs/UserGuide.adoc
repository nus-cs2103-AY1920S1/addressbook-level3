...
Adds an income of your personal finance to PalPay +
...
==== Example Usage
 ...
 Example 1: in $/120 d/31122019 n/work
...
image::in_ug_2.png[]
 ...
 Example 2: in $/500.50 n/allowance d/01012020 c/parents
...
==== Example Usage
 ...
 Example 1: out $/5 d/01012020 n/burger
...
image::out_ug_2.png[]
 ...
 Example 2: out $/1000 n/maintenance d/02012020 c/car c/transport
...
Updates the specified entry within PalPay. +

Format (Transactions): `update TYPE+INDEX [$/AMOUNT] [d/DATE] [n/ITEM] [c/CATEGORY]` +

Format (Budget): `update TYPE+INDEX [$/AMOUNT] [d/DATE] [n/ITEM] [c/CATEGORY]` +
...
* Ledger does not have an update function. If you need to change specific fields within a ledger entry, you should delete the target entry and recreate a new entry with your preferred fields.
*
