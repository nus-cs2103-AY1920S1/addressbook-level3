...
e.g. rename the tag `friends` to `buddies` (i.e. all foods who had the `friends` tag will now have
...
----
+
The above method can be used to get a printable string representing a bunch of food details.
