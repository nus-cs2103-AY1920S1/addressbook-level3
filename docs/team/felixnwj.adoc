...
{should a Introductory Statement(Aspect 1 Point 1) be included here?}
...
{Rubric says to list main features, but this is not indicated in Sample PPP. indicate here?}
