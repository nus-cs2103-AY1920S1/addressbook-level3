...
The Purchase Tracking feature was implemented with a new set of classes introduced to the Model.

===== PurchaseHistory

****
`PurchaseHistory` is a singleton class containing a `PurchaseHistoryList`.
****
