...
image::UpdateViewPanelActivityDiagram.png[790]
...
=== AllItemsList
. Updating the AllItemsList

.. Prerequisites: Current view is the main list.
.. Test case: `add|apple|09/09/2020` +
  Expected: `AllItemsList` should be updated to display the item under "tracking items".

.. Test case: `search|b` +
  Expected: `AllItemsList` should not be updated.
