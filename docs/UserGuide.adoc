...
image::tab_1_default.png[width="500"]
...
.pdf document sample
image::pdf_sample.png[width="480", align="center"]
...
image::pdf_delete.png[width="450", float="left"]
.pdf delete after clicking ok button
image::pdf_delete_after.png[width="450"]
