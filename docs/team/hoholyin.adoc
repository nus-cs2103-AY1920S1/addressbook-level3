...
This section shows a summary of my contributions to the team project and will include the
Major enhancement (Book feature), code contributed and other contributions I have made.
