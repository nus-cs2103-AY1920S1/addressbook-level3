...
[WARNING]
Due to size limitation, you will not be allowed to add any items into the cart if the total amount exceeds $9999. You
...
[WARNING]
The maximum amount you may set for a goal is 10,000,000 (10 million).
====
