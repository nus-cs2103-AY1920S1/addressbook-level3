...
:functionalCodeUrl: https://github.com/AY1920S1-CS2103-F10-3/main/tree/master/src/main/java/seedu/revision
:testCodeUrl: https://github.com/AY1920S1-CS2103-F10-3/main/tree/master/src/test
...
This 13-week project was started as part of NUS' Software Engineering (CS2103/T) module. The team was required to
...
* *Code contributed*: [link:{functionalCodeUrl}/[Functional Code, window=blank]] [link:{testCodeUrl}/[Test Code, window=blank]]
...
*** Created skeleton class for `AnswerableBuilder` using Java Generics and the factory class design so that other teammates will be able to build upon it easily (PR link:{pullUrl}/148[#148], link:{pullUrl}/149[#149])
