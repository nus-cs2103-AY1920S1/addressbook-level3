...
Step 4. The user decides that inviting the person was a mistake or the particular person has not been involved in any of the expenses in the activity. Therefore, it is perfectly fine to remove that person from the activity since he is not owing money to anyone and no one else owes him money.
...
NOTES: The activity diagram for the disinvite command is omitted as it is similar to the invite operation.
