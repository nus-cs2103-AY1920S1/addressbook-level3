...
public class CommandTestUtil {
    ...
    static {
        DESC_AMY = new EditSpendingDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_COST_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditSpendingDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_COST_BOB)
