...
We aim to improve the quality of life for teachers by assisting them with mundane daily administrative tasks.
...
** Wrote skeleton code for storage for others to reuse (Pull requests https://github.com/AY1920S1-CS2103T-W13-2/main/pull/35[#35])
* Community:
...
include::../UserGuide.adoc[lines=1025..1066]

*The following is an example of `Event` view section the User Guide:*

include::../UserGuide.adoc[lines=1070..1089]
...
include::../DeveloperGuide.adoc[lines=1315..1324]


*The following is the delete `Event` section of the Developer Guide:*

include::../DeveloperGuide.adoc[lines=1410..1429]

*The following is the index `Event` section of the Developer Guide:*

include::../DeveloperGuide.adoc[lines=1348..1386]
