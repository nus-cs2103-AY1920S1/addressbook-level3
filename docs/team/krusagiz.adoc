...
THRIFT is a fork from the original https://github.com/nus-cs2103-AY1920S1/addressbook-level3[AddressBook-Level3] application which allows users to create a personalised list of contacts.
...
_{End of extract from the section on proposed AI extension}_
