...
* View your main branch's deployed documentation on the site exerciseName given by Netlify (customizable as shown <<Changing the site exerciseName of your project, below>>).
+
image:netlify/temp_site_name.png[Temporary site exerciseName, width = 630]
+
...
== Changing the site exerciseName of your project
If you don't like the site exerciseName given by Netlify, you can change it as follows:

. Click on `Settings`.
+
. Then click `Change site exerciseName` and fill in your desired site exerciseName.
+
image:netlify/change_site_name.png[Change site exerciseName, width = 630]
