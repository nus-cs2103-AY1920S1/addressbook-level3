...
public class Amount {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Amount should contain only digits, "
            + "and have only 2 decimal points.\n"
            + "It should be more than zero but not bigger than " + MAX_VALUE;
