...
The diagram below shows a simplifed execution sequence of a 'find t/Animal Farm a/George'.
...
image:BookPredicateEmptyObjectDiagram.png[height="300"]
image:BookPredicateFilledObjectDiagram.png[height="300"]
