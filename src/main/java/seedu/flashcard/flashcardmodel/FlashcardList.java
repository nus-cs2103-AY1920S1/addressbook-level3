...
import seedu.flashcard.flashcardmodel.flashcard.*;

/**
 * The list of all flashcardmodel list, meanwhile, holding the {@Code TagManager}
 */
public class FlashcardList {
    ...
    /**
     * Fetch the particular flashcardmodel based on its id number
     * @param flashcardId the id number of the flashcardmodel we are looking for
     * @return the flashcardmodel with this id number
     * @throws CardNotFoundException if flashcardmodel with this number was not found
     */
    ...
    /**
     * Edit the question on a particular flashcardmodel
     * @param flashcardId the id number of the flashcardmodel we want to edit
     * @param newQuestion the updated question for the target flashcardmodel
     */
    ...
    /**
     * Edit the answer on a particular flashcardmodel
     * @param flashcardId the id number of the flashcardmodel we want to edit
     * @param newAnswer the updated answer for the target flashcardmodel
     */
     ...
     * @param flashcardId the id number of the flashcardmodel we want to edit
     * @param newOptions the updated options for the target flashcardmodel
    ...
    /**
     * Look up for a flashcardmodel whose id number, question or answer contains this specific keyword
    ...
    /**
     * delete the flashcardmodel based on its id
     * @param flashcardId the id of the flashcardmodel we want to delete
     */
     ...
     * @param question the question of the flashcardmodel
     * @param options the options of the flashcardmodel
     ...
     * @param question the question of the flashcardmodel
     * @param answer the options of the flashcardmodel
     */
    ...
    /**
     * Give the target flashcardmodel a tag. If this tag currently does not exist, create a new one in the TagManager
     * @param flashcardId the flashcardmodel to be tagged
     * @param tagName the tag to be added to the flashcardmodel
     */
