...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        FlashCard expectedFlashCard = new PersonBuilder(NUS).withTags(VALID_CATEGORY_LOCATION).build();
        ...
        FlashCard expectedFlashCardMultipleCategories = new PersonBuilder(NUS).withTags(VALID_CATEGORY_LOCATION, VALID_CATEGORY_HISTORY)
                .build();
