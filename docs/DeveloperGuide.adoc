...
* 2a. The user provided an incorrect or wrong url
+
...
1.  User requests to edit bookmarks
2.  Mark shows a list of bookmarks
...
[discrete]
=== Use case: Make a webpage available offline
