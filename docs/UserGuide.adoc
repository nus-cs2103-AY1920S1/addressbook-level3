...
may want to start by adding your photos to display in the gallery (<<diary_gallery_display, Section 3.9.2.2, “Gallery Display”>>).
...
* Arguments:
** `<file path>` - Relative file path from the location of the _TravelPal's_ jar file, or an absolute file path. (see <<glossary, Section 5, “Glossary”>> for details of relative and absolute file paths)
...
.. Additionally, there will be a auto-generated photo numbering, for use as described in <<diary_text_displaying_images, Section 3.9.4.2, “Displaying images”>>.
...
* Usage: Clicking the `Add` button located under the gallery display area ( <<diary_gallery_button_bar, Section 3.9.2.5, “Gallery Button Bar”>>) will open your
