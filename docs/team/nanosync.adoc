...
Listed below are sections I contributed to the User Guide, which includes the Flexible Date Formats, Find and Sort section. It showcases my ability to write documentation targeting end-users.
