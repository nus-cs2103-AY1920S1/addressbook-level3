...
This feature depicts most core features of 'LiBerry' in the form of a condensed PDF, which is further explained below.
...
* This feature aids the librarian in retrieving more information about a book when a borrower inquires about it.
