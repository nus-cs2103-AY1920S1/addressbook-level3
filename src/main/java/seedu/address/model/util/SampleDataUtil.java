...
public class SampleDataUtil {
    public static Employee[] getSampleEmployees() {
        return new Employee[] {
            ...
            new Employee(new EmployeeId(), new EmployeeName("William F"), new EmployeeGender("male"),
                    new EmployeePay("20"), new EmployeePhone("87128807"),
                    new EmployeeEmail("ggg@example.com"),
                    new EmployeeAddress("Blk 30 GGG Street 99, #06-40"),
                    new EmployeeJoinDate(LocalDate.now()), getTagSet("fun")),
            new Employee(new EmployeeId(), new EmployeeName("James Bond"), new EmployeeGender("male"),
                    new EmployeePay("20"), new EmployeePhone("87128807"),
                    new EmployeeEmail("ggg@example.com"),
                    new EmployeeAddress("Blk 30 GGG Street 99, #06-40"),
                    new EmployeeJoinDate(LocalDate.now()), getTagSet("fun")),
            new Employee(new EmployeeId(), new EmployeeName("Benjamin Gan"), new EmployeeGender("male"),
                    new EmployeePay("20"), new EmployeePhone("87128807"),
                    new EmployeeEmail("ggg@example.com"),
                    new EmployeeAddress("Blk 30 GGG Street 99, #06-40"),
                    new EmployeeJoinDate(LocalDate.now()), getTagSet("fun")),
            new Employee(new EmployeeId(), new EmployeeName("Jacob"), new EmployeeGender("male"),
                    new EmployeePay("20"), new EmployeePhone("87128807"),
                    new EmployeeEmail("ggg@example.com"),
                    new EmployeeAddress("Blk 30 GGG Street 99, #06-40"),
                    new EmployeeJoinDate(LocalDate.now()), getTagSet("fun")),
            new Employee(new EmployeeId(), new EmployeeName("Henry"), new EmployeeGender("male"),
                    new EmployeePay("20"), new EmployeePhone("87128807"),
                    new EmployeeEmail("ggg@example.com"),
                    new EmployeeAddress("Blk 30 GGG Street 99, #06-40"),
                    new EmployeeJoinDate(LocalDate.now()), getTagSet("boring")),
            new Employee(new EmployeeId(), new EmployeeName("Bill Gates"), new EmployeeGender("male"),
                    new EmployeePay("20"), new EmployeePhone("87128807"),
                    new EmployeeEmail("ggg@example.com"),
                    new EmployeeAddress("Blk 30 GGG Street 99, #06-40"),
                    new EmployeeJoinDate(LocalDate.now()), getTagSet("tech")),
            new Employee(new EmployeeId(), new EmployeeName("Sophia"), new EmployeeGender("female"),
                    new EmployeePay("20"), new EmployeePhone("87128807"),
                    new EmployeeEmail("ggg@example.com"),
                    new EmployeeAddress("Blk 30 GGG Street 99, #06-40"),
                    new EmployeeJoinDate(LocalDate.now()), getTagSet("fun"))
