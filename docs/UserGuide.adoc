...
Format: ``delete EVENT TYPE n/NAME d/START DAY [m/START MONTH] [d/START YEAR] [D/END DAY] [M/END MONTH] [Y/END YEAR]``
...
It is in the middle of the semester and your friend asks you whether you would be available for a short trip during the first week of this summer. Instead of trawling through your list of appointments (i.e. commitments and trips), you simply need to ask TravEzy! TravEzy would look at your commitments, trips, school breaks and holidays before informing you whether you are available (i.e. you happen to have a school break/holiday then *and* do not have any commitment/trip then). 

But how do you do that?

Format: ``check d/START DAY [m/START MONTH] [d/START YEAR] [D/END DAY] [M/END MONTH] [Y/END YEAR]``
...
Format: ``suggest d/START DAY [m/START MONTH] [d/START YEAR] [D/END DAY] [M/END MONTH] [Y/END YEAR] [p/PERIOD]``
