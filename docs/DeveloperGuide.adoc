...
recommendations generated for you. It is stored internally as an `Statistics` object with `watched` and `watchlist`.
...
Given below is an example usage scenario and how the Statistics feature behaves at each step.
