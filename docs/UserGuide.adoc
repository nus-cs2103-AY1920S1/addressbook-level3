...
You have created an account with name as 'Japan trip'.
* `account add n/Japan trip d/expense spent in Japan`
You have created an account with name as 'Japan trip' and description of 'expense spent in Japan'.
...
*`account find trip`
You can see a list of accounts with 'trip' contained in their names.
// end::accounts[]
