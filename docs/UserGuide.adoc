...
If successfully executed, the result box will display the message "_x persons listed!_", where _x_ is the
...
In this example below, 3 athletes have the `butterfly` tag.
