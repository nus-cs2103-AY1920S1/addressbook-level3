...
* has a need to manage and schedule itinerary items
...
3.  User requests to add a specific activity to a specific day
4.  System adds activity under selected day
+
Use case ends.
...
* 3b. The activity index is invalid.
+
[none]
...
. Deleting a person while all activities are listed
