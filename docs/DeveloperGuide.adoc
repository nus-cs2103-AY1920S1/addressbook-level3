...
This is a feature which allows the user to effectively manage the deliverymen by providing relevant statistics in regards to their statuses.
...
* Utilization Level
** This signals to the user the proportion of the deliverymen who are waiting to be assigned orders.
** It is the percentage of the number of deliverymen who are working (ie. delivering an order) over the number of deliverymen.
** It is computed as follows: *UTILIZATION LEVEL =  DeliveringMen / (AVAILABLEMEN + DELIVERINGMEN) x 100*
