...
*1. auto/Y* +
Format: `new dist/DISTRICT_NUM auto/Y`
...
*2. auto/N* +
Format: `new dist/DISTRICT_NUM auto/N`
...
* Multiple words can be taken for the operator and description parameter
...
Format: `new dist/DISTRICT_NUM auto/Y r/pending`
