...
[IMPORTANT]
Your signature should not contain numbers or punctuations and must be less than 40 characters.
...
You can view a the statistics of the number of bodies admitted to the morgue over the past 10 days, a specific week, a specific month, or a specific year.
...
You can archive old or irrelevant entries. One entry can be archived at a time, or all entries of a certain specification can be archived at once.
...
You can view all archived entries.
...
You can give workers feedback (for the manager’s own reference), and can view a history of all feedback entered.
...
* `feedback` +
Displays of all feedback entered
...
You can assign a body and task to a worker.
...
You can view a summary of all available commands and their flags. Use the `-v` flag to view the detailed description of all commands and their flags.
...
You can view emergency help hotlines.
