...
/**
 * Represent the question on each model
 */
public abstract class Question {
    ...
    /**
     * Modify the question on the model
     * @param newQuestion The updated question of the model
     */
    ...
    /**
     * While searching for a model, check if the question contains the target message
