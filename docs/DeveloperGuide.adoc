...
* e.g. `newappt -id E0000001A -start 01/11/19 1800 -reoccur m -num 2` - creates two monthly reoccurring appointments to patient whose `referenceId` is E0000001A.
* e.g. `editappt - entry 1 -start 02/11/19 1800` - edits a patient's first appointment timing to be the input timing if there is no conflict with doctor's duty shift.
