...
.Class Diagram of the Logic Component (todo: Update diagram)
...
* improve code reusability, we can reuse the `Person` class to derive classes which can represent patients or staff doctors.
