...
image::calendarScreenshots/add1.png[Add command]
...
image::calendarScreenshots/add2.png[Add result]
...
image::calendarScreenshots/delete1.png[Delete command]
...
image::calendarScreenshots/delete2.png[Delete result]
...
image::calendarScreenshots/show1.png[Show command]
...
image::calendarScreenshots/show2.png[Show result]
...
image::calendarScreenshots/list1.png[List command]

Step 2. A pop-up will appear to show you all your _events_. 

image::calendarScreenshots/list2.png[List result]
...
Do you need to find out whether you are available to go for a trip? You can get _TravEzy_ to find that out for you (i.e. when you happen to have a _school break_/_holiday_ then *and* do not have any _commitment_/_trip_ then).
...
image::calendarScreenshots/check1.png[Check command]
...
image::calendarScreenshots/check2.png[Check result]
