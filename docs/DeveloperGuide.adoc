...
image::CalendarCloseDisplayActivityDiagram.png[align="center"]
{empty} +
...
image::CalendarNextMonthActivityDiagram.png[align="center"]
{empty} +
...
image::CalendarPreviousMonthActivityDiagram.png[align="center"]
{empty} +
