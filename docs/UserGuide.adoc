...
.Example of how an add command can be used.
image::Add 2 in 1.png[]
...
.Example of when your password is about to expire
image::PasswordExpiring.png[width="220"]
...
.Example of how an edit command can be used.
image::Edit 2 in 1.png[]
...
>>>>>>> 57900bceda68ce2fd8fcf27979b3172ea508be0e
...
.Edits can be made to text and the Save Note button can be clicked.
image::OpenNote3.png[width="500"]

After clicking on the Save Note button, your edits made to the opened note will be saved!
...
Worry not because you can `undo` your mistake!
...
Once again, worry not because you can `redo` your action!

Using our `redo` feature will not only redo your command, it will also inform you of exactly what action is being redone.
...
* You can only redo an undone command.
