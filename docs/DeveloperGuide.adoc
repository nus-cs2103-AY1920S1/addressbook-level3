...
=======
include::DevGuideFeatureImplementations/report.adoc[]

=======
include::DevGuideFeatureImplementations/suggest.adoc[]

=======
include::DevGuideFeatureImplementations/budgetbar.adoc[]

// tag::dataencryption[]
=== [Proposed] Notification

_{Explain here how the notification feature will be implemented}_
