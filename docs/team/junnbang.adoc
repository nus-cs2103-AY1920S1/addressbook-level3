...
* *Minor enhancements*
** Create, Read, Update, Delete (CRUD) commands for Delivery Tasks.
** Refactor storage way by introduced a Central Manager to encapsulates all the data needed to be saved.
