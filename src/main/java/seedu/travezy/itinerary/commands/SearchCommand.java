...
import static seedu.travezy.itinerary.parser.CliSyntax.PREFIX_DATE;
import static seedu.travezy.itinerary.parser.CliSyntax.PREFIX_DESCRIPTION;
import static seedu.travezy.itinerary.parser.CliSyntax.PREFIX_LOCATION;
import static seedu.travezy.itinerary.parser.CliSyntax.PREFIX_TIME;
import static seedu.travezy.itinerary.parser.CliSyntax.PREFIX_TITLE;

import java.util.Optional;

import seedu.travezy.commons.util.CollectionUtil;
import seedu.travezy.itinerary.model.Model;
import seedu.travezy.itinerary.model.event.Date;
import seedu.travezy.itinerary.model.event.Description;
import seedu.travezy.itinerary.model.event.Event;
import seedu.travezy.itinerary.model.event.Location;
import seedu.travezy.itinerary.model.event.Time;
import seedu.travezy.itinerary.model.event.Title;
