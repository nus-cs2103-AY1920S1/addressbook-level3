...
NOTE: You can also drag and drop a word bank into your app.
...
NOTE: You can also drag and drop a word bank out your app. +
However, dragging and dropping may crash the app on Mac system.
