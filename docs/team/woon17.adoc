...
* *Major enhancement 1*: added *Appointments management* feature
...
** What it does: The duty shift scheduling provides users the ability to schedule duty shifts for doctors. It can help doctors to check, add, edit duty shifts efficiently.
...
https://nus-cs2103-ay1920s1.github.io/tp-dashboard/#search=woon&sort=groupTitle&sortWithin=title&since=2019-09-06&timeframe=commit&mergegroup=false&groupSelect=groupByRepos&breakdown=false&tabOpen=false&until=2019-11-10[Functional code]
https://nus-cs2103-ay1920s1.github.io/tp-dashboard/#search=woon&sort=groupTitle&sortWithin=title&since=2019-09-06&timeframe=commit&mergegroup=false&groupSelect=groupByRepos&breakdown=false&tabOpen=false&until=2019-11-10[Test code]

* *Other contributions*:

** Community:
*** Contributed to forum discussions (example: https://github.com/nus-cs2103-AY1920S1/forum/issues/144[1]]
*** Reported bugs and suggestions. i.e. I suggest to mention that user should not edit or delete data file in UG.
