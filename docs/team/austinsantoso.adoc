...
** Community:
*** Performed manual testing, Reported bugs and suggestions for teammates.
*** Performed manual testing, Reported bugs and suggestions for other teams in the class
