...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_TIMING = "appointment's timing should be after current time \n%1$s";
    //    public static final String MESSAGE_REFERENCEID_EMPTY = "Invalid command format: need to have another para! \n%1$s";
    ...
    public static final String MESSAGE_INVALID_APPOINTMENT_DISPLAYED_INDEX = "The appointment index provided is not correct";
