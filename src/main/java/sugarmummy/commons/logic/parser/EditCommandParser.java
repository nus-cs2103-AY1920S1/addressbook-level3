...
import static sugarmummy.commons.logic.parser.CliSyntax.PREFIX_TAG;
...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap =
            ArgumentTokenizer.tokenize(args, CliSyntax.PREFIX_RECORDTYPE, CliSyntax.PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL,
