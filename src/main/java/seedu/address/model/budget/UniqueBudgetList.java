 ...
 * A budget is considered unique by comparing using {@code Budget#isSameBudget(Budget)}. As such, adding and
 * updating of
 * budgets uses Budget#isSameBudget(Budget) for equality so as to ensure that the budget being added or updated is
 * unique in terms of identity in the UniqueBudgetList. However, the removal of a budget uses Budget#equals
 * (Object) so
