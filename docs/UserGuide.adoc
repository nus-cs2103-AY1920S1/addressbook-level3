...
Each Loan you create will keep track of:

1. A sum of money `amount`
...
| Name | "No Name"
| Start Day | "-1" (Offset ignored)
| Start Month | "-1" (Offset ignored)
| Start Year | "-1" (Offset ignored)
| End Day | "-1" (Offset ignored)
| End Month | "-1" (Offset ignored)
| End Year | "-1" (Offset ignored)
|==============================
