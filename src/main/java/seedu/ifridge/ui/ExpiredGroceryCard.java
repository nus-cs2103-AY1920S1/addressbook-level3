 ...
 */
public class ExpiredGroceryCard extends UiPart<Region> {

    private static final String FXML = "ExpiredGroceryCard.fxml";
    ...
    public ExpiredGroceryCard(Food food, int displayedIndex) {
        super(FXML);
        this.food = food;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ExpiredGroceryCard)) {
            return false;
        }

        // state check
        ExpiredGroceryCard card = (ExpiredGroceryCard) other;
