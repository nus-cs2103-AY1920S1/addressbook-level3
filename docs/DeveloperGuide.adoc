...
=== Edit Mode
==== Model
Restaurant class contains both the details and a List of Food items as its menu,
which makes it difficult to edit an entire restaurant item using 1 command line,
hence the use of Edit Mode.

ModelManager now contains an extra editingRestaurantList on top of FilteredRestaurantList
for access to the Restaurant currently under EditMode.
