...
[none]
* 2a. The user attempts to add a like that already exists as a dislike, or vice versa.
[none]
** 2a1. $aveNUS shows an error message.
+
Use case ends.

* 3a. The given categories, tags or locations are invalid.
+
[none]
** 3a1. $aveNUS shows an error message.
+
