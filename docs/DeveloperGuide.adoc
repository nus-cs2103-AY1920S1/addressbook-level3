...
Given below is an example usage scenario and how the FlashCard-exporting mechanism behaves at each step.
...
** Cons: Requires an external library to the nature of the file format
