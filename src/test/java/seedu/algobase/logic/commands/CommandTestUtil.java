...
public class CommandTestUtil {
    ...
    public static final String VALID_DESCRIPTION_QUICK_SORT = "hello world";
    public static final String VALID_DIFFICULTY_QUICK_SORT = "1.5";
    public static final String VALID_NAME_QUICK_SORT = "Quick sort";
    public static final String VALID_REMARK_QUICK_SORT = "ez";
    public static final String VALID_SOURCE_QUICK_SORT = "Kattis";
    public static final String VALID_WEBLINK_QUICK_SORT = "https://open.kattis.com/12345";
