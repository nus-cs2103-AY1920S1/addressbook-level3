...
[TIP]
A schedule-related command executed in the Main Tab will direct you to the Schedule Tab and vice versa.
*Non-schedule related commands should not be executed in the Schedule Tab as the lists referenced by the app are
on the Main Tab*
