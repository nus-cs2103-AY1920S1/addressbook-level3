...
The following activity diagram provides a general overview of the events that occur when a user executes an `export` command:

image::ExportActivityDiagram.png[width=517,height=546]

_Figure 3: Activity diagram of when the user executes an `export` command_

The following activity diagram provides a general overview of the events that occur when a user executes an `import` command:

image::ImportActivityDiagram.png[width=450,height=540]
