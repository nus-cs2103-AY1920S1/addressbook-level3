...
* Example:
`add dt/24-Aug-2019 d/Printer ink c/Miscellaneous a/3.50 p/Alex Yeoh`

[NOTE]
The format of the date has to be in dd-MMM-yyyy format. (Eg. 24-Aug-2019 or 03-Sep-2019)
The person should also be someone recorded in the Members Tab
...
image::homeUG/HomeFindCurr.png[width = "400"]
...
image::homeUG/HomeFindStep2.png[width = "400"]
...
This command helps to display the full transaction list after Find Commands. After a Find Command, the Delete, Edit, Sort Commands
can be entered before entering the Back Command to display the full list.
