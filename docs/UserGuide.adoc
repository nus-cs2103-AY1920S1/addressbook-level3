...
==== List all Employees: `emplist`

Shows the list of all employees on the company’s roster. Employee details are truncated.

Format: `emplist`

==== Fetch Full Details of Employee: `fetch`

Fetch the full details of a specific employee. Returns one employee only. +
Finds persons whose names contain any of the given keywords. 

Format: `fetch EMPLOYEE_ID`

****
* `EMPLOYEE_ID` must be a positive integer and exist within the list of employees. 
* If not found, 'Employee Not Found' will be displayed.
****
...
==== Adding an employee person: `add`

Adds an employee to the employee list

Format: `add n/NAME no/PHONE_NUMBER p/POSITION e/EMAIL a/ADDRESS [t/TAG]...`
...
==== Editing an employee details : `edit`

Edits an existing employee in the employee list.

Format: `edit INDEX n/NAME no/PHONE_NUMBER p/POSITION e/EMAIL a/ADDRESS [t/TAG]...`
...
* `edit 1 no/91234567 e/johndoe@example.com` +
