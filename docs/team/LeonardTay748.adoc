...
image::StatsCommand.png[width="790"]

2. The result box will display the message "Statistics displayed"

image::StatsCommandBox.png[width="790"]
...
image::StatsWindow.png[width="790"]
...
image::HelpCommandBox.png[width="790"]
...
* `_Stage_` -- To create the pop-up window.
