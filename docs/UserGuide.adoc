...
list on the right-sde pane. The index *must be a positive integer* 1, 2, 3, ...
****
...
NOTE: "Bad" rated `Deadline`(s) will be added to a deadline which is due 3 days later. This is an approximated value that based on
