...
*We have decided to go with Alternative 2.* There is a lot of retrieval of book objects in within the Book and Loan feature.
Therefore, the benefits of quick retrieval of book information from the catalog will
...
*We have decided to go with Alternative 2* and keep it simple. This is because there are some edge cases which will lead to
...
Expected: Fin amount in borrower panel remains the same. Error details shown in the command result display.
