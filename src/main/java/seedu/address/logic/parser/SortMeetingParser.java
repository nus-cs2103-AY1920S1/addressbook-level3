...
public class SortMeetingParser implements Parser<SortMeetingCommand> {
    ...
    /**
     * Parses the given {@code String} of arguments in the context of the SortMeetingCommand
    ...
    public SortMeetingCommand parse(String args) throws ParseException {
        try {
            ...
            return new SortMeetingCommand(index);
        } catch (ParseException pe) {
            throw new ParseException(
                    String.format(MESSAGE_INVALID_COMMAND_FORMAT, SortMeetingCommand.MESSAGE_USAGE), pe);
        }
    }
}
