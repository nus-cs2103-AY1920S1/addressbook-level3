...
Streamlines the process of sharing of word banks with friends.
...
The revision bank is best appreciated when you actually play around with some word banks, and then visit the revision bank
