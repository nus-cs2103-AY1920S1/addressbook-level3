...
made for the `stats` and `fitler` features.

This section also contains an excerpt for the sorting feature that I have planned for the
next version (v2.0) of Mortago.
...
{start of extract 3: sort command (v2.0)}
