...
public class FinanceStorageManager implements Storage {
    ...
    @Override
    public Optional<ReadOnlyFinanceLog> readAddressBook() throws DataConversionException, IOException {
        return readAddressBook(addressBookStorage.getAddressBookFilePath());
    }

    @Override
    public Optional<ReadOnlyFinanceLog> readAddressBook(Path filePath) throws DataConversionException, IOException {
