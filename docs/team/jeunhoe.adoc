...
You can view the entire document https://ay1920s1-cs2103t-t12-3.github.io/main/UserGuide.html#training-feature[here].
...
You can view the entire document https://ay1920s1-cs2103t-t12-3.github.io/main/DeveloperGuide.html#training-feature[here].

{Start of extract from Developer Guide}

include::../DeveloperGuide.adoc[tag=training_structure]

include::../DeveloperGuide.adoc[tag=training_design]
