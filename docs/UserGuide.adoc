...
*Command Format*
====
All commands start with the keyword of the command (ie: 'student' for student commands). Certain commands may include
additional options and will be specified in the description. An optional field will be marked ​(optional) beside the field.
====
