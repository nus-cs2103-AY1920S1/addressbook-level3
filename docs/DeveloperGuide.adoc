...
1. Student gives the command to delete an existing question `deleteq INDEX`
2. Application shows the question being deleted
3. Application deletes the question indicated by the student from the application
...
[none]
** 1a1. Application shows the error of invalid index
