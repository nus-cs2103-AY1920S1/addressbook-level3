...
/**
 * Parses input arguments and creates a new DeliverymanDeleteCommand object
 */
public class DeleteCommandParser implements Parser<DeliverymanDeleteCommand> {
    /**
     * Parses the given {@code String} of arguments in the context of the DeliverymanDeleteCommand
     * and returns a DeliverymanDeleteCommand object for execution.
