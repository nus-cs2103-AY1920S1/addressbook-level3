...
:repoURL: https://github.com/AY1920S1-CS2103-F09-4/main.git

By: `Team cinnamon-agents`      Since: `Sep 2019`      Licence: `MIT`
...
.. Test case: +
    ...
    `addcriteria [INDEX OF POLICY JUST ADDED] cr/test
    `eligiblepeople [INDEX OF PERSON JUST ADDED]` +
