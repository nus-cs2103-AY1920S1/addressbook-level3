...
If the specified contact is involved in an expense, he cannot be removed since participants in activity will owe him money or he will owe participants money and a warning message indicating that he/she is involved in an expense will be shown.
