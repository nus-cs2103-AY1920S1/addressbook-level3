...
If the command is successful, the athlete's name and attendance rate will be displayed in the result box as shown in
the diagram below.
...
feature box will show you your team's overall attendance rate.
...
If successfully added, the result box (red box) will display message "_Event created:_" followed by the name
of the event you just added, as shown in the diagram below.
...
If successfully deleted, the result box (red box) will display the message "_Deleted event:_" followed by
the name of the event you just deleted, as shown in the diagram below.
...
You will need the event name, athlete’s index, date of record and timing of record.
...
If successfully added, the result box will display the details of the record you just added.

In the diagram below, the details of Tao Li's record - event, date and timing - are displayed in the
success message.
...
You will need the event name, athlete's index and date of record.
...
If successfully deleted, the result box will display the details of the record you just deleted.

In the diagram below, the details of Tao Li's deleted record - event and date - are displayed in
the success message.
