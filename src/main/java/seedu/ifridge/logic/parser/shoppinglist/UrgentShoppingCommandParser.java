 ...
 */
public class UrgentShoppingCommandParser implements Parser<UrgentShoppingCommand> {
     ...
     */
    public UrgentShoppingCommand parse(String args) throws ParseException {
        try {
            Index index = ParserUtil.parseIndex(args);
            return new UrgentShoppingCommand(index);
        } catch (ParseException pe) {
            throw new ParseException(
                    String.format(MESSAGE_INVALID_COMMAND_FORMAT, UrgentShoppingCommand.MESSAGE_USAGE), pe);
        }
    }
