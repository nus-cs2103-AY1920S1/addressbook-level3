...
*** Add Sort Command (Pull requests https://github.com/AY1920S1-CS2103T-F11-2/main/issues/7[#7], https://github.com/AY1920S1-CS2103T-F11-2/main/issues/16[#16])
*** Wrote tests for sort command and its dependencies (Pull request https://github.com/AY1920S1-CS2103T-F11-2/main/issues/82[#82])
