...
import seedu.address.logic.commands.inventory.DoneInventoryCommand;
 ...
 */
public class DoneInventoryParser implements Parser<DoneInventoryCommand> {

    @Override
    public DoneInventoryCommand parse(String args) throws ParseException {
        try {
            Index index = ParserUtil.parseIndex(args);
            return new DoneInventoryCommand(index);
