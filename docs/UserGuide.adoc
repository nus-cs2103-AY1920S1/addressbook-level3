...
All items containing "larry" in Student list and all items containing "programming" are displayed. Student list defaults to expanded view since there is only 1 search result.
