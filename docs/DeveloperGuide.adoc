...
many seemingly unrelated classes such as `Budget`, `PurchasHistory` and `UserRecommendations` in order to produce the
...
image::RecommendationClassDiagram.png[width=350, align="center"]
...
image::LikeActivityDiagram.png[width=400, align="center"]
...
image::RecValueActivityDiagram.png[width=600, align="center"]
