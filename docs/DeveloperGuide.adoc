...
First and foremost, they will be able to sort the food items based on their default ordering, where it is based on ascending price, name and then category. +
...
A singleton class `RecommendationSystem` encapsulates
...
Each food is passed to the recommendation system and it calculates the
