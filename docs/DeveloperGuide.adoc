...
2.  MoneyGoWhere generate statistical analysis such as total spending of each tag
+
Use case ends.
[none]

'''
=== Use case: List all the tags
...
'''
=== Use case: Import external data from a CSV file

*MSS*

1.  User requests to import data from CSV file by specifying the file path
2.  MoneyGoWhere import the data from the CSV file located at specified file path
+
Use case ends.
...
'''
=== Use case: Export data to a CSV file

*MSS*

1.  User requests to export data from CSV file by specifying the file path
2.  MoneyGoWhere export the data into the CSV file located at specified file path
+
Use case ends.
...
2.  MoneyGoWhere restores the list of spending to the state before the previous undoable command was executed.
+
Use case ends.
...
[none]
* 1a. There is no undoable commands executed previously.
+
[none]
** 1a1. MoneyGoWhere shows an error message.
+
...
2.  MoneyGoWhere restores the most recent undo command.
+
Use case ends.
...
[none]
* 1a. There is no undo commands executed previously.
+
[none]
** 1a1. MoneyGoWhere shows an error message.
+
...
'''
=== Use case: Clear all spending

*MSS*

1.  User requests to clear all entries in the list of spending.
2.  MoneyGoWhere deletes all spending.
+
Use case ends.
