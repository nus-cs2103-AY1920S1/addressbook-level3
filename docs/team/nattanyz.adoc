...
** Documentation:
*** I was quite involved in the conceptualisation of the project in its initial stages and was thus responsible for the first draft of the Introduction section of the User Guide. 
*** Subsequently, I abstracted out the What is a flashcard? and Interacting with flashcards sections, making non-trivial improvements to the clarity of the writing in the process.
*** I helped to clean up various sections of the User Guide, especially in the first draft, and made sure they abided by a consistent format.
** Community:
