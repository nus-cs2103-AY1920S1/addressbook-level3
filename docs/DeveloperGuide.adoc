...
=== Select feature
==== Implementation
The select feature is facilitated by `SelectCommand`. It extends `Command` and parses the arguments using
`SelectCommandParser`.

==== Design Consideration
===== Aspect: Method to display personal information of the selected person
* Alternative 1 (current choice): Displaying it in an AnchorPane.
** Pros: Minimises the use of mouse
* Alternative 2: Displaying it in a TabPane.
...
=== Use case: UC1 - Marking attendance of players
=== Actor: User
...
[discrete]
=== Use case: UC3 - Key in Performance of a Player
=== Actor: User
...
[discrete]
=== Use case: UC4 - View a player’s profile
=== Actor: User
