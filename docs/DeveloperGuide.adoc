...
Now the overview - How these data structures are stored in `Model` and `Storage`.
...
To have a better understanding of how these commands work, I will walk you through one command from CardCommand and HomeCommand.

For instance, `AddCommand` +
