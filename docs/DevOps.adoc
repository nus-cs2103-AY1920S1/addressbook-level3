= CS2103/T Revision Tool - Dev Ops
...
. Update the version number in link:{repoURL}/src/main/java/seedu/revision/MainApp.java[`MainApp.java`].
...
For example, Revision Tool depends on the https://github.com/FasterXML/jackson[Jackson library] for JSON parsing.
