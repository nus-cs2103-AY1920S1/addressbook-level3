...
public class CommandResult {
     ...
     */
    public CommandResult(String feedbackToUser, boolean showHelp, boolean showModule, boolean exit) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(feedbackToUser, showHelp, showModule, exit);
    }
}
