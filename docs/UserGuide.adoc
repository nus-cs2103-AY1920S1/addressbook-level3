...
Format: `add cat/<category name> typ/Expense n/<description> amt/<expenditure> d/<date> [tg/<tag>]`
...
Format: `add cat/<category name> typ/Income n/<description> amt/<expenditure> d/<date> [tg/<tag>]`
...
.. editCategory cat/<category type> o/<old category name> n/<new category name>
.. listCategories
