...
* Started implementing Ui components and link them to FXML. This provides skeletal codes for the rest of my teammates to adapt.
* Modify Command Class to be generic so that the class can take in various Model classes.
