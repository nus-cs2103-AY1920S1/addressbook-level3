...
illustrate these features in more detail, as well as the relevant documentation
...
** What it does: This feature allows the user to check for availability of employees and allocate them to an event with
...
* *Minor feature*: added command history to allow user to view previous commands using up/down
arrow keys.
...
== PROJECT: DUKE
Visit https://calvincxz.github.io/duke/ for more details.
