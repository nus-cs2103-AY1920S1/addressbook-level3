...
This command allows users of the AlgoBase application to add optional remarks to people in their address book and edit it if required.
...
/**
 * Changes the remark of an existing problem in the address book.
 */
...
You can refer to the changes in this link:https://github.com/nus-cs2103-AY1920S1/algobase-level3/commit/7d04e49e364dad661cd88f462f01923fba972d2c#diff-5338391f3f6fbb4022c44add6590b74f[diff].
...
Your code should look something like link:https://github.com/nus-cs2103-AY1920S1/algobase-level3/commit/83dd9e6b03d6b83199ceb6f3b66166483155abed#diff-34ace715a8a8d2e5a66e71289f017b47[this] after you are done.
...
If you are stuck, check out the sample link:https://github.com/nus-cs2103-AY1920S1/algobase-level3/commit/efdcdf0e80cec9489f7b47e3f65824f4688ad8f7#diff-fc19ecee89c3732a62fbc8c840250508[here].
...
Create a new `Remark` in `seedu.address.model.Problem`. Since a `Remark` is a field that is similar to `Address`, we can reuse a significant bit of code.

A copy-paste and search-replace later, you should have something like link:https://github.com/nus-cs2103-AY1920S1/algobase-level3/commit/b7a47c50c8e5f0430d343a23d2863446b6ce9298#diff-af2f075d24dfcd333876f0fbce321f25[this].
...
to link:https://github.com/nus-cs2103-AY1920S1/algobase-level3/commit/2758455583f0101ed918a318fc75679270843a0d#diff-0c6b6abcfac8c205e075294f25e851fe[`seedu.address.ui.ProblemCard`].
...
```
into link:https://github.com/nus-cs2103-AY1920S1/algobase-level3/commit/2758455583f0101ed918a318fc75679270843a0d#diff-12580431f55d7880578aa4c16f249e71[`main/resources/view/ProblemListCard.fxml`].
...
Refer to link:https://github.com/nus-cs2103-AY1920S1/algobase-level3/commit/b241ef8526bd4e8a6ad94b8118b7fc3441ec8fa3#diff-3462fc1118b9872387a01b41157b0402[this commit] and check that you have got everything in order!
...
Not doing so will cause AlgoBase to default to an empty address book!

Check out link:https://github.com/nus-cs2103-AY1920S1/algobase-level3/commit/ce4f9b70f524d2395948861d80d57fda9ae6e82e#diff-07708562699e2436c717f3330bafae1e[this commit] to see what the changes entail.

== Finalizing the UI

Now that we have finalized the `Problem` class and its dependencies, we can now bind the `Remark` field to the UI.

Just add link:https://github.com/nus-cs2103-AY1920S1/algobase-level3/commit/56d5cb662c31dd38b02f6a5301ba6ab3c667d6a3#diff-0c6b6abcfac8c205e075294f25e851fe[this one line of code!]
[source, java]
.ProblemCard.java
----
...
Make one last link:https://github.com/nus-cs2103-AY1920S1/algobase-level3/commit/b3307d7a42acb613a8f1d36979a7f547abcf6623#diff-34ace715a8a8d2e5a66e71289f017b47[check] to ensure that everything is working properly...
...
link:https://github.com/nus-cs2103-AY1920S1/algobase-level3/commit/b3307d7a42acb613a8f1d36979a7f547abcf6623#diff-d749de38392f7ea504da7824641ba8d9[this].
