...
public class CommandTestUtil {
    ...
    public static final String VALID_NRIC_AMY = "S019283A";
    public static final String VALID_NRIC_BOB = "S102939B";
    ...
    public static final String VALID_POLICY_HEALTH = "health policy";
