...
public class TypicalIdentificationNumbers {
    public static final IdentificationNumber FIRST_BODY_ID_NUM = IdentificationNumber.customGenerateTestId("B", 1);
    public static final IdentificationNumber SECOND_BODY_ID_NUM = IdentificationNumber.customGenerateTestId("B", 2);
    public static final IdentificationNumber FIRST_WORKER_ID_NUM = IdentificationNumber.customGenerateTestId("W", 1);
