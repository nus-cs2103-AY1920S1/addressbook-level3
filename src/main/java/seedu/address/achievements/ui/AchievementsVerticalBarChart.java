...
/**
 * An UI component that displays a vertical {@link BarChart} with {@code xAxisLabel}, {@code yAxisLabel} and
 * {@code chartData}.
 */
public class AchievementsVerticalBarChart extends UiPart<Region> {

    private static final String FXML = "achievements/AchievementsVerticalBarChart.fxml";
