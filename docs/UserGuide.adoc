...
* The items filtered are those contain the whole keyword. (eg. `find m/cs1010` will show `CS1010` module in the Module list.
However, `find m/cs10` will not show any of the module since no module contains `cs10` as a word in its information)
