...
class JsonAdaptedPerson {
    ...
    private final JsonAdaptedPerformance performance;
    ...
    public JsonAdaptedPerson(@JsonProperty("name") String name, @JsonProperty("phone") String phone,
                             ...
                             @JsonProperty("performance") JsonAdaptedPerformance performance) {
    ...
    public JsonAdaptedPerson(Person source) {
        ...
        performance = new JsonAdaptedPerformance(source.getPerformance());
    }
