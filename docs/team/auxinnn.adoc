...
We have updated the User Guide of Address Book to fit the commands of our project. The following part shows my
contribution to the modification of *NUStudy User Guide* for quiz feature.

'''

include::../UserGuide.adoc[tag=quizStart]

include::../UserGuide.adoc[tag=quizQuit]
...
We also updated the Developer Guide so that the style and architecture fits our project. The following part shows my
