...
Step 1. The user executes *list m/01/2019* to filter the list to bring up transactions of January 2019.
...
.. Test case: `list m/01/2019 t/Food` +
   Expected: The list of transactions related to food for January 2019 will be shown.
