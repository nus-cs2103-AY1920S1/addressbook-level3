...
To create a report that displays the data in CaloFit: +
...
1. Maximum, Minimum and Average calorie intake per day of the current month.
[NOTE]
Average value is rounded down.
2. Number of days where calorie intake exceeded calorie budget of the month.
3. List of most consumed dishes of the month.
4. Calorie intake per day over the entire month.
5. Quantity of each type of dish consumed in that month.
