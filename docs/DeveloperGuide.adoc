...
|`* * *` |student with many friends |split the bill with my friends |know how much I should pay for a meal

|`* * *` |student who forgets to pay his debt on time |be reminded to pay my debt before the deadline |stop incurring interests
...
.  The application shouldn't make users feel defeated, but rather empowered in managing their finances.
