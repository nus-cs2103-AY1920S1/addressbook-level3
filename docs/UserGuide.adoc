...
Another feature that many students want is to set a savings target
in which they can be constantly reminded about whenever they open up the application,
which can further encourage them to take up certain savings habits and cut down on certain unnecessary expenditures.
