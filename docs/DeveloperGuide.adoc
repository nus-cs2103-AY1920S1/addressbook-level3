...
The following sequence diagram illustrates how `rn` command is executed (adding a task for question is similar, but with different user command):

.Sequence diagram for adding a task for note
image::task/AddTaskForNoteSequenceDiagram.png[]
