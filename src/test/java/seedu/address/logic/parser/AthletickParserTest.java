...
public class AthletickParserTest {

    private final AthletickParser parser = new AthletickParser();
    ...
    public void parseCommand_deletePerson() throws Exception {
        DeleteCommand command = (DeleteCommand) parser.parseCommand(
                DeleteCommand.COMMAND_WORD + " " + FLAG_PERSON + " " + INDEX_FIRST_PERSON.getOneBased());
