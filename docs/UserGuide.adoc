...
Edits the answer number and email address of the 1st person to be `91234567` and `johndoe@example.com` respectively.
* `edit 2 n/Betsy Crower t/` +
Edits the question of the 2nd person to be `Betsy Crower` and clears all existing categories.

=== Locating persons by question: `find`
