...
* `add n/John Doe ic/S9999999J p/98765432 e/johnd@example.com a/John street, block 123, #01-01 dob/12.09.1980`: adds contact
...
****
[NOTE]
Deleted items will expire in 10 seconds for testing purpose. Expired items will be removed on restart of application.
