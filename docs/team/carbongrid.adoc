...
* *Major enhancement*: *Eager Evaluation (Proposal & UX Concept)*
...
** Highlights: Eager Evaluation should not block the main UI from user upon processing large data-sets.
** Credits: SakuraBlossom (Threading and Commands), Chrome DevTools Console (Inspiration)
...
** Project management:
*** Updating Gradle wrapper & Configuration for Headed UI Test (Pull Request https://github.com/AY1920S1-CS2103T-T09-3/main/pull/89[#89])
*** Dependencies management and version bumping for dependencies bug fixes & optimisations after compatibility checks. (Pull requests https://github.com/AY1920S1-CS2103T-T09-3/main/pull/80[#80], https://github.com/AY1920S1-CS2103T-T09-3/main/pull/100[#100], https://github.com/AY1920S1-CS2103T-T09-3/main/pull/200[#200])
...
include::../DeveloperGuide.adoc[tag=autocompleteDesignConsideration]
