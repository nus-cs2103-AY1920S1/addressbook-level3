...
import static seedu.ichifund.logic.commands.CommandTestUtil.ADDRESS_DESC_BOB;
import static seedu.ichifund.logic.commands.CommandTestUtil.EMAIL_DESC_AMY;
import static seedu.ichifund.logic.commands.CommandTestUtil.EMAIL_DESC_BOB;
import static seedu.ichifund.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static seedu.ichifund.logic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
import static seedu.ichifund.logic.commands.CommandTestUtil.INVALID_NAME_DESC;
import static seedu.ichifund.logic.commands.CommandTestUtil.INVALID_PHONE_DESC;
import static seedu.ichifund.logic.commands.CommandTestUtil.INVALID_TAG_DESC;
import static seedu.ichifund.logic.commands.CommandTestUtil.NAME_DESC_AMY;
import static seedu.ichifund.logic.commands.CommandTestUtil.NAME_DESC_BOB;
import static seedu.ichifund.logic.commands.CommandTestUtil.PHONE_DESC_AMY;
import static seedu.ichifund.logic.commands.CommandTestUtil.PHONE_DESC_BOB;
...
import static seedu.ichifund.logic.commands.CommandTestUtil.TAG_DESC_FRIEND;
import static seedu.ichifund.logic.commands.CommandTestUtil.TAG_DESC_HUSBAND;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(PERSON_BOB).withTags(VALID_TAG_FRIEND).build();
        ...
        Person expectedPersonMultipleTags = new PersonBuilder(PERSON_BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
