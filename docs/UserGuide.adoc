...
* You can also opt to add in custom preferences using the following format:
...
* You can analyse a specific password in greater detail using the following format:
* `analyse strong/<index>`
====

Format: `analyse` / `analyse strong/<index>`
