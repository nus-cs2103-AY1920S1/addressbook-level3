...
public class NusModsParser {
    private static final String LESSONS_JSON_URL = "./data/lessons.json";
    private static Map<String, Map<String, Tutorial>> lessonMap = NusModsParser.load();

    /**
     * Loads lesson json data into a Map<ModuleCode, Map<ClassNo, Tutorial>>.
     */
    ...
    /**
     * Parses the NUSMods url to return a List of Tutorials. Throws NullPointException error
