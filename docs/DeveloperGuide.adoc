...
== Introduction
Welcome to ORGANice! This is an organ matching desktop application that is specifically designed for fast typing
hospital administration staff. This developer guide is meant for developers who would like to understand the
design and structure of ORGANice.
...
This section explains the interactions amongst the different architecture components using an example.
