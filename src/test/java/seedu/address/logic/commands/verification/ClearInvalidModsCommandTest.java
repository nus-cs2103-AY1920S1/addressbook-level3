...
public class ClearInvalidModsCommandTest {
    ...
    @Test
    public void execute_noInvalidMods_success() {
        Model model = new ModelStubOne();
        CommandResult expectedCommandResult = new CommandResult(
                "No modules are invalid.", false, false);
        assertCommandSuccess(new ClearInvalidModsCommand(), model, expectedCommandResult, model);
    }

    @Test
    public void execute_hasInvalidMods_success() {
        Model model = new ModelStubTwo();
        CommandResult expectedCommandResult = new CommandResult(
                "2 invalid modules have been cleared!", false, false);
        assertCommandSuccess(new ClearInvalidModsCommand(), model, expectedCommandResult, model);
    }

    @Test
    public void equals_success() {
        ClearInvalidModsCommand a = new ClearInvalidModsCommand();
        ClearInvalidModsCommand b = new ClearInvalidModsCommand();
        assertEquals(a, b);
    }
