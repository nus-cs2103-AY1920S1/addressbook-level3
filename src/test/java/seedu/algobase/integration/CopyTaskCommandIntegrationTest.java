...
public class CopyTaskCommandIntegrationTest {
    @TempDir
    ...
    @Test
    public void copytask_allConstraints() throws CommandException, ParseException {
        logicManager.execute("copytask task/1 from/1 to/2\n");
    }
}
