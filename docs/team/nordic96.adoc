...
*** *Justification*: Secretaries and receptionists are not responsible only in task management. They have other tasks that consume many of their time during office work. In order to improve their task performance more time efficiently, the feature allows users to save time instead of manually typing the document while referring to
