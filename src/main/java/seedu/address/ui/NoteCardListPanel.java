 ...
 */
public class NoteCardListPanel extends UiPart<Region> {
    private static final String FXML = "NoteListPanel.fxml";
    private final Logger logger = LogsCenter.getLogger(NoteCardListPanel.class);

    @FXML
    private ListView<Note> noteListView;

    public NoteCardListPanel(ObservableList<Note> noteList) {
        super(FXML);
