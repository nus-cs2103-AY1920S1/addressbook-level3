...
public class AccountAddCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "account add n/food d/The chatting robot proposed is a multi-faceted approach, "
               ...
               + "the consistency of the users’ conditions, "
               + "at the same time avoids any subtle signs of depressions or abnormal behavior.  "
               ...
               + "that provide both emotional support and life coaching techniques "
               + "to ease the pain or anxiety the users feel. "
