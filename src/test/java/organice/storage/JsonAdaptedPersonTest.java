...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_TYPE, VALID_NRIC, INVALID_NAME,
                VALID_PHONE, PLACEHOLDER_AGE, VALID_PRIORITY);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_TYPE, VALID_NRIC, null, VALID_PHONE,
                PLACEHOLDER_AGE, VALID_PRIORITY);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_TYPE, VALID_NRIC, VALID_NAME, INVALID_PHONE,
                PLACEHOLDER_AGE, VALID_PRIORITY);
    ...
    public void toModelType_invalidNric_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_TYPE, INVALID_NRIC, VALID_NAME, INVALID_PHONE,
                PLACEHOLDER_AGE, VALID_PRIORITY);
    ...
    public void toModelType_invalidType_throwsIllegalValueException() {
        JsonAdaptedPerson person =
            new JsonAdaptedPerson(INVALID_TYPE, VALID_NRIC, VALID_NAME, INVALID_PHONE, PLACEHOLDER_AGE, VALID_PRIORITY);
