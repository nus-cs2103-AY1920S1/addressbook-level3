= Jon Chua - Project Portfolio
:site-section: AboutUs
:icons: font
:imagesDir: ../images
:stylesDir: ../stylesheets

== *CS2103T Project: $aveNUS*
...
spicy food accordingly and the overall recommendations contain less spicy food.
...
application can then take into account the user's preferences when selecting the food items to recommend, resulting in
