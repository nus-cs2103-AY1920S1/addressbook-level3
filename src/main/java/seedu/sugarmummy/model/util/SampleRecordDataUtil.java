...
import seedu.sugarmummy.model.record.BloodSugarBuilder;
import seedu.sugarmummy.model.record.BmiBuilder;
...
public class SampleRecordDataUtil {
    ...
    public static Record[] getSampleRecords() {
        return new Record[]{
            ...
            new BmiBuilder().withDateTime("2019-07-02 09:09").withHeight("180.0").withWeight("150").build(),
            new BmiBuilder().withDateTime("2019-07-13 12:19").withHeight("180.0").withWeight("85.0").build(),
            new BmiBuilder().withDateTime("2019-07-26 09:19").withHeight("180.0").withWeight("69.5").build(),
            new BmiBuilder().withDateTime("2019-08-01 06:09").withHeight("180.0").withWeight("55.4").build(),
