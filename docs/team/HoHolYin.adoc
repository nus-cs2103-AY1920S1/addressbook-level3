...
* This assists the librarian in tracking the movement of books with ease using the system.

==== Implemented the ability to *delete books*.
* This allows the librarian to update the catalog when a book goes missing.

==== Implemented the ability to *display information* about a book.
* This aids the librarian in retrieving more information about a book when a borrower enquires about it.
