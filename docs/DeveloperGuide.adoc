...
This feature allows the user to _sort_ their bank account by the _amount_ or _date_ of their transanctions by using the command `sort amount` or `sort date` respectively.

==== Current Implementation
The `sort` command is facilitated by the _Logic_ and _Model_ components of the application, _PalPay_.

The sequence diagram below shows how the sorting of transactions work when the user enters `sort amount`.
