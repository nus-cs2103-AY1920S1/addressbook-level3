...
** Community:
*** PRs reviewed (with non-trivial review comments): https://github.com/AY1920S1-CS2103T-W11-2/main/pull/190[190],
*** Reported bugs and suggestions for other teams in the class (examples:  https://github.com[1], https://github.com[2], https://github.com[3])

== Contributions to the User Guide

|===
|_Given below are sections I contributed to the User Guide for the `invite`, `disinvite` and `delete` features. They showcase my ability to write documentation targeting end-users._
|===
