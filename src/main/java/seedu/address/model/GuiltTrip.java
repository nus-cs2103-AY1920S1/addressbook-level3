...
import seedu.address.model.entry.AutoExpenseList;
import seedu.address.model.entry.Budget;
import seedu.address.model.entry.BudgetList;
...
import seedu.address.model.entry.ExpenseList;
import seedu.address.model.entry.Income;
import seedu.address.model.entry.IncomeList;
import seedu.address.model.entry.UniqueEntryList;
import seedu.address.model.entry.Wish;
import seedu.address.model.entry.WishList;
...
public class GuiltTrip implements ReadOnlyGuiltTrip {
     ...
     * existing entry in the address book.
     */
