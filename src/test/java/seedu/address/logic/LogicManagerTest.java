...
public class LogicManagerTest {
    ...
    public void setUp() {
        ...
        model.setUserSettings(new UserSettings(false, 30, ChronoUnit.DAYS));
    ...
    public void execute_validCommand_success() throws Exception {
        String listPeopleCommand = ListPeopleCommand.COMMAND_WORD;
        assertCommandSuccess(listPeopleCommand, ListPeopleCommand.MESSAGE_SUCCESS, model);
    }
