...
* Each activity will be automatically assigned an activity ID. +
****
...
If current display is listing contacts `list c/`, the contact at that specified index will be deleted if he/she is not involved in any activities.

If current display is listing activities `list a/`, the activity at that specified index will be deleted.

If viewing an activity instead `view a/1`, it will soft-delete an expense* by index.
...
* The index refers to the index number shown in the displayed list of contacts/activities.
