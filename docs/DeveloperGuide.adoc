...
|===
|*Pros*|
1. Time Complexity Efficient: O(m), where m is length of searched word. +
...
|*Cons*|
1. Time Complexity Inefficient: O(nm), where n is number of words and m is length of searched word.
|===
