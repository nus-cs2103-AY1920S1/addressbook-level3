...
Once you have begun a visit using `visit-start`, the application will note that you have an ongoing visit. You can then mark that visit as finished using `visit-now-finish`, which will archive that visit. The ongoing visit will be removed from the Current Visit tab.
