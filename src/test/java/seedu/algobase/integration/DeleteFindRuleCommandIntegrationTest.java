...
public class DeleteFindRuleCommandIntegrationTest {
    @TempDir
    ...
    @Test
    public void deletefindrule_allConstraints() throws CommandException, ParseException {
        logicManager.execute("deletefindrule 1\n");
        logicManager.execute("dfr 1\n");
    }
}
