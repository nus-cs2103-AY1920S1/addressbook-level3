...
==== Justification
This feature improves the product significantly because a borrower can be no longer using the library and the app should unregister him or her from the library system.

==== Highlights
This enhancement affects existing commands and commands to be added in future. It required an in-depth analysis of design alternatives. The implementation too was challenging as it required changes to many data in the storage.
