...
DukeCooks is a desktop application designed for health-conscious students.
...
DukeCooks is developed by a group of five Year 2 Computing students from the National University of Singapore.
...
AB3 to create and manipulate a person's contact information. In DukeCook’s Dashboard, these functions are used to create
