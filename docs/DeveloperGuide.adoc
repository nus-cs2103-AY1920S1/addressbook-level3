...
=== Auto-generated cheatsheet feature
...
Given below is an example usage scenario and how the auto-generation mechanism behaves at each step.

[NOTE]
Assuming that user is already in the _cheatsheet_ mode.
