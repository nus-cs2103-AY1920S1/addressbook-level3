...
and would like a ballpark figure to estimate how well you know the subject.
...
NOTE: You cannot edit the status of a task with this command. Instead, you may want to use `rdone` if you want to mark a
