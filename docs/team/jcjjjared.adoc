...
myself under the premise that we had to either optimize or morph an existing https://nus-cs2103-ay1920s1.github.io/addressbook-level3/index.html[AddressBook] application. We chose the latter. Another
