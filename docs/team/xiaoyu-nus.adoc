...
** Project management:
** Documentation:
*** Added GUI and replenish list section of the User Guide: (Pull requests https://github.com/AY1920S1-CS2103T-F11-2/main/pull/134[#134])
...
include::../UserGuide.adoc[tag=set reminder]
...
include::../DeveloperGuide.adoc[tag=user interface]
//
//
