...
.  Xpire not only has a list to track you perishable items, it also has a *to-buy* list(replenish list). You can move your items from the
...
This is a active list that shows you the current view of items. As you manipulate the items using
