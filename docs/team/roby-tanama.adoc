...
There are also a list of themes available which gives the user a sense of freedom where they are able to tweak how the
application looks according to their own preferences. There is also custom theme available to suit the tastes of even
the most demanding of users.

==== Justification

The look of the app is the first thing that users see when starting up the application. By having a expertly
...
constantly type commands just for a bunch if information that could have been easily displayed on the screen.
...
and theme button which allow user to know what they can do before even reading the user guide.
...
default browser would definitely make it much more convenient for the users.
...
** Fixed bugs after they were found [PR https://github.com/AY1920S1-CS2103T-F13-2/main/pull/221[#221]]
...
*** Updated the UI screenshots

*** Provided sample screenshots for any UI changes

** Updated the Developer Guide

*** Updated UI section of the Developer Guide [PR https://github.com/AY1920S1-CS2103T-F13-2/main/pull/190[#190]]

== Contributions to the User Guide

This section shows the contributions that I have made to the sorting feature of the User Guide.

include::../UserGuide.adoc[tag=general]
