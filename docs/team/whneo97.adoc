...
and it has a GUI created with JavaFx. It is written in Java and has about 29 kLOC.
...
..._(Click https://github.com/AY1920S1-CS2103-T16-1/main/blob/master/docs/UserGuide.adoc#show-a-list-of-all-achievements-the-user-has-attained-achvm[here] for more information on the `achvm` command from the User Guide.)_

//Bio
include::../UserGuide.adoc[tag=personalisedUserExperienceBioPppPart1]

..._(Click https://github.com/AY1920S1-CS2103-T16-1/main/blob/master/docs/UserGuide.adoc#shows-a-page-displaying-the-user-profile-of-the-user-bio[here] for more information on the `bio` command from the User Guide.)_
...
..._(Click https://github.com/AY1920S1-CS2103-T16-1/main/blob/master/docs/UserGuide.adoc#adds-a-biography-for-the-user-using-specified-fields-addbio[here] for more information on the `addbio` command from the User Guide.)_
...
..._(Click https://github.com/AY1920S1-CS2103-T16-1/main/blob/master/docs/UserGuide.adoc#edits-a-biography-for-the-user-using-specified-fields-editbio[here] for more information on the `editbio` command from the User Guide.)_

//ClearBio

include::../UserGuide.adoc[tag=personalisedUserExperienceClearBioPppPart1]

..._(Click https://github.com/AY1920S1-CS2103-T16-1/main/blob/master/docs/UserGuide.adoc#clears-the-biography-of-the-user-using-clrbio[here] for more information on the `editbio` command from the User Guide.)_
...
..._(Click https://github.com/AY1920S1-CS2103-T16-1/main/blob/master/docs/UserGuide.adoc#sets-the-font-color-of-the-text-fontcolour-or-fontcolor[here] for more information on the `editbio` command from the User Guide.)_
...
..._(Click https://github.com/AY1920S1-CS2103-T16-1/main/blob/master/docs/UserGuide.adoc#sets-the-background-picture-as-a-colour-or-using-a-specified-file-path-bg[here] for more information on the `editbio` command from the User Guide.)_
...
include::../DeveloperGuide.adoc[tag=userStoriesSample3]
include::../DeveloperGuide.adoc[tag=userStoriesSample5]
|=======================================================================
