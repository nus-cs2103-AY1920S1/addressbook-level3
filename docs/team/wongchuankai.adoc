...
for our Software Engineering project. We are allowed to morph it to other application that uses command line interface.
...
`EzWatchList` helps users to keep track of movie or TV show in a watch list. User can simply
