...
==== Filter Earnings: `filter_earnings` [Coming in v2.0]
...
==== List of auto added earnings: `list_auto` [Coming in v2.0]
...
==== Graph Earnings: `graph` [Coming in v2.0]
...
==== Pie Chart Earnings: `piechart` [Coming in v2.0]
