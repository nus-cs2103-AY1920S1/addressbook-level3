...
Given below are class diagrams of the `Task` class.

.High Level Class Diagram for Task
image::task/HighLevelTaskClassDiagram.png[width="40%", scaledwidth=8cm]

.Detailed Class Diagram for Task
image::task/TaskClassDiagram.png[width="30%", scaledwidth=6cm]
