...
[NOTE]
The items according to the category will only be displayed in the response box if both description and quantity fields are not specified.
If both are specified but description is invalid, only suggestions will be shown according to the mistyped description in the response box.
