...
The questions feature is the starting point for creating quizzes and starting a slideshow. With questions, you are able to manage
your existing questions, and add new ones which will be automatically saved.
...
You may refer to <<Feature-Question-Add>> for examples on how to add questions and <<Feature-Question-List>> to view the list of questions added.
