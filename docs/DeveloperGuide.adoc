...
We can see that the book holds a `Optional<Loan>` in order to have either 1 or 0 `Loan` objects. This makes it consistent with the class diagram of `Book` above.
