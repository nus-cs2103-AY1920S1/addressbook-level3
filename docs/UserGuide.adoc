...
****
*Example 1: Checking of a contact in the contacts page:* +

*Step 1:* Type `check 1` into the command box and press kbd:[Enter] to execute it

[[UG-CheckExample1]]
image::UG-CheckExample1.png[width="500"]

*Step 2:* The result box will display "Contact Shown"

[[UG-CheckExample2]]
image::UG-CheckExample2.png[width="500"]
...
****
*Example 2: Checking of a claim in the claims page:* +
...
[[UG-CheckExample4]]
image::UG-CheckExample4.png[width="500"]

*Step 2:* The result box will display "Claim Shown"

[[UG-CheckExample5]]
image::UG-CheckExample5.png[width="500"]
...
[[UG-CheckExample6]]
image::UG-CheckExample6.png[width="300"]
...
=== [Proposed Implementation] Checking for months or dates
...
//tag::statsfeature[]
//@@author{lawncegoh}
=== [Proposed Implementation] Display statistics of the application
