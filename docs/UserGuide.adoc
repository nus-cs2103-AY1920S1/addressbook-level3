...
Trying to journal about your trip to DisneyLand? The Diary allows you to add entries and keep them alive in your desktop forever.

Format: `add t/TITLE d/DATE TIME [p/PLACE] [m/MEMORY]`


| 💡
| Note that ``PLACE`` and ``MEMORY`` are optional
|
...
Example: Lets take the example of our midnight fishing trip! I can't really remember where it was...

Enter``add t/Fishing Trip d/12/12/2019 2300 m/Caught the biggest fish ever!``
image::DiaryAddNoPlaceBefore.png[TravEzy Logo]
