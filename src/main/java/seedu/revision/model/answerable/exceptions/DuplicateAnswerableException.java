package seedu.revision.model.answerable.exceptions;

/**
 * Signals that the operation will result in duplicate Answerables (Answerables are considered duplicates
