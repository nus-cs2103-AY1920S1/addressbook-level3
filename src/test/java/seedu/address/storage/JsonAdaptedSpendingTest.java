...
public class JsonAdaptedSpendingTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedSpending spending =
                new JsonAdaptedSpending(INVALID_NAME, VALID_DATE, VALID_EMAIL, VALID_COST, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedSpending spending =
                new JsonAdaptedSpending(null, VALID_DATE, VALID_EMAIL, VALID_COST, VALID_TAGS);
    ...
    public void toModelType_invalidDate_throwsIllegalValueException() {
        JsonAdaptedSpending spending =
                new JsonAdaptedSpending(VALID_NAME, INVALID_DATE, VALID_EMAIL, VALID_COST, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedSpending spending =
                new JsonAdaptedSpending(VALID_NAME, VALID_DATE, INVALID_EMAIL, VALID_COST, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedSpending spending =
                new JsonAdaptedSpending(VALID_NAME, VALID_DATE, VALID_EMAIL, INVALID_COST, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedSpending spending =
                new JsonAdaptedSpending(VALID_NAME, VALID_DATE, VALID_EMAIL, VALID_COST, invalidTags);
