...
. Type in the `create 9` command in the command line input, then press kbd:[Enter], or simply click the `+` button as shown
below.
...
. You should type in the `flip 3` command in the command line input, then press kbd:[Enter], or click the navigation button `3` for
...
. You should type in the `addphoto fp/snowymountains.jpg d/picturesque mountains` command in the command line input, then press kbd:[Enter]
...
. You can type in the `addphoto fc/` command in the command line input as highlighted in yellow below, and press the kbd:[Enter] key,
...
`append After an entire day's drive, we arrived at the bustling city of Tai Chung`, and then you press the kbd:[Enter] key.
+
...
text in between the existing lines 4 and 5, and press the kbd:[Enter] key.
+
...
. You type in the command `edit i/1 d/On the third day, we departed from the Hua Lian county and began our drive to Tai Chung.` command to fix the mistake in the first line, and press the kbd:[Enter] key.
+
...
. You type in the command `delete 1` command to delete first line entirely, and press the kbd:[Enter] key.
+
...
. You type in the `editor` command, and press the kbd:[Enter] key.
+
