...
image::CardOverview.png[width = "790"]
...
* *Code contributed*: [https://nus-cs2103-ay1920s1.github.io/tp-dashboard/#search=yhtingg&sort=groupTitle&sortWithin=title&since=2019-09-06&timeframe=commit&mergegroup=false&groupSelect=groupByRepos&breakdown=false&tabOpen=true&tabType=authorship&tabAuthor=yhtingg&tabRepo=AY1920S1-CS2103T-F11-3%2Fmain%5Bmaster%5D[Functional code]] [https://github.com[Test code]] _{give links to collated code files}_
...
|===
|_Since we had morphed the original addressbook application, we had to update the User Guide accordingly to match our app. Given below are sections that I have contributed to the User Guide, with additions regarding the card feature that I had implemented. They showcase my ability to write documentation targeting end-users._
|===
...
image::DeleteCard1.png[width = "790"]

The result box will display the message as shown.

You can see that your card is no longer visible from the list.

image::DeleteCard2.png[width = "790"]
