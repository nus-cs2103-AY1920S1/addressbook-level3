...
* `switchtab tt/display i/1` – Switches to the first display tab (i.e. `problems` tab)
* `st tt/1 i/1` – Same effects as the previous command but in a shorter format.
...
Format: `closetab tt/TAB_TYPE i/TAB_INDEX`
...
* `closetab tt/display i/1`
* `closetab tt/details i/2`
