...
+
. Success message will be displayed upon successful update.
...
+
.  Put `b` as your `TYPE` input and key in the fields you want to change. In this case, we will be changing the date and description of this Budget.
+
