...
public class SampleDataUtil {
    public static Problem[] getSampleProblems() {
        return new Problem[] {
            new Problem(new Name("Alex Yeoh"), new Phone("87438807"), new WebLink("alexyeoh@example.com"),
                new Description("Blk 30 Geylang Street 29, #06-40"),
                getTagSet("friends")),
            new Problem(new Name("Bernice Yu"), new Phone("99272758"), new WebLink("berniceyu@example.com"),
                new Description("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                getTagSet("colleagues", "friends")),
            new Problem(new Name("Charlotte Oliveiro"), new Phone("93210283"), new WebLink("charlotte@example.com"),
                new Description("Blk 11 Ang Mo Kio Street 74, #11-04"),
                getTagSet("neighbours")),
            new Problem(new Name("David Li"), new Phone("91031282"), new WebLink("lidavid@example.com"),
                new Description("Blk 436 Serangoon Gardens Street 26, #16-43"),
                getTagSet("family")),
            new Problem(new Name("Irfan Ibrahim"), new Phone("92492021"), new WebLink("irfan@example.com"),
                new Description("Blk 47 Tampines Street 20, #17-35"),
                getTagSet("classmates")),
            new Problem(new Name("Roy Balakrishnan"), new Phone("92624417"), new WebLink("royb@example.com"),
