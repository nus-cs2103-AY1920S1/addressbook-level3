...
** [blue]`edit 3 a/12`
** [blue]`find Betsy` +
[blue]`edit 1 a/-12`:Edits the 1st person in the results of the [blue]`find` command. The Find Command is detailed
in <<findCommandHome, Section 5.1.5 To Find Transactions that Match Keywords in the Home Tab>>
