...
contextually aware, by suggesting values catered to each command specifically. The possible
values will also automatically update according to changes in the database.
