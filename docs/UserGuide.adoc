...
image::findprob_1.png[width="70%", scaledwidth=10cm]
...
image::find_rule_1.png[width="70%", scaledwidth=10cm]
...
* Existing values will be updated to the input values.
* `START_DATE` should be before or equal to `END_DATE`.
* Edited start date and end date are not forced to cover all due dates of tasks in the plan. Instead, users can change the due dates afterwards to make life easier.
