...
Format: `add MODULE_CODE MODULE_TITLE MODULE_YEAR_AND_SEMESTER MODULE_FACULTY MODULAR_CREDIT GRADE`
e.g. `add <m>CS2103 <t>Software Engineering <s>1920S1 <f>Computing <c>4 <g>A`, `add <m>ACC1002 <t>Financial Accounting <s>1920S1 <f>NUS Business School <c>4 <g>A`

==== Delete module from record : `delete`
Delete a specific module from the list of modules.
