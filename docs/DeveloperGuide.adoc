...
[discrete]
=== Use case: UC11 - View the statistics of a set of flashcards with the same tag
...
[discrete]
=== Use case: UC12 - Show statistics of a particular flashcard.
Actor: user

Precondition: The flashcard exists in the system.

*MSS*

1. User [.underline]#views all existing flashcards (UC01)#.
2. User identifies the index of that flashcard which he/she wants to view progress of.
1. User requests for the progress of a flashcard by inputting the index number of that flashcard.
2. System shows the statistics of that flashcard.
