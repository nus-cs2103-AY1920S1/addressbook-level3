...
Examples: +
`help cmd/add_contact type/brief` would show you a brief description of what the
`add_contact` command does and how to use it+
`help cmd/goto type/api` opens up a page in your browser
and displays our API for the `goto` command+
`help cmd/help type/guide` opens up a page in your browser and brings you right here! :smiley:
...
[[UG-BudgetExample]]
[reftext="Figure 3.12.1"]
[caption="Figure 3.12.1: "]
.FinSec calculates your budget from the income and claim totals on the left while simultaneously +
displaying a graph of the income, claim and budget values for the current month on the right
