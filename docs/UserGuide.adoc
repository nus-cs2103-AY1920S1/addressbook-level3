...
* `add n/John Doe ic/S9999999J p/98765432 e/johnd@example.com a/John street, block 123, #01-01 b/12.09.1980 pol/SeniorCare t/high-priority`

=== Adding a policy: `addpolicy`

Adds a policy to the list of policies +
Format: `addpolicy  add pol n/NAME d/DESCRIPTION c/TIME_PERIOD p/PRICE [sa/START_AGE] [ea/END_AGE]... [t/TAGS]...`
...
* `add pol n/SeniorCare d/care for seniors c/10months p/$50000 [sa/50 ea/75]`
...
Format: `edit INDEX [n/NAME] [ic/NRIC] [p/PHONE] [e/EMAIL] [a/ADDRESS] [b/BIRTHDAY]`
...
Edits an existing person in the address book. +
Format: `edit INDEX [n/NAME] [d/DESCRIPTION] [c/TIME_PERIOD] [p/PRICE]`
...
=== Locating people by keywords: `findtagpeople`

Finds people who have the specified tag(s). +
Format: `findtagpeople KEYWORD [MORE_KEYWORDS]`

****
* The search is case insensitive
* The order of the keywords does not matter
* Only full words will be matched
* People matching at least one keyword will be returned
* People matching more keywords will be presented first
****

=== Locating policies by keywords: `findtagpolicy`

Finds policies who have the specified tag(s) +
Format: `findtagpolicy KEYWORD [MORE_KEYWORDS]`
...
Expected Output:
```
New person added: John Doe Phone:98765432 Email:johnd@example.com Address:John street, block 123, #01-01 Birthday 12th September 1980 Policy: SeniorCare Tags: high_priority
...
Expected Output:
```
New person added: John Doe NRIC: S9999999J Email:johnd@example.com Address:John street, block 123, #01-01 Birthday 12th September 1980 Policy: SeniorCare Tags: high_priority
...
Expected Output:
```
New person added: John Doe NRIC: S9999999J Phone: 98765432 Address:John street, block 123, #01-01 Birthday 12th September 1980 Policy: SeniorCare Tags: high_priority
...
* *Add Person* `add n/NAME ic/NRIC p/PHONE_NUMBER e/EMAIL a/ADDRESS b/BIRTHDAY [pol/POLICY] [t/TAG]…​` +
e.g. `add n/John Doe ic/S9999999J p/98765432 e/johnd@example.com a/John street, block 123, #01-01 b/12.09.1980 pol/SeniorCare t/high-priority`
* *Add Policy* `addpolicy  add pol n/NAME d/DESCRIPTION c/TIME_PERIOD p/PRICE [sa/START_AGE] [ea/END_AGE]... [t/TAGS]...` +
e.g. `add pol n/SeniorCare d/care for seniors c/10months p/$50000 [sa/50 ea/75]`
* *List People* : `listpeople`
* *List Policies* : `listpolicies`
* *Edit Person* : `edit INDEX [n/NAME] [ic/NRIC] [p/PHONE] [e/EMAIL] [a/ADDRESS] [b/BIRTHDAY]` +
e.g. `edit 2 n/James Lee e/jameslee@example.com`
* *Edit Policy* : `edit INDEX [n/NAME] [d/DESCRIPTION] [c/TIME_PERIOD] [p/PRICE]` +
...
* *Find people by keywords*: `findtagpeople KEYWORD [MORE_KEYWORDS]` +
e.g. `findtagpeople smoker diabetic`
* *Find policy by keywords*: `findtagpolicy KEYWORD [MORE_KEYWORDS]` +
e.g. `findtagpolicy smoker diabetic`
