...
/**
 * Command with an option containing two arguments and one variable argument.
 */
public class OptionalTwoArgumentsOneVarArgumentCommandStub extends Command {

    private String argument1;
    private String argument2;
    private final List<String> arguments;

    private OptionalTwoArgumentsOneVarArgumentCommandStub(Builder builder) {
    ...
    private static class Builder extends CommandBuilder {
        ...
        protected Map<String, OptionalArgumentList> defineCommandOptions() {
            return Map.of("-o", ArgumentList.optional()
        ...
        protected Command commandBuild() {
            return new OptionalTwoArgumentsOneVarArgumentCommandStub(this);
        }
    }
}
