...
My team of five members consists of four Year 2 Computer Science Undergraduate students, including me, and a
...
** Extracted Repetitive Code in All Packages:
https://github.com/AY1920S1-CS2103T-T13-3/main/pull/133[(PR #133)],
https://github.com/AY1920S1-CS2103T-T13-3/main/pull/385[(PR #385)]
...
|Alternative 1 has been implemented. Alternative 1 allows the data file to be exported in the desired order anytime while treasurerPro is running while
...
`Logic`.
|Alternative 2 has been implemented. The new interface acts as a facade for `ModelManager` which prevent unwanted modifications
...
|Alternative 1 has been implemented. An `ArrayList` has better performance for the set and get methods than a `LinkedList` which would be used frequently in `ModelManager`.
|===
