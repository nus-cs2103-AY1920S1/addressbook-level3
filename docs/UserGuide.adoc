...
[NOTE]
The `display_schedule_between` command will display all events that span across the specified date range, to have a more
detailed view of all the event day and timing, you could either do a fetch event command or simply double click the event.
