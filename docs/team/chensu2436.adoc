...
*** Reviewed User Guide and Developer Guide for other teams in class
...
[NOTE]
_Due to page limit, only 1 find command example is included. Please refer to User Guide 3.4 for more examples._
...
[NOTE]
_Due to page limit, only Find Section in Manual Testing is shown. Please refer to Developer Guide Appendix E for the Clash section._
