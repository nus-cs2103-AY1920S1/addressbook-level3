...
import seedu.address.storage.IncidentManagerStorage;
...
public class MainApp extends Application {
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            ...
            logger.warning("Problem while reading from the file. Will be starting with an empty IncidentManager");
            initialData = new IncidentManager();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting IncidentManager " + MainApp.VERSION);
