...
The MAMS system provides display commands to view the expanded details of any particular object,
a suite of commands for resolving appeals, checking timetable clashes, overriding MC limits, and leaving special notes on students.
...
** Highlights: There are a few types of checks can be performed. Therefore, the user inputs for this command can take various forms.
...
This feature provides a convenient way to search items that admin is more interested in.
...
[NOTE]
Due to page limit, only 1 find command example is included. Please refer to User Guide 3.4 for more examples.

== Contributions to the Developer Guide

|===
|_Given below are sections I contributed to the Developer Guide Design and Implementation section. They showcase my ability to write technical documentation and the technical depth of my contributions to the project._
|===
