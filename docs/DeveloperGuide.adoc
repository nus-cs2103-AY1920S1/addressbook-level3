...
|`* * *`|lecturer|manage the contents of the lecture notes I present|all the material I plan to cover is present, with no omissions or redundancies|Jeremy

|`* * *`|student|review lecture content|I can study well for my exams|Jeremy
