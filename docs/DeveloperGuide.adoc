...
* default mode with no date input: generates on completed order total `profit` , `cost` or `revenue`
* mode with date input: takes in 2 `dates`, starting date and ending date and generates the `profit`
