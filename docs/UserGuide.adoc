...
Our application requires the strict adhering of parameters to certain constraints to prevent feature flaws and functionality bugs. Listed below are category of parameter, the prefixes utilizing them and their constraints.
...
| _No Prefix_
a| 
* The index refer to the index number of an employee/event in the displayed employee/event list.
