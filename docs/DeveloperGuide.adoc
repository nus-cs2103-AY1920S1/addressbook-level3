...
.Sequence diagram for a find command
image::FindSequenceDiagram.png[Find Sequence Diagram]
...
.Activity diagram for a find command
image::FindActivityDiagram.png[Find Activity Diagram]
...
'''
[discrete]
=== UC08 Import external data from a CSV file
...
'''
[discrete]
=== UC09 Export data to a CSV file
