...
.Model Interface
image::model/ModelInterfaceClassDiagram.png[]
...
image::storage/HistoryManagerStorageClassDiagram.png[300,200]

.`JsonSerializableCcaTracker`
image::storage/CcaTrackerStorageClassDiagram.png[600,400]

.`JsonSerializableCoursePlanner`
image::storage/CoursePlannerStorageClassDiagram.png[300,200]

.`JsonSerializableFinanceTracker`
image::storage/FinanceTrackerStorageClassDiagram.png[600,400]

.`JsonSerializablePlanner`
image::storage/PlannerStorageClassDiagram.png[600,400]
...
image::undoredo/UndoCommandActivityDiagram.png[]

.Activity Diagram for redo command
image::undoredo/RedoCommandActivityDiagram.png[]
...
image::undoredo/InverseCommandActivityDiagram.png[]
...
image::undoredo/HistoryManagerModelClassDiagram.png[]
...
image::undoredo/CommandClassDiagram.png[]
...
image::undoredo/UndoSequenceDiagramNew.png[]
...
image::undoredo/RedoSequenceDiagramNew.png[]
...
* `Model#hasPurchase(Purchase)` - Checks for the existence of the purchase
...
* `Model#getTotalSpending()` - Returns the total expenditure by the user to be
    rendered onto Ui

* `Model#calculateRemainingAmount()` - Calculates the remaining amount
    available to user

* `Model#getRemainingAmount()` - Returns the remaining amount available to
    user to be rendered onto Ui
...
The class diagram for CcaTracker is shown below:

image::model/ModelCcaTrackerClassDiagram.png[]
