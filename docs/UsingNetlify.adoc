...
+
. You will then be brought to the setup page. Click `GitHub` to webLink your repository to Netlify.
...
+
image:netlify/netlify_details.png[Netlify details webLink, width = 630]
