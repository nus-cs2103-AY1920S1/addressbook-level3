...
public class PerformanceCommandTest {
    ...
    private static final Record VALID_RECORD = new Record(VALID_ATHLETICK_DATE, VALID_TIMING);
    ...
    public void execute_validIndexUnfilteredList_success() {
        ...
        PerformanceCommand performanceCommand =
            new PerformanceCommand(INDEX_FIRST_PERSON, VALID_EVENT, VALID_ATHLETICK_DATE, VALID_TIMING);

        String expectedMessage = performanceCommand.getSuccessMessage(
            person, VALID_EVENT, VALID_ATHLETICK_DATE, VALID_TIMING);
    ...
    public void execute_invalidIndexUnfilteredList_throwsCommandException() {
        ...
        PerformanceCommand performanceCommand =
            new PerformanceCommand(outOfBoundIndex, VALID_EVENT, VALID_ATHLETICK_DATE, VALID_TIMING);
