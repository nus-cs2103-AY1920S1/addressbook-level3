...
public class InventoryUi {
    private static final Logger logger = LogsCenter.getLogger(InventoryUi.class);
    ...
    public static String editedTransaction(Item editedTransaction) {
        return "Edited Transaction:\n" + editedTransaction;
    }

    public String addedItem(Item transaction) {
        return "Added Transaction:\n" + transaction;
    }

    public String deletedItem(Item transaction) {
