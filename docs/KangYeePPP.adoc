...
[[update-reimbursement-ppp]]The following sequence diagram shows how the reimbursement `Model` and `Storage` is updated.
...
After this, the reimbursement tab is updated as shown in <<update-reimbursement-ppp, Figure 12>>.
