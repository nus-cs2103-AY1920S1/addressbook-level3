...
Examples: +
`help cmd/add_contact type/brief` would show you a brief description of what the `add_contact` command does and how to use it +
`help cmd/goto type/api` opens up a page in your browser and displays our API for the `goto` command +
