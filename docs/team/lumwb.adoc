...
for repeated events. Events can also have their own colors to allow users to easily identify and categorize their events.
...
* *Highlights:* The implementation of this feature was rather challenging, as every event in NJoy teaching assistant had to be converted into a ics-compliant format, which
