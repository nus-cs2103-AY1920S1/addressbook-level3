...
image::AddAssignmentActivityDiagram.png[]
...
the value "Not Submitted" will be paired with the key. Should the Assignment have been Completed, the value
"Late to the party" will be paired instead, indicating that the student does not need to submit said assignment any longer,
since it has already been graded before he/she joined the classroom.
