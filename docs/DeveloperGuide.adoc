...
The following class diagram shows the structure of the `OfflineDocument` which supports annotations:
//TODO: draw object diagram of this possible state
.Structure of `OfflineDocument` designed to support annotations.
//image::AnnotationOfflineDocumentClassDiagram.png[]
