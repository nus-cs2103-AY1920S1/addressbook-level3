...
Format: `*autotag* TAG_NAME [n/NAME_KEYWORD]... [nn/NOT_NAME_KEYWORD]...
[u/URL_KEYWORD]... [nu/NOT_URL_KEYWORD]... [f/FOLDER]... [nf/NOT_FOLDER]...
[t/TAG]... [nt/NOT_TAG]...`
...
Notes or highlights that can be made on <<offline-copy, offline copies>> of a bookmark.
...
An offline copy of a bookmarked website that is stored as a HTML file on the computer.
