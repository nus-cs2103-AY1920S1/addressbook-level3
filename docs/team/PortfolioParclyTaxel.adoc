...
** Image support was implemented in https://github.com/AY1920S1-CS2103T-F11-4/main/pull/67[#67]. Instead of a custom class,
...
grew to have four boolean variables representing command side effects. I replaced the boolean arguments of
this constructor with a single integer argument acting as a bit field.
...
https://nus-cs2103-ay1920s1.github.io/tp-dashboard/#search=&sort=groupTitle&sortWithin=title&since=2019-09-06&timeframe=commit&mergegroup=false&groupSelect=groupByRepos&breakdown=false&tabOpen=true&tabType=authorship&tabAuthor=Parcly-Taxel&tabRepo=AY1920S1-CS2103T-F11-4%2Fmain%5Bmaster%5D[here].
