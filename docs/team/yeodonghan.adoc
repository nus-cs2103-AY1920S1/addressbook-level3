...
*** Added Customer, Phone, Order and schedule storage. (Pull requests https://github.com[#133], https://github.com[#118], https://github.com[#121], https://github.com[#125])
*** Wrote tests for Storage module (Pull request https://github.com[#291])

** Documentation:
*** Tweaked AB3 user guide to fit our application: https://github.com[#176]
*** Edited and added diagrams to Developer Guide: https://github.com[#157] https://github.com[#190]

** Community:
*** PRs reviewed (with non-trivial review comments): https://github.com[#101], https://github.com[#119]
