...
public class OfflineCommand extends Command {
    ...
    public static final String MESSAGE_OFFLINE_BOOKMARK_ACKNOWLEDGEMENT = "Opening cached Bookmark: %1$s";
    ...
    public CommandResult execute(Model model, Storage storage) throws CommandException {
        ...
        if (version < 0 || version >= cachedCopies.size()) {
        ...
        return new OfflineCommandResult(String.format(MESSAGE_OFFLINE_BOOKMARK_ACKNOWLEDGEMENT, bookmarkToOpen));
    }
}
