...
image::Activity.png[Activity, 400, 500]
...
image::../images/InviteExample.png[InviteExample, 450, 600]

Step 2: Observe the output in result box and the activity details box.

image::InviteOutput.png[InviteOutput, 400, 600]
...
image::DisinviteExample.png[DisinviteExample, 300, 500]
...
image::DisinviteCommand.png[DisinviteCommand, 450, 600]

Step 2: Observe the output in result box and the activity details box.

image::DisinviteOutput.png[DisinviteOutput, 400, 600]
