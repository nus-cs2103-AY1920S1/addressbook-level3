...
import seedu.address.storage.JsonIncidentManagerStorage;
...
public class LogicManagerTest {
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        // Execute add command
        String addCommand = RegisterCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + USERNAME_DESC_AMY + PASSWORD_DESC_AMY;
     ...
     */
    private static class JsonIncidentManagerIoExceptionThrowingStub extends JsonIncidentManagerStorage {
        private JsonIncidentManagerIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
