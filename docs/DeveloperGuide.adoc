...
<span class="underline">Use case: UC3 – Delete Trip</span>
...
<span class="underline">Use case: UC4 – Add Day</span>

**MSS**

1.  User chooses to add a **Day** to a specified **Trip**

2.  User <span class="underline">edits the day (UC5)</span>
...
<span class="underline">Use case: UC5 – Edit Day</span>
...
3b2. User chooses to <span class="underline">add/edit/delete (UC 7/8/9)
**Event**</span>
...
<span class="underline">User case: UC6 – Delete Day</span>
...
<span class="underline">User case: UC7 – Add Event</span>

**MSS**

1.  User chooses to add a **Event** to a specified **Day**

2.  User <span class="underline">edits the event (UC5)</span>
...
<span class="underline">User case UC8 – Edit Event</span>
...
<span class="underline">User case UC9 – Delete Event</span>
...
1.  Should work on any [mainstream
    OS](https://se-education.org/addressbook-level3/DeveloperGuide.html#mainstream-os) as
