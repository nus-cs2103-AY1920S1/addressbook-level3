...
class AddCommandAllocatorTest {
    ...
    void allocate_correctUserInput_success() {
        ...
        assertAllocatorSuccess(addCommandAllocator, "mentor " + NAME_DESC_AMY + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + SUBJECT_DESC_AMY + ORGANIZATION_DESC_AMY, new AddMentorCommand(expectedMentor));
    ...
    void allocate_missingUserArgument_failure() {
        ...
        assertAllocatorFailure(addCommandAllocator, "issue " + NAME_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + SUBJECT_DESC_BOB + ORGANIZATION_DESC_BOB,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));
