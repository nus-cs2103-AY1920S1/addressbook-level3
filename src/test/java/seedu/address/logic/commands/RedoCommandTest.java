...
public class RedoCommandTest {
    ...
    @Test
    public void execute_undoneCommandsStackIsEmpty_showsFailureMessage() {
        assertCommandSuccess(new UndoCommand(), model, RedoCommand.MESSAGE_FAILURE, expectedModel);
    }
}
