...
The above diagram shows a generalised view of the Logic component within each package.
...
Further details on the implementation of the Parser and Command can be found below in Section 3, Implementation.

Given below is a generalised Sequence Diagram depicting the steps outlined above.
