...
** https://github.com/AY1920S1-CS2103T-F13-1/main/pull/117[[#117\]]: Increased test coverage for `SampleDataUtil`
...
** https://github.com/AY1920S1-CS2103T-F13-1/main/pull/268[[#268\]]: Increased test coverage for `UnregisterCommand`
