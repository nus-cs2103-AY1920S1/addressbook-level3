...
Emergency numbers such as 999 and 995 are just 3 digits for us to remember in times of need, however, do you ever wonder what is the work that goes behind each of those calls?
