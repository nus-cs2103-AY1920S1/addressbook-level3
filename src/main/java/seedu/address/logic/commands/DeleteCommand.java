...
/**
 * Deletes a Problem identified using it's displayed index from the address book.
 */
public class DeleteCommand extends Command {
    ...
    public static final String MESSAGE_DELETE_PERSON_SUCCESS = "Deleted Problem: %1$s";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        return new CommandResult(String.format(MESSAGE_DELETE_PERSON_SUCCESS, problemToDelete));
    }
