...
Format: `*autotag* TAG_NAME [n/NAME] [nn/NOT_NAME] [u/PARTIAL_URL] [nu/NOT_PARTIAL_URL]
[f/FOLDER] [nf/NOT_FOLDER]... [t/TAG]... [nt/NOT_TAG]...`
...
* `NOT_NAME`, `NOT_PARTIAL_URL`, `NOT_FOLDER`, and `NOT_TAG` are names, partial URLs, folders,
