...
== About the project
My team of 4 software engineering students and I were tasked with
...
We chose to morph it into an application to facilitate learning for students.
...
as well as the relevant documentation I have added to the user and developer guides in relation to these enhancements.

Note the following symbols and formatting used in this document: +
`stats`: A grey highlight (called a mark-up) indicates that this is a command that can be inputted
into the command line and executed by the application. +
*Bold*: A bolded word indicates an action to be taken by the user.

== Summary of contributions
This section shows the enhancements I have made to the project as well as other contributions.
...
The `stats` and `overview` commands give users an idea of which questions they
...
The implementation was challenging as it required changes to existing models and logic classes.
* Credits:
...
Example:
Let's say you have answered some questions from a particular subject previously
