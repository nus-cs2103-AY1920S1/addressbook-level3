...
==== Multiple Choice Cards: `<USER_INPUT>`, `front`
====
...
====
** FrontBack: `add deck/DECK_NAME front/CARD_FRONT back/CARD_BACK [priority/HIGH_OR_LOW]` +
** MCQ: `add deck/DECK_NAME front/CARD_FRONT back/INDEX_OF_CORRECT_OPTION choice/CHOICE_A choice/CHOICE_B [priority/HIGH_OR_LOW]`
====
* *edit*: `edit deck/DECK_NAME action/DESIRED_ACTION [index/CARD_INDEX] [front/NEW_FRONT_TEXT] [back/NEW_BACK_TEXT]`
- only applicable for Front-Back Cards and Multiple Choice Cards
...
*** indicate choice: `<USER_INPUT>` which is any integer
*** see question: `front`
** *Java/Javascript Cards:*
