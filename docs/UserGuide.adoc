...
. The income is added to the top of the *Transactions* tab
...
. The income includes `parents` in the `CATEGORY` field.
...
. The income is added to the top of the *Transactions* tab
. The added income is given a `parents` category.
