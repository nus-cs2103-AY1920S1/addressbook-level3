...
---
I will now walk you through an `ImportCommand` using a Sequence Diagram. +
...
3. Afterwhich, the callback essentially performs an `ImportCommand`, to load the word bank.
