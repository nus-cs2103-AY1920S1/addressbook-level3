...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_NOTE_DISPLAYED_INDEX = "The lecture note index provided is invalid";
    ...
    public static final String MESSAGE_NOTE_NOT_FOUND = "Sorry. The note is not found in the note list. "
            + "We cannot add a revision task for it.";
