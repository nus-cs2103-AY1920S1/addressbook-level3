...
* `MainWindow#setUnknownFalse()` -- Restores a previously undone address book state from its history.
* `MainWindow#setUnknownTrue()` -- Restores a previously undone address book state from its history.
