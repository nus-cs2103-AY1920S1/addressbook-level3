...
.Course Model
plantuml::diagrams/ModelCoursePlannerClassDiagram.puml[align=center]
...
`prereqTree` attribute that is checked against the user's list of taken
courses. The `prereqTree` can be either:
