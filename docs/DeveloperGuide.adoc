...
[NOTE]
The guard statement throws a command exception if the following conditions are met: `!model.isLoggedIn() && !(command instanceof LoginCommand || command instanceof AddCommand || command instanceof ExitCommand)`
