...
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.APPT_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.APP_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.BEGIN_VISIT_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.CANCEL_VISIT_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.CLEAR_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.DELETE_APPT_DESCRIPTION;
...
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.FINISH_VISIT_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.HELP_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.IMPORT_MERGE_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.IMPORT_REPLACE_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.INDEX_A_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.INDEX_P_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.LIST_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PAT_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_ADDRESS_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_APPT_DESC_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_APPT_END_DATE_AND_TIME_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_APPT_START_DATE_AND_TIME_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_EMAIL_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_FILENAME_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_INDEXES_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_NAME_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_PATIENT_INDEX_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_PATIENT_VISIT_TODO_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_PHONE_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_RECUR_DAYS_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_RECUR_HOURS_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_RECUR_MINUTES_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_RECUR_MONTHS_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_RECUR_WEEKS_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_RECUR_YEARS_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_TAG_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_VISIT_REMARKS_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_VISIT_TASK_FINISH_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_VISIT_TASK_INDEX_AND_DETAIL_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.PREFIX_VISIT_TASK_UNFINISH_DESCRIPTION;
import static cs.f10.t1.nursetraverse.autocomplete.WordDescriptionBank.REDO_DESCRIPTION;
