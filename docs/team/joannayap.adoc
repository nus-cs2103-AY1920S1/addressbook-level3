...
image::Ui.png[][height="200", width="550"]
...
** Wrote additional tests for existing features to increase coverage (Pull requests https://github.com/AY1920S1-CS2103T-F11-1/main/pull/347[#347])
...
**	Integrated a third party library (FontAwesomeFX and JFeonix) to the project (https://github.com/AY1920S1-CS2103T-F11-1/main/pull/159[#159])
