...
. Run the `unrealunity.visit.Main` and try a few commands
...
After forking the repo, the documentation will still have the UnityUnreal branding and refer to the `AY1920S1-CS2103T-F12-2/main` repo.

If you plan to develop this fork as a separate product (i.e. instead of contributing to `AY1920S1-CS2103T-F12-2/main`), you should do the following:
