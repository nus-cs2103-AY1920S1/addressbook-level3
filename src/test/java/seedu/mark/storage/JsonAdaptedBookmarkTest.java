...
public class JsonAdaptedBookmarkTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedBookmark bookmark =
                new JsonAdaptedBookmark(INVALID_NAME, VALID_URL, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedBookmark bookmark = new JsonAdaptedBookmark(null, VALID_URL, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidUrl_throwsIllegalValueException() {
        JsonAdaptedBookmark bookmark =
                new JsonAdaptedBookmark(VALID_NAME, INVALID_URL, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullUrl_throwsIllegalValueException() {
        JsonAdaptedBookmark bookmark = new JsonAdaptedBookmark(VALID_NAME, null, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidRemark_throwsIllegalValueException() {
        JsonAdaptedBookmark bookmark =
                new JsonAdaptedBookmark(VALID_NAME, VALID_URL, INVALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedBookmark bookmark =
                new JsonAdaptedBookmark(VALID_NAME, VALID_URL, VALID_REMARK, invalidTags);
