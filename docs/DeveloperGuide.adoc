...
The _UserRecommendations_ class stores the list of user likes and dislikes as a set in lowecase to prevent duplicates.
...
The following activity diagram below summarizes how the `recommend` command works: *TODO*
