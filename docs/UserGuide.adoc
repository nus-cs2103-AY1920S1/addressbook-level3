...
.Example success message that appears after keying a successful
image::SavingsSuccessMessage.png[width = 600]

.Example User's savings history after savings were added.
image::SavingsAdded.png[width = 600]
...
[NOTE]
If you click the "Savings" tab on the right panel, you will be able to view your savings history. The saving will appear GREEN in the savings history. +
Also the amount saved is deducted from your wallet, and transferred into your savings account immediately.
