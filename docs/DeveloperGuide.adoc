...
The figure below shows the sequence diagram on what happens from a simple execution of the ```game``` command. We will go through the internal mechanism of the execution of the ```GameCommand```.
