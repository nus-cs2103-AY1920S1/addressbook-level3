...
* `*undo*` +
Restores the bookmark list to the state before the previous undoable command was executed.

* `*delete* 1` +
`*delete* 2` +
`*undo* 2` +
Restores the bookmark list to the state before the 2 `*delete*` commands were executed.
// end::undo-command[]
