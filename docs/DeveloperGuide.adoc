...
It has two required fields, and three optional fields:
...
It has one required field, and three optional fields:
...
`EventSource`, `TaskSource` and their respective builders, have appropriate annotations to facilitate serialization and deserialization.
