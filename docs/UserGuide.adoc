...
If successfully deleted, the result box (red box) will display message "_Deleted event:_" followed by the name
of the event you just deleted, as shown in the diagram below.
