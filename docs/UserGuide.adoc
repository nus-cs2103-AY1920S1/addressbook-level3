...
* `delete 12` +
Deletes the 12th repeater in the current list. Also deletes the associated transactions.

==== Finding repeater: `find` [Coming in v2.0]

Finds repeaters whose description matches all the (case-insensitive) given keywords. +
Format: `find KEYWORD [MORE_KEYWORDS]`

Examples:

* `find phone john` +
Finds all repeaters whose description contains all of the keywords "phone" and "john".
