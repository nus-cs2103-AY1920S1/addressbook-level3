...
The following diagram shows the current UI of the password management:
...
* *Code contributed*: https://nus-cs2103-ay1920s1.github.io/tp-dashboard/#search=hooncp&sort=groupTitle&sortWithin=title&since=2019-09-06&timeframe=commit&mergegroup=false&groupSelect=groupByRepos&breakdown=false&tabOpen=true&tabType=zoom[RepoSense]
