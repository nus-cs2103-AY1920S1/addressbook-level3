...
include::../UserGuide.adoc[tag=FeatureDeleteStudent]

include::../UserGuide.adoc[tag=FeatureEditStudent]

include::../UserGuide.adoc[tag=FeatureFind]
...
include::../UserGuide.adoc[tag=FeatureList]

include::../UserGuide.adoc[tag=FeatureCd]
