...
public class JsonAdaptedMemeTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedMeme meme =
                new JsonAdaptedMeme(INVALID_NAME, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedMeme meme = new JsonAdaptedMeme(null, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedMeme meme =
                new JsonAdaptedMeme(VALID_NAME, INVALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedMeme meme =
                new JsonAdaptedMeme(VALID_NAME, VALID_ADDRESS, invalidTags);
