...
public abstract class EditCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Edits the details of the entity identified "
            ...
            + "Constraints for editing interviewees:\n"
            + "An empty tag prefix t/ can be supplied to reset the tags of an interviewee.\n"
            + "If a department prefix d/ is supplied, there must be at least one non-empty, valid department.\n"
            + "if a slot prefix s/ is supplied, there must be at least one non-empty, valid slot.\n"
            ...
            + "[" + PREFIX_SLOT + "SLOT]... "
            + "[" + PREFIX_TAG + "TAG]...\n"
            + "Constraints for editing interviewers:\n"
