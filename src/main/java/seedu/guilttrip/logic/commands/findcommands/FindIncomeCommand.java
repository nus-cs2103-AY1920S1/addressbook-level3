...
/**
 * Finds and lists all incomes in guiltTrip with fields matching any of the predicates.
...
public class FindIncomeCommand extends Command {
    ...
    /**
     * Filters the list of Income by the conjuction of the existing predicates.
