...
. Run the `seedu.employeeAddress.Main` and try a few commands
...
. Configure the <<Documentation#Docs-SiteWideDocSettings, site-wide documentation settings>> in link:{repoURL}/build.gradle[`build.gradle`], such as the `site-employeeName`, to suit your own project.
