 ...
 */
public class HealthRecordsWindow extends UiPart<Stage> {

    private static final String FXML = "HealthRecordsWindow.fxml";
    ...
    public HealthRecordsWindow(Stage primaryStage, Logic logic) {
