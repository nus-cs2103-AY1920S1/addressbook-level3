...
**[Coming in v2.0]** You can use the parameter `b/` to export only the displayed
list of bookmarks, without any offline copies, folders, reminders, or autotags.
...
URL keywords, or folders that bookmarks to be tagged should *not* match.
