...
* View your main branch's deployed documentation on the site planName given by Netlify (customizable as shown <<Changing the site planName of your project, below>>).
+
image:netlify/temp_site_name.png[Temporary site planName, width = 630]
+
...
== Changing the site planName of your project
If you don't like the site planName given by Netlify, you can change it as follows:

. Click on `Settings`.
+
. Then click `Change site planName` and fill in your desired site planName.
+
image:netlify/change_site_name.png[Change site planName, width = 630]
