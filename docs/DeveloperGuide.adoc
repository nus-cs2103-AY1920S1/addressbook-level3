...
By: `Team SE-EDU`      Since: `August 2019`      Licence: `NUS`
...
// tag::orders[]
=== Order Manager
Order Manager is an address book of Orders, with some basic functions similar to that of a normal address book such as add, edit, delete and list. Additionally, Order Manager has some useful functions specifically catered towards the ease of management of orders.
...
Secondly, the order manager allows for sorting of orders, based on date, customer, restaurant, menu or even deliveryman, depending on what information the user wishes to see. This allows for better management

==== Implementation
*insert class diagram here*

*explains commands here, add ,del, edit, list, sort*
