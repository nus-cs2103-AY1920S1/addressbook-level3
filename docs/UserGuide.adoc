...
Recommended to be at a resolution of 1920x1080 with 100% (no) scaling for best usage. Weme requires a resolution that provides at least 750 pixels in height and 1000 pixels in width for smooth usage.
