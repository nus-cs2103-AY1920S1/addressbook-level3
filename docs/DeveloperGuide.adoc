...
* `Statistics#getPortionMembersByTasks()` -- Retrives statistics of all the members and number of tasks completed by the each individual member.
* `Statistics#getPortionMembersByItems()` -- Retrives statistics of all the members and number of items purchased by the each individual member.
* `Statistics#getPortionTasksByStatus()` -- Retrives statistics of all existing tasks and number of tasks of each status.
