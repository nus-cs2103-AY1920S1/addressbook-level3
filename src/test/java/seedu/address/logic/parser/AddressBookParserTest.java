...
public class AddressBookParserTest {
    ...
    public void parseCommand_add() throws Exception {
        ...
        AddCommand command = (AddCommand) parser.parseCommand(PersonUtil.getAddCommand(note));
        assertEquals(new AddCommand(note), command);
    }
    ...
    public void parseCommand_edit() throws Exception {
        Note note = new PersonBuilder().build();
        EditCommand.EditNoteDescriptor descriptor = new EditNoteDescriptorBuilder(note).build();
