...
[start=3]
3. The show can now be viewed under the watched tab by clicking the watched tab or hitting the keyboard shortcut kbd:[1].
...
* When searching based on actor, only shows from the watchlist and internal database (if online) will be searched.
