...
include::../UserGuide.adoc[lines=1132..1162]

*The following is an example of Statistics Generation*:

include::../UserGuide.adoc[lines=1234..1304]
...
include::../DeveloperGuide.adoc[lines=1130..1154]

{nbsp} +

*The following is an example of Statistics Generation*:

include::../DeveloperGuide.adoc[lines=1241..1281]
