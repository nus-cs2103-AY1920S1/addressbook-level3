...
[width="100%",cols="5%,95%", grid=none]
|===
ifdef::env-github[| :white_check_mark: a| The list of liked and disliked categories, tags and locations will be shown.]
ifndef::env-github[a| icon:check[role="green", size="2x"] a| The list of liked and disliked categories, tags and locations will be shown.]
|===
...
Only use the command if you are sure that you want to clear your likes and dislikes!
