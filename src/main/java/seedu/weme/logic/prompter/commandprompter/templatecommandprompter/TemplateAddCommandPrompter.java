...
import static seedu.weme.logic.commands.templatecommand.TemplateAddCommand.MESSAGE_USAGE;
...
/**
 * Prompt possible arguments for TemplateAddCommand.
 */
public class TemplateAddCommandPrompter implements Prompter {
    ...
    public CommandPrompt prompt(Model model, String userInput) throws PromptException {
        ...
        LastArgument lastArgument = getLastArgument(arguments, PREFIX_NAME, PREFIX_FILEPATH);
        ...
        String inputWithoutLastArgument = removeLastArgument(userInput, PREFIX_NAME, PREFIX_FILEPATH);
