...
image::ArchitectureDiagram.png[width=70%, scaledwidth=70%]
...
image::gui/SwitchTabsSequenceDiagram3.png[width=100%, scaledwidth=14cm]
...
.. Other incorrect delete commands to try: `delete`, `deleteprob x` (where x is larger than the list size) +
