...
* `add n/John Doe ic/S9999999J p/98765432 e/johnd@example.com a/John street, block 123, #01-01 dob/12.09.1980 g/Male`: adds contact
...
****
* `DATE_OF_BIRTH` are in the form `DD.MM.YYYY` and must be before current time.
