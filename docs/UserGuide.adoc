...
Adds tag/s to the expense at the specified index. +
{nbsp} +
Usage:
...
* t/ : Specifies name of the tag/s to be added to the expense.(REQUIRED) +
{nbsp} +
+
Example: +
...
Deletes tag/s from the expense of the specified index. +
{nbsp} +
Usage:

 tag rm [INDEX] [TAG]

* t/ : Specifies name of the tag/s to be removed from the expense.(REQUIRED) +
{nbsp} +
+
Example: +
...
* t/ : Specifies name of the tag/s to filter expenses with.(REQUIRED) +
{nbsp} +
Example: +
