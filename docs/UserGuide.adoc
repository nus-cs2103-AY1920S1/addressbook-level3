...
image::add1.png[width="790"]

Step 1. User click (or press kbd:[3]) on search page. User then input `add 1` on command box.

image::add2.png[width="790"]

Step 2. User click (or press kbd:[1]) on watch list page. User will see `Joker`
movie added to watch list.

image::add3.png[width="790"]
...
Searches for shows whose names contain any of the given keywords from the watchlist, watched list and online/internal
database. +
...
* by actor (from watchlist/internal database): +
...
[start=1]
1. You want to search for the movie "Avengers". +
...
* typing `search` in the command box and pressing kbd:[enter]

image::SearchPage.png[width="790"]

*Scenario 1: You are offline*
...
image::SearchAvengers.png[width="790"]
...
image::Sync1.png[width="790"]

Step 1. User searches for `Titanic` show in search page.

image::Sync2.png[width="790"]

Step 2. `Titanic` result page will be displayed.

image::Sync4.png[width="790"]

image::Sync5.png[width="790"]

User input `sync 2` to synchronise movie at index 2 of the list with a movie
of same name in watchlist.

Step 3. Go to watchlist. New information of `Titanic` in watchlist will be displayed.

image::Sync6.png[width="790"]

Scenario 2. User has not input Titanic show into watchlist manually.

image::Sync21.png[width="790"]
...
image::Sync22.png[width="790"]

Step 3. User can choose to use `add 1` command to add show of index 1 found in search result page.

image::Sync23.png[width="790"]


****
*Note*

* User have added their show with their own information. However, user might not know some of the parameters such as actors.
