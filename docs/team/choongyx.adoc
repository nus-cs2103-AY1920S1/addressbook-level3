...
** What it does: It allows the user view their spending in the form of a pie-chart which organises the user's expenditure based on tags.
...
** What it does: It allows the user view their spending in the form of a graph based on a date range provided.
...
*** Managed jar release `v1.2.1`  on GitHub

** Enhancements to existing features:
*** Refactored and modified existing class `Cost` to `Address` to fit the needs of our application.
