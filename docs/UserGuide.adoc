...
=== Adding a new folder *`newfolder`*

Creates a new folder for organizing bookmarks into.

Format: `*newfolder* FOLDER_NAME [p/PARENT_FOLDER]`

****
* `FOLDER_NAME` must not have already existed.
* `PARENT_FOLDER` must be an existing folder.
* If `PARENT_FOLDER` is not specified, `FOLDER_NAME` will have no parent, and be at the root.
****

Examples:

* `*newfolder* CS2103 p/NUS +
...
Format: `*deletefolder* FOLDER_NAME`
...
* `*deletefolder* CS2103 +
Deletes the folder named `CS2103`.
