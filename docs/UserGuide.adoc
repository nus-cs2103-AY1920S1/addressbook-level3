...
[start = 2]
1.2. To edit by its *description*, you can enter the required description and quantity as shown below.
...
1. To checkout, you can type the command "checkout" and specify the amount that the customer is paying as shown in the screenshot below.
...
1. To clear, type the "clear" command word only as shown in the screenshot below.
