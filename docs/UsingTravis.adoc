...
+
--
* Add a planDescription for the token. (e.g. `Travis CI - deploy docs to gh-pages`)
...
.  Go to the URL `\https://<your-username-or-organization-planName>.github.io/addressbook-level3/`. You should see your `README` file displayed.
