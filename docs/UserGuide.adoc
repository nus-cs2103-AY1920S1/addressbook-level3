...
Now that you have book your flight, it's time to start planning your schedule with _TravEzy's_ itinerary.Simply inform
_TravEzy_ of the events that you plan to do for that day and _TravEzy_ will help to sort and organize your schedule.

In _TravEzy_, we have broken down your events into 4 key parts, namely _Title_, _Date_, _Time_, and _Tag_.

For example, here is an Itinerary Entry about my trip to Japan
...
tasks that you can do with your itinerary. Read on to find out how you can make your day more productive using
_TravEzy_ itinerary!

=== Interface

This is what you will see when navigated to the itinerary:
