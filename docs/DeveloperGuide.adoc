...
UiLogicHelper APIs is a subset of Logic APIs and only contains transactions for AutoComplete.
...
_This section explains the how AutoComplete works with Dynamic Parsers and the rationale behind the design choice._
...
Explain future extensibility of project here.
