...
image::accountadd_1.png[]

1a. Enter the command "account add n/exchange d/expenses spent during SEP".

image::accountadd_2.png[]

1b. You have created an account to record an account named "exchange" with the successful message displayed.
...
image::accountfind_1.png[]

1a. Enter the command "account find trip".

image::accountfind_2.png[]

1b. You have found 2 accounts with their names containing the keyword "trip".
...
*`account report 1` You can view the report of the first account.
