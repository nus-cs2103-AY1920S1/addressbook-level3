...
I was given the task of modifying the existing architecture of AddressBook3 to suit our application.
Due to the increased complexity of our product, a large part of the existing architecture had to be changed.
I have summarized most of the changes into the following 4 sections:
