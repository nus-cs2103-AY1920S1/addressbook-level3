...
Edits the planName of the 2nd problem to be `permutations` and clears all existing tags.

==== Locating problems by planName: `find`
...
==== Locating training plans by planName: `findplan`
