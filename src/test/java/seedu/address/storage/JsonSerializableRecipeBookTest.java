...
public class JsonSerializableRecipeBookTest {
    ...
    private static final Path TYPICAL_RECIPES_FILE = TEST_DATA_FOLDER.resolve("typicalRecipesDukeCooks.json");
    ...
    public void toModelType_typicalRecipesFile_success() throws Exception {
        ...
        DukeCooks typicalRecipesDukeCooks = TypicalRecipes.getTypicalDukeCooks();
        assertEquals(dukeCooksFromFile, typicalRecipesDukeCooks);
    }
}
