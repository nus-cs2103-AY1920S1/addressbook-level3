...
Shows a list of all persons registered in the incident Manager. +
Format: `list`

=== Editing a person : `edit`

Edits an existing person in the incident Manager. +
...
Deletes the specified person from the incident Manager. +
Format: `delete INDEX`
...
* `list` +
`delete 2` +
Deletes the 2nd person in the incident Manager.
* `find Betsy` +
`delete 1` +
