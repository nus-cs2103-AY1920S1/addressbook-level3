...
'''
[discrete]
=== UC18 View exchange rate of a currency

*MSS*

1.  User requests to view exchange rate of a particular currency
...
[none]
* 1a. There is no amount and currency specified
+
[none]
** 1a1. MoneyGoWhere shows all exchange rates.
+
Use case ends.
