...
The Training class, containing a date, as well as a HashMap.
...
* As a person could be added into the team after some trainings have taken place, using trainings attended / total trainings would not give an accurate reflection of a Person s training attendance.
