...
For more of my personal work and the omitted details, please refer to sections 3.2 (Auto-sorting of items by name then date), 3.9 (Spelling correction with alternative recommendations), Appendix D, G.2, and G.5 to G.9 of the Developer Guide._
|===
