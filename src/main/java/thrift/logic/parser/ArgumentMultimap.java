...
public class ArgumentMultimap {
    ...
    /**
     * Returns the index specified with the "i/" prefix.
     */
    public String getIndexFromCommand() throws ParseException {
        return getSingleValue(CliSyntax.PREFIX_INDEX).orElse("");
    }
}
