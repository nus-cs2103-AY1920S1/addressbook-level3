...
** Enhanced delete commands to prompt the user once to confirm his/her deletion.
** Updated the appIcons for the application, and created the logo for the application using an online software, logomakr.
...
_Figure 3 : Code Snippet of StudyBuddyItemContainsTagPredicate#test()_
...
_Figure 4. Sequence diagram of listing items by a specified tag_
...
_Diagram 5. Activity diagram for the deletion prompt feature._

Truncated for this project portfolio. Please refer to the Developer’s guide for the full content.
