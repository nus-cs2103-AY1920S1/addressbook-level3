...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing NUStudy ]===========================");
        super.init();
    ...
    /**
     * Returns a {@code ModelManager} with {@code storage} and {@code userPrefs} data. <br>
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting NUStudy " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping NUStudy ] =============================");
        try {
