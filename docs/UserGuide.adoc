...
and the order of all `limits` should match the order of all `persons`
i.e. the first `<limit>` in the input will correspond to the first `<person>` in the input.
...
image::LoanUG2.png[width=75%,scaledwidth=75%]
...
image::LoanUG3.png[width=75%,scaledwidth=75%]
