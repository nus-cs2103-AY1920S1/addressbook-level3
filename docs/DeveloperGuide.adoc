...
Also, if there was a change to the data field of Customer, it would be less intuitive as one would need to understand the parsing
in order to modify CustomerContainsKeywordsPredicate.
