...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_CARD_DISPLAYED = "The card provided is invalid. Note that "
    ...
    public static final String MESSAGE_INVALID_CVC_DISPLAYED = "The CVC provided is incorrect";
