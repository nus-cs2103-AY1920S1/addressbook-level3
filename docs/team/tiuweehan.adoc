...
*** Furthermore, this feature transcends across all 5 components of AlgoBase: `UI`, `Logic`, `UiLogic`, `Model` and `Storage`, making it a full-stack development consisting of > 4000 lines of functional code and > 1500 lines of tests.
