...
and allows access to the Restaurant currently under EditMode.
...
and commands for EditMode can only be accessed if under `Editing` Context.
...
while the StackPane displaying the list of Restaurants originally will be filled with the restaurant's Food menu instead.
