...
public class SampleDataPasswordUtil {
    public static Password[] getSamplePasswords() {
        return new Password[] {
                new Password(new Description("Gmail"),
                        new Username("Randomguy"),
                        new PasswordValue("password")),
                new Password(new Description("Gmail1"),
                        new Username("Randomguy1"),
                        new PasswordValue("password1")),
                new Password(new Description("Gmail2"),
                        new Username("Randomguy2"),
                        new PasswordValue("password2")),
                new Password(new Description("Gmail3"),
                        new Username("Randomguy3"),
                        new PasswordValue("password3")),
                new Password(new Description("Gmail4"),
                        new Username("Randomguy4"),
