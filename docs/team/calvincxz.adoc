...
algorithm also ensures that employees cannot be allocated to events with conflicting time periods. The portable *Fetch Event Window*
also allows users to allocate events manpower in different *Tabs* inside AddMin+.
