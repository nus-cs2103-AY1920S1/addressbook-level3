...
{empty}[https://github.com/openorclose[github]] [<<Daryle#, portfolio>>]
...
{empty}[https://github.com/dorcastan[github]] [<<Dorcas#, portfolio>>]
...
{empty}[https://github.com/Na-Nazhou[github]] [<<Nazhou#, portfolio>>]
...
{empty}[https://github.com/kxyoke[github]] [<<KaiXin#, portfolio>>]
