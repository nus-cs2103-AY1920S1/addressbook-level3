...
Use this command to add a new Participant to Alfred to keep track of for your hackathon. Participants have the parameters "Name", "Phone number" and "Email address" which you must provide. The format of the command for adding a new Participant is as described below.
...
Use this command to add a new Mentor to Alfred to keep track of for your hackathon. Mentors have the parameters "Name", "Phone number" and "Email address" which you must provide.
...
* `edit participant P-1 n/NewParticipantNAme` sets the name of the participant with ID P-1 to "NewParticipantName"
...
Use this command to delete an Entity, so that Alfred no longer keeps track of that Entity.
