...
* *Appointment Management* +
** addappt: `addappt [-id <PATIENT_NAME | PATIENT_IC>] [-rec REPEATEDLY] [-num TIMES]`
** ackappt: `ackappt <REFERENCE_ID>`
** appointments: `appointments <REFERENCE_ID>`
