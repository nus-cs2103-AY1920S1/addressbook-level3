...
This section shows a summary of my role in the project, my technical ability to code, document, and other helpful contributions to the
team project.
...
Ensuring clear communication throughout the team, so that we all knew what to do. And that issues that arrived were handle smoothly and cleanly.
...
|===
|_The following is an excerpt from the Advanced Features portion:_
|===
___
...
|===
|_Given below are sections for the Api Component I wrote to introduce the design architecture in the application.
|===

include::../DeveloperGuide.adoc[tag=apicomponent]

|===
|_Given below are sections for features I wrote to illustrate the implementation of the Api Model classes, Image Retrieval, and generation of Recommendations._
|===

include::../DeveloperGuide.adoc[tag=onlinedata]
