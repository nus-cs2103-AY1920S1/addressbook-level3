...
* Improved the structure of the user guide link:https://github.com/AY1920S1-CS2103T-F13-4/main/pull/258[#258], link:https://github.com/AY1920S1-CS2103T-F13-4/main/pull/214[#214]
