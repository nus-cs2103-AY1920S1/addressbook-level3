...
public class TimeRangeTest {
    ...
    public void constructor_endBeforeStart_throwsIllegalValueException() {
        ...
        assertThrows(IllegalValueException.class, () -> new TimeRange(DayOfWeek.FRIDAY, DayOfWeek.FRIDAY, start, end));
    }
    ...
    public void overlap_differentDay_returnsFalse() throws IllegalValueException {
        LocalTime start = LocalTime.parse("09:00");
        LocalTime end = LocalTime.parse("11:00");
        TimeRange tr1 = new TimeRange(DayOfWeek.FRIDAY, DayOfWeek.FRIDAY, start, end);
        TimeRange tr2 = new TimeRange(DayOfWeek.SATURDAY, DayOfWeek.SATURDAY, start, end);
    ...
    public void overlap_sameDayOverlap_returnsTrue() throws IllegalValueException {
        ...
        TimeRange tr2 = new TimeRange(DayOfWeek.FRIDAY, DayOfWeek.FRIDAY, start, end);
        assertTrue(tr1.overlap(tr2));
        start = LocalTime.parse("08:00");
        end = LocalTime.parse("10:00");
        TimeRange tr3 = new TimeRange(DayOfWeek.FRIDAY, DayOfWeek.FRIDAY, start, end);
