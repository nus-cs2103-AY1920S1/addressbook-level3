...
/**
 * Contains integration tests (interaction with the Model) and unit tests for ListTaskDoneCommand.
 */
public class ListTaskDoneCommandTest {
    ...
    public void execute_dashboardListIsFiltered_showsCompleteSuccess() {
        ...
        expectedModel.updateFilteredDashboardList(Model.PREDICATE_SHOW_DONE_DASHBOARD);
        assertCommandSuccess(new ListTaskDoneCommand(), model,
            ListTaskDoneCommand.MESSAGE_SHOW_COMPLETE_SUCCESS, expectedModel);
    }
