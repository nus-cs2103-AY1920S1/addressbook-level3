...
/**
 * Jackson-friendly version of {@link seedu.address.model.person.User}.
 */
class JsonAdaptedUser {
     ...
     */
    @JsonCreator
    public JsonAdaptedUser(@JsonProperty("personId") String personId,
    ...
    public User toModelType() throws IllegalValueException {
        ...
        return new User(modelPersonId, modelName, modelPhone, modelEmail,
