...
These sections of the user guide teach a user how the notification feature works and how they can use the delete
command and any important considerations.
...
_{start of extract 2: document generation}_
