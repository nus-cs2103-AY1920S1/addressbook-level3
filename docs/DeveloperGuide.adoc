...
1. User request to list the tags.
2. FlashMind shows a list of all current tags.
3. User finds the tag.
...
[[flashcard]] Flashcard::
A digital card that contains a short knowledge like an English word or a geography common knowledge.
