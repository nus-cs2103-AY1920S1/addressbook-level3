...
* Defines its _API_ in an `interface` with the same exerciseName as the Component.
...
|`* * *` |Indecisive exercise |get food suggestions |save time when deciding what to eat

|`* * *` |Health conscious exercise |track my health progress |manage my diet
...
2.  A new diary is created with the specified exerciseName
...
[none]
* 1a. Diary exerciseName already exists.
+
[none]
