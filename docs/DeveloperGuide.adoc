...
* a student who is inexperienced in planning overseas trips
* don't know what is involved in planning an itinerary
* prefer desktop apps over other types
* can type fast
* prefers typing over mouse input
* is reasonably comfortable using CLI apps

*Value proposition*: Many students wish to go for overseas trips during their holidays. They are inexperienced and don't
know what is involved in planning for a trip. They require a template as a way to organise the information they have for
...
|`* * *` |organised traveller |plan my daily itinerary |I can make better use of my travel time

|`* * *` |lightweight traveller |save the itinerary to my phone |I can pack light
...
|`* *` |eager traveller |follow an activity checklist |I will not miss out on anything
...
|`*` |inexperienced planner |receive planning recommendations |I can improve my itinerary
