...
image::LoanObjectDiagram.png[width="880 align="center"]
{nbsp} +
...
image::LoaningActivityDiagram.png[width="650 align="center"]
{nbsp} +
...
image::ReturningActivityDiagram.png[width="820 align="center"]
{nbsp} +
