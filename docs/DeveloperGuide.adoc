...
//updated by Ko Gi Hun 30/09/19
[discrete]
=== Use case: (UC01) Edit selected appointment
*MSS*
...
[discrete]
//Updated by Ko Gi Hun 30/09/19
=== Use case: (UC02) Generate appointment document in PDF format
*MSS*
...
//Updated by Yu Chen
[discrete]
=== Use case: (UC03) List appointments
*MSS*
...
//Updated by Jun Hao
=== Use case: (UC04) Find appointment
*MSS*
