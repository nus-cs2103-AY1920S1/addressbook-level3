...
*** Link different models to update one another https://github.com/AY1920S1-CS2103T-T09-1/main/pull/108[#108#]
*** Wrote additional tests for existing features to increase coverage https://github.com/AY1920S1-CS2103T-T09-1/main/pull/221[#221]
