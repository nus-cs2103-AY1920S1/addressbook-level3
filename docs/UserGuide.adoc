...
Allows you to set a budget for the current month in the currency set. +
...
Shows you  current monthly budget, total spending and remaining budget in Singapore Dollars. +
*Format:* `showbudget`
