...
*** Wrote additional GUI tests to increase coverage from 50% to 72% (PR link:{pullUrl}/158[#158], link:{pullUrl}/161[#161])
...
** Community:
*** PRs reviewed: (link:{mainPullUrl}/14[example])
*** Contributed to forum discussions (link:{issuesUrl}/60[example])
