...
* Input `*autotag* NUS n/NUS n/School n/Uni` into the command box.
+
...
* Observe that an autotag named `NUS` with three name conditions (`NUS`, `School`, and `Uni`)
...
* If you want to delete the tag `NUS`, input `*autotag-delete* NUS` into the command box.
+
image::ui-screenshots/AutotagDeleteCommandUi1.png[]

* Observe that the autotag named `NUS` has been deleted from the autotag panel of the Dashboard.
