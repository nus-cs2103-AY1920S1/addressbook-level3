...
[NOTE]
The expenditure ranking chart is in decreasing order, i.e., the biggest purchases will be at the top of the list,
and the smallest purchases will be at the bottom of the list.
