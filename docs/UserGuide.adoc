...
traditional GUI apps. Interested? Jump to <<Quick Start>> to get started. Enjoy!
...
* Type the name and URL of the bookmark to be added. `add u/this n/Homepage`
+
image::AddCommandUi1.png[]
// online tab, showing mark User Guide
* The bookmark is added and can be viewed in the bookmark list.
+
...
This overwrites any note attached to paragraph 2 to a note with content “change or add note content”
