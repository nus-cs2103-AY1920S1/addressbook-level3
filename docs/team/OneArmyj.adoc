...
travel infrequently, and would require an application to organize their travelling information when they plan their
own trip itinerary. +

It is written in Java and has about 10 kLoC. The user interacts with the application using a
Command Line Interface (CLI), and it has a Graphical User Interface GUI created with JavaFX.
...
=== *Other Contributions*:
** Tools:
*** Set up https://travis-ci.com/AY1920S1-CS2103T-T09-1/main[Travis CI] for team project
*** Set up https://coveralls.io/github/AY1920S1-CS2103T-T09-1/main[Coveralls] for team project
*** Set up https://ci.appveyor.com/project/OneArmyj/main[AppVeyor] for team project
*** Set up https://ay1920s1-cs2103t-t09-1.netlify.com/[Netlify] for team project
*** Set up https://app.codacy.com/manual/OneArmyj/main/dashboard[Codacy] for team project
** Documentation:
