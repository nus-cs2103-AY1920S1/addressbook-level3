...
image::AccessActivityDiagram.png[width="400"]
...
image::SessionClassDiagram.png[width="400"]
...
image::AccessSequenceDiagram.png[width="600"]
...
User needs to key in the index of vehicle (based on the displayed vehicle list) to dispatch. If no index is provided, or the index is not a positive integer, an exception will be thrown and user will be prompted to provide a valid index.
