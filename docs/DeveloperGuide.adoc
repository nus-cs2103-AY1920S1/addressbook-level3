...
The _UserRecommendations_ class stores the list of user likes and dislikes.
...
The following activity diagram below summarizes how the `like` command works: *TODO*
...
The sequence diagram below shows how a sample `recommend` command is executed: *TODO*
