= Keyboard Flashcard (KFC) - Developer Guide
...
|`* * *` |user |find a flashCard by question |locate details of flashCards without having to go through the entire list

|`* *` |user |hide <<private-contact-detail,private contact details>> by default |minimize chance of someone else seeing them by accident

|`*` |user with many flashCards in the address book |sort flashCards by question |locate a flashCard easily
|=======================================================================
...
(For all use cases below, the *System* is the `Keyboard Flashcard` and the *Actor* is the `user`, unless specified otherwise)

[discrete]

*MSS*

1.  User requests to list all flashcards in a category
2.  System shows a list of flashcards with index
3.  User requests to delete a flashcard in the list by providing category and index
...
1.  User requests to list all flashcards in a category
2.  System shows a list of flashcards with index
3.  User requests to edit a flashcard in the list by providing category and index
