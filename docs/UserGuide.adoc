...
+
images::ui-screenshots/ExportCommandUi1.png[]
...
images::ui-screenshots/ExportCommandUi2.png[]
...
the group of bookmarks to be tagged using _conditions_ that describe the key characteristics
of the group.
