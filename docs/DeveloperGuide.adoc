...
Training plan feature allows user to create customized training plans that consist of selected problems in AlgoBase. Users can record their progress by marking problems in plans as done.
