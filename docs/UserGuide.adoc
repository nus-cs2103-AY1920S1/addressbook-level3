...
===== Itinerary Page
The _Itinerary_ page is the home page of your _Trip_. From this page, you can access your _Days_ and details for each _Day_. Below is an explanation of the user interface:
...
image::TripManager.png[title="User Interface of  __Trip Manager__"]
