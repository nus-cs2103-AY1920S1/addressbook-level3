...
|`* * *` |memey person |Easily share my memes to other platforms |I can send them in my chats
|`* * *` |meme lover |manage my collection of memes |I can view them anytime I want
|`* * *` |organised meme lover |tag memes |I can better organize my memes
|`* * *` |user |get hints on command syntax when i type |I don't have to memorise the command syntax
...
|`* * *` |user |export memes |I can backup the files or share them with another user
...
|`* *` |user |bookmark my favourite meme |I can find my favourite memes quickly
|`*` |person new to meme |get the reference to the meme I see for the first time |I can have fun as well
|=======================================================================
...
[discrete]
=== Use case: Create meme

*MSS*

1. User requests to list meme templates
2. Weme shows a list of meme template
...
[none]
** 2a1. User adds template
+
2a2. Weme interactively generates template based on user input
+
Use case ends
...
1. User opens the template tab
2. Weme opens the template tab
3. User requests to create a template, using a base picture from the disk
4. Weme displays the base picture in the editing area
5. User requests to add/move text boxes in the base picture
6. Weme adds/moves text boxes in the base picture
7. User completes template creation
8. Weme successfully creates the new template
+
Use case ends

*Extensions*
[none]
* 3. The given path is invalid
[none]
...
[discrete]
=== Use case: Import meme

*MSS*

1. User toggles the import tab
2. Weme opens the import tab
3. User requests to import a meme collection from a directory
4. Weme adds the memes from the collection into staging area
5. User deletes unwanted memes in the staging area
...
*Extensions*
[none]
* 3. The given directory path is invalid.
[none]
** 3a1. AddressBook shows an error message
+
Use case resumes at step 2

* 3. The given collection is corrupted
+
[none]
** 3a1. Weme shows an error message
+
...
1. User opens Weme
2. User requests to delete a template
3. Weme deletes the template
4. User requests to undo
5. Weme undoes the deletion restores the template
...
*Extensions*
[none]
* 5. User keys in undo again
[none]
** 5a1. AddressBook shows an error message
+
Use case resumes at step 1

* 5. User adds a template and keys in redo
[none]
** 5a1. AddressBook shows an error message
+
Use case resumes at step 1

* 6. User keys in redo again
[none]
