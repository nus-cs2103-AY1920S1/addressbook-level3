...
Upon execution of either command on the events page, you will be directed to a page where one can edit the necessary details to create a new event. This page contains a form with 4 necessary fields
