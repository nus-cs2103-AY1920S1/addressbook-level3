...
//        assertParseSuccess(parser,  PREAMBLE_WHITESPACE + MODULE_CODE_DESC_CS2100
//        + TITLE_DESC_CS2100
//                + SEMESTER_DESC_CS2100
//                + CREDIT_DESC_CS2100 + GRADE_DESC_CS2100, new AddCommand(expectedModule));
//
//        // multiple module code
//        assertParseSuccess(parser, MODULE_CODE_DESC_CS2100 + MODULE_CODE_DESC_CS2100
//        + TITLE_DESC_CS2100
//                + SEMESTER_DESC_CS2100
//                + CREDIT_DESC_CS2100 + GRADE_DESC_CS2100, new AddCommand(expectedModule));
//
//        // multiple title - last title accepted
//        assertParseSuccess(parser, MODULE_CODE_DESC_CS2100 + TITLE_DESC_CS2103
//        + TITLE_DESC_CS2100
//                + SEMESTER_DESC_CS2100
//                + CREDIT_DESC_CS2100 + GRADE_DESC_CS2100, new AddCommand(expectedModule));
//
...
//        assertParseSuccess(parser, MODULE_CODE_DESC_CS2100 + TITLE_DESC_CS2100
//                + SEMESTER_DESC_CS2100
//                + CREDIT_DESC_CS2103 + CREDIT_DESC_CS2100 + GRADE_DESC_CS2100,
//                new AddCommand(expectedModule));
//
//        // multiple grade - last grade accepted
//        assertParseSuccess(parser, MODULE_CODE_DESC_CS2100 + TITLE_DESC_CS2100
//                        + SEMESTER_DESC_CS2100
//                        + CREDIT_DESC_CS2103 + GRADE_DESC_CS2103 + GRADE_DESC_CS2100,
//                        new AddCommand(expectedModule));
//    }
//
//    @Test
...
//        + TITLE_DESC_CS2100 + CREDIT_DESC_CS2100,
//                expectedMessage);
//
...
//        + VALID_TITLE_CS2100 + CREDIT_DESC_CS2100,
//                expectedMessage);
//
//        // missing address prefix
//        assertParseFailure(parser, MODULE_CODE_DESC_CS2100 + SEMESTER_DESC_CS2100
//        + TITLE_DESC_CS2100 + VALID_CREDIT_CS2100,
//                expectedMessage);
//
//        // all prefixes missing
//        assertParseFailure(parser, VALID_MODULE_CODE_CS2100 + VALID_SEMESTER_CS2100
//        + VALID_TITLE_CS2100 + VALID_CREDIT_CS2100,
//                expectedMessage);
//    }
//
////    @Test
...
////        // invalid name
////        assertParseFailure(parser, INVALID_MODULE_CODE_DESC + SEMESTER_DESC_CS2100
// + TITLE_DESC_CS2100 + CREDIT_DESC_CS2100
////                + GRADE_DESC_HUSBAND + GRADE_DESC_FRIEND, Semester.MESSAGE_CONSTRAINTS);
////
////        // invalid phone
////        assertParseFailure(parser, MODULE_CODE_DESC_CS2100 + INVALID_SEMESTER_DESC
// + TITLE_DESC_CS2100 + CREDIT_DESC_CS2100
////                + GRADE_DESC_HUSBAND + GRADE_DESC_FRIEND, Credit.MESSAGE_CONSTRAINTS);
////
////        // invalid email
////        assertParseFailure(parser, MODULE_CODE_DESC_CS2100 + SEMESTER_DESC_CS2100
// + INVALID_TITLE_DESC + CREDIT_DESC_CS2100
////                + GRADE_DESC_HUSBAND + GRADE_DESC_FRIEND, Title.MESSAGE_CONSTRAINTS);
////
////        // invalid address
////        assertParseFailure(parser, MODULE_CODE_DESC_CS2100 + SEMESTER_DESC_CS2100
// + TITLE_DESC_CS2100 + INVALID_CREDIT_DESC
...
////
////        // non-empty preamble
////        assertParseFailure(parser, PREAMBLE_NON_EMPTY + MODULE_CODE_DESC_CS2100
// + SEMESTER_DESC_CS2100 + TITLE_DESC_CS2100
