...
set -o errexit # isExit with nonzero isExit code if any line fails
...
set -o nounset # isExit if variable is unset
...
if git ls-remote --isExit-code --heads upstream gh-pages; then
    git fetch --depth=1 upstream gh-pages
    git reset upstream/gh-pages
elif [ $? -eq 2 ]; then # isExit code of git ls-remote is 2 if branch does not exist
