...
+
. Go to https://www.netlify.com/ and click `Sign Up`. Next, click `GITHUB SIGN IN`, enter your GitHub account detail and authorize netlify.
+
...
+
. Fill out the detail as follows and then click `Deploy site`.
...
+
image:netlify/netlify_details.png[Netlify detail link, width = 630]
