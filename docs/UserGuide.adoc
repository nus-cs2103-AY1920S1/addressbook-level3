...
[NOTE]
The items according to the category will only display if both description and quantity fields are not specified. If both
are specified but description is invalid, only suggestions will be shown according to the mistyped description.
