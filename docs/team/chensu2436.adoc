...
** Project management:
*** Set up project schedule tracking using issues
...
** Documentation:
*** Convert the first draft of User Guide to ascii doc https://github.com/AY1920S1-CS2103-T11-2/main/pull/25[#25]
*** sdf
** Community:
*** PRs reviewed (with non-trivial review comments): https://github.com/AY1920S1-CS2103-T11-2/main/pull/92[#92]
*** Reported bugs and suggestions for other teams (examples:  https://github.com[1], https://github.com[2], https://github.com[3])
*** Reviewed UG and reported suggestions for other teams in class()
