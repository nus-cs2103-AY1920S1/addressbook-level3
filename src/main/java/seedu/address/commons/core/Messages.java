...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_MODULE_DISPLAYED_INDEX = "The person index provided is invalid";
    public static final String MESSAGE_INVALID_QUESTION_DISPLAYED_INDEX = "The question index provided is invalid";
    public static final String MESSAGE_MODULES_LISTED_OVERVIEW = "%1$d persons listed!";
