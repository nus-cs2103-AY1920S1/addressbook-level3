...
public class TypicalQuestions {
    ...
    private static final Question TWO_NUMBER_ADDER = new QuestionBuilder()
            ...
            .withUserProgram(new UserProgram("Adder", "public class Adder { public static void main(String[] args) { } }"))
            .build();
    ...
    private static final Question VALID_SUDOKU = new QuestionBuilder()
            ...
            .withTestCases(new TestCase("1 2 3 4 5 6 7 8 9", "True"), new TestCase("-1 -1 -1 -1", "False"))
            .withUserProgram(new UserProgram("Sudoku", "public class Sudoku { public static void main(String[] args) { } }"))
            .build();
    ...
    private static final Question PALINDROME_NUMBER = new QuestionBuilder()
            ...
            .withTestCases(new TestCase("12321", "True"), new TestCase("10111", "False"))
            .withUserProgram(new UserProgram("Palindrome",  "public class Palindrome { public static void main(String[] args) { } }"))
            .build();
    ...
    private static final Question SWAP_NODES_IN_PAIRS = new QuestionBuilder()
            ...
            .withTestCases(new TestCase("5 12 33 23", "4132"), new TestCase("2 31 01", "1232"))
    ...
    private static final Question MERGE_K_SORTED_LISTS = new QuestionBuilder()
            ...
            .withTestCases(new TestCase("3 5 3 4 1 99 0 21 34 123 3 21 3 1", "0 1 3 4 21 34 99 123"), new TestCase("1 4 1 2 3 4", "1 2 3 4"))
            .withUserProgram(new UserProgram("Merge", "public class Merge { public static void main(String[] args) { } }"))
            .build();
