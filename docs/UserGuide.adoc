...
* The `MONTH_OF_YEAR` permits formats allowable by the Natty library. This includes both relative months
and the exact month. We recommend specifying the format in the style of `MMM yyyy`, e.g. `sep 2019`.
...
|==========================
|Start Month |End Month |Result
|&#10003; |&#10003; |The start and end month would follow that specified by the user.
|&#10003; |&#10007; |The start month follows that specified by the user, and the end month
will by one year from the start month or the current month, whichever is earlier.
|&#10007; |&#10003; |The end month follows that specified by the user, and the start month
will be one year before the end month of the earliest month found in your waste archive,
whichever is later.
|&#10007; |&#10007; |The end month would be the current month, and the start month would be
one year ago or the earliest month found in your waste archive, whichever is later.
|==========================
...
* `wlist report sm/Mar 2019 em/Oct 2019`
