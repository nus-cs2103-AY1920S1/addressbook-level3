 ...
 * As such, adding and updating of questions uses Question#isSameQuestion(Question) for equality so as to ensure that
 * the question being added or updated is unique in terms of identity in the UniqueQuestionList.
 * However, the removal of a question uses Question#equals(Object) so as to ensure that the question
