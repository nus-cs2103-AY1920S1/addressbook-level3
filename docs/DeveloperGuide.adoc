...
===== Aspect: Storing of image under member
...
This section describes the pros and cons of the current and other alternative implementations of members display in +Work.
