...
https://github.com/ShirleyWangxt/ped/issues

== User guide contributions

I updated the original addressbook User Guide with instructions for the enhancements that I had added.
The following is an excerpt from my NUStudy User Guide, showing additions that I have made for the
