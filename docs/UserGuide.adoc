...
To do so, you can transfer the banana to the replenish list by typing `shift|1`, where `1` refers to item number displayed.

.Current list view of items that have expired.
image::shift_command_example.png[]
...
image::shift_replenish_example.png[]
