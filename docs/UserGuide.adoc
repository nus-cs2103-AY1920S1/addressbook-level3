...
Example: `edit 1 n/John Hoe p/97654321`  `edit 2 t/inactive
...
====
.Note:
A deliveryman can have one of the 3 statuses: *AVAILABLE*, *UNAVAILABLE*, *DELIVERING*.
====
...
[TIP]
If you just want a brief update on the current state of your deliverymen, the textual analysis shown on the right panel
