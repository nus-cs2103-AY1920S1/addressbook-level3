...
.The graphical user interface for *Typee*
image::Ui.png[]
...
TIP: This symbol indicates useful information for users to utilise Typee.
...
* *Minor enhancement*: refactored code from [https://github.com/nus-cs2103-AY1920S1/addressbook-level3[Address Book - Level 3]] to fit the context of Typee

* *Code contributed*: [https://github.com/brebeek/main[Functional code]] [https://github.com/brebeek/main/tree/add-unit-test[Test code]] _{give links to collated code files}_
...
*** Wrote additional tests for existing features to increase coverage from 88% to 92% (Pull requests https://github.com/AY1920S1-CS2103T-F14-3/main[#36], https://github.com/AY1920S1-CS2103T-F14-3/main[#38])
** Documentation:
