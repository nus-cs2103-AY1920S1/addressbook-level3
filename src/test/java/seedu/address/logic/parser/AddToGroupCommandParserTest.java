...
class AddToGroupCommandParserTest {
    ...
    void parse_success() {
        assertParseSuccess(parser,
                WHITESPACE + PREFIX_NAME + ALICE.getName().toString() + WHITESPACE + PREFIX_GROUPNAME + GROUPNAME1.toString(),
                new AddToGroupCommand(ALICE.getName(), GROUPNAME1));

        assertParseSuccess(parser,
                WHITESPACE + PREFIX_NAME + BENSON.getName().toString() + WHITESPACE + PREFIX_GROUPNAME + GROUPNAME2.toString(),
