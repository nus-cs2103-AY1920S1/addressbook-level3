...
*Cons*:
|
Alternative 1 has been implemented. An ArrayList has better performance for the set and get methods than a LinkedList which
would frequently used in `ModelManager`.
|
|===
