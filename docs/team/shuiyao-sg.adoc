...
I also envisioned more advanced features such as sorting tasks and enabling push notifications that will come in v2.0 of NUStudy.
You may refer to relevant sections in the User Guide.

Apart from addition to my individual work, I also helped the team by adding a command summary of everyone's feature. This
is shown in the following paragraphs. You may refer to the Command Summary section in the User Guide.
