...
.Adding a task
[caption="Figure 2: "]
image::addtask-ug.png[width="600"]
...
.Editing a task
[caption="Figure 3: "]
image::edittask-ug.png[width="600"]
...
[caption="Figure 5: "]
image::donetask-ug.png[width="600"]
...
The add/delete/edit/find/list/done mechanism is implemented in `DukeCooks v1.3`. It extends
...
[caption="Figure 10: "]
image::AddTaskSequenceDiagram.png[width="500"]
