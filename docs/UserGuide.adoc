...
* MYMorise's GUI consists of 3 display panels:
    ...
    The left panel - displays all expenses recorded in MYMorise. User commands do not reference from this panel and should not be made based on this panel. Commands made should reference from centre panel. The purpose of this panel is solely for displaying all expenses recorded only.
