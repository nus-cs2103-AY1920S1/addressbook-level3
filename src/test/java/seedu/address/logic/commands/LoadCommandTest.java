...
import static seedu.address.logic.commands.CommandTestUtil.VALID_FILE_NO_PREFIX_ALICE;
...
public class LoadCommandTest {
    ...
    public void setUp() {
        ...
        userPrefsTest.setAddressBookFilePath(FILE_PATH);
        model = new ModelManager(getTypicalOpenAddressBook(), getTypicalFeedList(), userPrefsTest);
    }
    ...
    public void execute_duplicateFileLoad_throwsParseException() {
        ...
        assertCommandFailure(command, model,
                String.format(LoadCommand.MESSAGE_ALREADY_LOADED, model.getAddressBookFilePath()));
    }
    ...
    public void execute_fileLoad_success() {
        ...
        ModelManager expectedModel = new ModelManager(model.getAddressBook(), model.getFeedList(), userPrefs);
