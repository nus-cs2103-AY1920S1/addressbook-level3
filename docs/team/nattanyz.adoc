...
image::stats window.png[width="650", align="center"]
...
image::deck stats window.png[width="650", align="center"]
...
*** Also updated the title of popup windows to include "FlashCard Pro:" as a prefix.
** Project management:
