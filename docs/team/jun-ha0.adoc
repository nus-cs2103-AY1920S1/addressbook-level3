...
** [red]#*_Justification:_* -# The game feature is a utility feature that allows the user to practice and exercise their typing skill,
...
The implementation was also challenging because there were various JavaFX API like javafx.animation and javafx.scene.
