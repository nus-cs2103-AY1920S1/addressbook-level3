...
:bulb: A friendly tip: If you type `help` without any other parameters, a window will appear and display a command list with similar instructions to this page!
