...
public class ClearCustomerCommandTest {
    ...
    @Test
    public void execute_nonEmptyCustomerBook_success() throws CommandException {
        ...
        new ClearCustomerCommand().execute(expectedModel, new CommandHistory(), new UndoRedoStack());
