...
[NOTE]
Changing the categories of an `out` _Transaction_ entry with similar categories to that of a _Budget_ entry to reflect changes on the budget's remaining amount will be incoming in version 2.0.
