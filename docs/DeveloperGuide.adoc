...
* **Current Choice:** Create a new `Day` class with the new updated activity list to replace the targeted `Day` class.
...
* **Alternative:** Directly updates the activity list in the targeted `Day` class.
