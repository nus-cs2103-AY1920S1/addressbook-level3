...
== Introduction
When working on Incident Manager, you will most likely find that some features and fields that are no longer necessary.
...
.invalidPersonIncidentManager.json
[source, json]
```
{
  "persons": [ {
