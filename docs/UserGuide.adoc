...
`*undo* 2` +
`*redo* 2` +
Suppose after the `*undo* 2` command, your bookmark list looks like this:
image::ui-screenshots/RedoUI1.png[]

`*redo* 2` restores the bookmark list to the state before the `*undo* 2` command was executed.
You will see the two bookmarks you just recovered get deleted again.

image::ui-screenshots/RedoUI2.png[]
...
image::ui-screenshots/FavoriteUI1.png[]
