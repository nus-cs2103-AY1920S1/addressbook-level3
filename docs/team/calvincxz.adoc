...
viewing of the association via the *fetch event* command. All related commands have *GUI features* implemented.

** What it does: This feature allows the user to allocate employees to events with filter requirements. The internal
algorithm also ensures that employees cannot be allocated to events with conflicting time periods.
