...
import static seedu.exercise.logic.commands.CommandTestUtil.VALID_PREFIX_NAME_ENDDATE;
...
public class TypicalCustomProperties {
    ...
    public static final CustomProperty ENDDATE = new CustomPropertyBuilder().withPrefix(VALID_PREFIX_NAME_ENDDATE)
