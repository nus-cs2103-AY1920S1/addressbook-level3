...
such as undo/redo, history and up/down navigation. They showcase my ability to write good documentation for target users.
...
such as undo/redo, history and up/down navigation. They showcase my ability to write good technical documentation for potential developers,
