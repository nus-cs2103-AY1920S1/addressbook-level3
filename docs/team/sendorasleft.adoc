...
=== Features
[discrete]
include::../UserGuide.adoc[tag=featuresPreamble]
...
include::../DeveloperGuide.adoc[tag=testingView]

include::../DeveloperGuide.adoc[tag=testingList]

include::../DeveloperGuide.adoc[tag=testingHistory]
