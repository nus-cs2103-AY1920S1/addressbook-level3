...
* stores a `UniqueElementList<Room>` which contains the list of rooms.
* does not depend on any of the other three components.
...
[discrete]
=== Use case: Indicate that a doctor is on-duty and able to tend to patients (UC9)
...
[discrete]
=== Use case: Editing Information in GUI (UC10)
