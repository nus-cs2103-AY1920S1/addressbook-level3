...
a given keyword as they type. However, filtering larger data sets may be time consuming process.
...
If the main window triggers another reactive search request before previous request is completed,
