...
public class InProgressDeadlineCommandTest {
    ...
    @Test
    public void execute_inProgressValidDeadline_success() {
        ...
        String message = String.format(InProgressDeadlineCommand.MESSAGE_IN_PROGRESS_DEADLINE_SUCCESS,
        ...
        InProgressDeadlineCommand command = new InProgressDeadlineCommand(moduleIndex, 1);
