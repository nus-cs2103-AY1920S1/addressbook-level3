 ...
 */
public class QuizFlashcard extends UiPart<Region> {
    ...
    public QuizFlashcard(Flashcard flashcard, int displayedIndex) {
        super(FXML);
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof QuizFlashcard)) {
            return false;
        }

        // state check
        QuizFlashcard card = (QuizFlashcard) other;
