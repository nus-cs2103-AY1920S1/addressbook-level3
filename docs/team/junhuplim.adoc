...
*Code contributed*: The links provided show my code contribution for the project. (https://nus-cs2103-ay1920s1.github
.io/tp-dashboard/#search=junhup&sort=groupTitle&sortWithin=title&since=2019-09-06&timeframe=commit&mergegroup=false
&groupSelect=groupByAuthors&breakdown=false[Reposense], https://github.com/junhuplim/main[Github Repository])
...
* Documentation
** Did major tweaks to the User Guide and Developer Guide to make it more
reader-friendly: (Pull requests https://github.com/AY1920S1-CS2103T-T12-3/main/pull/188[#188],
...
(example: https://github.com/nus-cs2103-AY1920S1/addressbook-level3/pull/29[1])
** Reported bugs and suggestions for other teams (examples:  https://github.com/junhuplim/ped/issues/5[1], https://github.com/junhuplim/ped/issues/8[2],
