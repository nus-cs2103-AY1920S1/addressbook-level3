...
+
image:netlify/grant_or_request_access.png[Grant or request access, width = 100%]
...
+
image:netlify/temp_site_name.png[Temporary site name, width = 100%]
+
...
+
image:netlify/netlify_details.png[Netlify details link, width = 100%]
...
+
image:netlify/change_site_name.png[Change site name, width = 100%]
