...
[discrete]
=== Use case: Add new appointment for a patient (UC3)
Pre-condition: Patient exists in the system

*MSS*

1.  Patient wants to have a new appointment
2.  User wants to add this appointments for patient
...
** 2a2. Actor inputs correct format +
+
...
* 2b. Actor inputs a appointment which is conflicted with other appointments
+

** 2b1. Actor ask patient to make provide a new appointment date  +
...
Pre-condition: Patient’s appointment exists

*MSS*

1.  Patient wants to Change a current appointment date
2.  User checks whether the current appointment can be changed.
3.  User checks and updates appointment's appointment time slots.
...
** 3a2. Actor inputs correct format +
+
Steps 2a1-2a2 are repeated until the appointment has the correct format +
...
** 3b1. Actor ask patient to make a new appointment  +
...
[discrete]
=== Use case: Find patients appointment (UC5)

*MSS*

1.  Actor requests to find patient's appointment list
...
[discrete]
=== Use case: Editing Information in GUI (U7)

*Actor:* Clerk

*Guarantees:*

1. Information is edited after change is completed in GUI.

*MSS:*

1. Clerk selects the tabs of information (e.g Patients, Appointments) that requires modification.
2. Clerk selects an item in the list of information.
3. Clerk selects an attribute of the item.
4. Clerk modifies the attribute.
5. Clerk completes the modificatigit on.
6. ClerkPro stores the change and displays the new information.

Use case ends.

[discrete]
=== Use case: AutoCompleter (UC8)
