...
[discrete]
=== Use case: UC10: Add bookmarks from web browser
*MSS*
1. User [.underline]#browses the web (UC09)#.
2. User requests to bookmark currently showing webpage.
3. Mark uses current website's URL and [.underline]#adds bookmark (UC02)#.
+
Use case ends.

[discrete]
=== Use case: UC11: Annotate offline documents
*MSS*
