...
(https://github.com/AY1920S1-CS2103T-T10-3/main/pull/99[PR #99]) (https://github.com/AY1920S1-CS2103T-T10-3/main/pull/119[PR #119]) -- Gave suggestion to move code block for better adherence to design principles. +
