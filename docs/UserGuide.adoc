...
facilitate courses that you have already taken. Jarvis will use such
information in the calculation of your CAP (Cumulative Average Point).

Format: `add-course c/COURSECODE g/GRADE [c/COURSECODE g/GRADE]...`

where `GRADE` can be any
