...
=== Check feature
This section is an overview of the check feature, an extended feature of the Goto feature. This feature can only be used
after going to contacts or claims page. It is used to examine each contact or claim individually.
It also provides some design considerations to give users an insight of how the current solutions are worked out.
