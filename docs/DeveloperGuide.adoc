...
image::InSequenceDiagram.png[pdfwidth=70%]
...
image::InActivityDiagram.png[pdfwidth=70%]
...
image::OutbudgetActivityDiagram.png[pdfwidth=70%]
...
determine how much of budget he has left, as well as be alarmed by the red font color to spend less if he has overspent beyond the budget set. +
...
Moreover, as our user is a visual person, PalPay makes use of color to display different messages.
...
in providing a pleasing user exp. +
...
image::UpdateActivityDiagram.png[pdfwidth=70%]
...
image::UpdatefutureActivityDiagram.png[pdfwidth=70%]
// end::update3[]
// end::update[]
...
image::SortSequenceDiagram.png[pdfwidth=80%]
...
image::sort_dg_3.png[pdfwidth=80%]
...
.After `in $/10 n/Allowance d/07112019` Command
