...
== Role
My primary role in the project was to implement the Goto, Sort, Check features. I also enhanced the existing Clear Feature. I was also handling the scheduling and tracking of the project, ensuring that deadlines are met.
