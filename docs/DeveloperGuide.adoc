...
2. System updates the calendar view to display appoinments for the specified month.
...
[discrete]
=== Use case: (UC15) Checking spelling errors

[discrete]
//Updated by Ko Gi Hun 30/09/19
=== Use case: (UC16) Generate appointment document in PDF format
*MSS*
