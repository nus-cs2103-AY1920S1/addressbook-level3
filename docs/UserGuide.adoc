...
Format: `approve appealId [APPEAL_REMARK]`

Examples:

Sample Input:

* `approve 4 rr/watch your workload`
...
Format: `reject appealId [APPEAL_REMARK]`

Examples:

Sample Input:

* `reject 1 rr/student not suitable for high work load`
...
* **approve**:
** `approve [INDEX] [REMARK]`
- e.g `approve 2 rr/meets requisites` Marks the 2nd appeal in the appeal list as approved.
...
-
** `reject [INDEX] [REMARK]`
- e.g `reject 2 rr/meets requisites` Marks the 2nd appeal in the appeal list as rejected.
