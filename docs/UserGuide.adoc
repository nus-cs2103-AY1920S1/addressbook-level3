...
This command allows you to complete an order in the database by its order name.
...
* The order name `ORDERNAME` must exist in the order list.
====
...
- Delete order: `-delete_order ORDERNAME`
