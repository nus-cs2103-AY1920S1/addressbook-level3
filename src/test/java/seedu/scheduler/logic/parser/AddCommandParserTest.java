...
public class AddCommandParserTest {
    ...
    public void parse_intervieweeAllFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + ROLE_DESC_BOB_INTVE + NAME_DESC_BOB + PHONE_DESC_BOB
        ...
        assertParseSuccess(parser, ROLE_DESC_BOB_INTVE + NAME_DESC_AMY + NAME_DESC_BOB + PHONE_DESC_BOB
                + TAG_DESC_FRIEND + FACULTY_DESC_BOB + YEAR_OF_STUDY_DESC_BOB
                + DEPARTMENT_DESC_BOB + SLOT_DESC_BOB + EMAIL_PERSONAL_DESC_BOB + EMAIL_NUS_WORK_DESC_BOB,
                new AddIntervieweeCommand(expectedInterviewee));

        // multiple phones - last phone accepted
        assertParseSuccess(parser, ROLE_DESC_BOB_INTVE + NAME_DESC_BOB + PHONE_DESC_AMY + PHONE_DESC_BOB
                + TAG_DESC_FRIEND + FACULTY_DESC_BOB + YEAR_OF_STUDY_DESC_BOB
                + DEPARTMENT_DESC_BOB + SLOT_DESC_BOB + EMAIL_PERSONAL_DESC_BOB + EMAIL_NUS_WORK_DESC_BOB,
                new AddIntervieweeCommand(expectedInterviewee));
        ...
        Interviewee expectedIntervieweeMultipleSlots = new IntervieweeBuilder(BOB_INTERVIEWEE_MANUAL)
                ...
                .build();
        assertParseSuccess(parser, ROLE_DESC_BOB_INTVE + NAME_DESC_BOB + PHONE_DESC_BOB + TAG_DESC_FRIEND
                        + TAG_DESC_HUSBAND
    ...
    public void parse_interviewerAllFieldsPresent_success() {
        ...
        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + ROLE_DESC_AMY_INTVR + NAME_DESC_AMY + PHONE_DESC_AMY
        ...
        // multiple phones - last phone accepted
        assertParseSuccess(parser, ROLE_DESC_AMY_INTVR + NAME_DESC_AMY + PHONE_DESC_BOB
                        + PHONE_DESC_AMY + TAG_DESC_FRIEND + EMAIL_NUS_WORK_DESC_AMY + DEPARTMENT_DESC_AMY
                        + SLOT_DESC_AMY,
                new AddInterviewerCommand(expectedInterviewer));
        ...
        Interviewer expectedInterviewerMultipleTags = new InterviewerBuilder(AMY_INTERVIEWER_MANUAL)
                .withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
        assertParseSuccess(parser, ROLE_DESC_AMY_INTVR + NAME_DESC_AMY
        ...
        // multiple work emails - last work email accepted
        assertParseSuccess(parser, ROLE_DESC_AMY_INTVR + NAME_DESC_AMY + PHONE_DESC_AMY + TAG_DESC_FRIEND
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, ROLE_DESC_AMY_INTVR + NAME_DESC_AMY + PHONE_DESC_AMY
    ...
    public void parse_intervieweeCompulsoryFieldMissing_failure() {
        ...
        // missing name
        assertParseFailure(parser, ROLE_DESC_BOB_INTVE + PHONE_DESC_BOB
                + FACULTY_DESC_BOB + YEAR_OF_STUDY_DESC_BOB + DEPARTMENT_DESC_BOB + SLOT_DESC_BOB
                + EMAIL_PERSONAL_DESC_BOB + EMAIL_NUS_WORK_DESC_BOB,
                expectedMessage);

        // missing phone
        assertParseFailure(parser, ROLE_DESC_BOB_INTVE + NAME_DESC_BOB
                + FACULTY_DESC_BOB + YEAR_OF_STUDY_DESC_BOB + DEPARTMENT_DESC_BOB + SLOT_DESC_BOB
                + EMAIL_PERSONAL_DESC_BOB + EMAIL_NUS_WORK_DESC_BOB,
                expectedMessage);

        // missing personal email
        assertParseFailure(parser, ROLE_DESC_BOB_INTVE + NAME_DESC_BOB + PHONE_DESC_BOB
                        + FACULTY_DESC_BOB + YEAR_OF_STUDY_DESC_BOB + DEPARTMENT_DESC_BOB + SLOT_DESC_BOB
                        + EMAIL_NUS_WORK_DESC_BOB,
                expectedMessage);
    ...
    public void parse_interviewerCompulsoryFieldMissing_failure() {
        ...
        // missing name
        assertParseFailure(parser, ROLE_DESC_AMY_INTVR + PHONE_DESC_AMY
                        + TAG_DESC_FRIEND + DEPARTMENT_DESC_AMY + SLOT_DESC_AMY + EMAIL_NUS_WORK_DESC_AMY,
                expectedMessage);

        // missing phone
        assertParseFailure(parser, ROLE_DESC_AMY_INTVR + NAME_DESC_AMY
                        + TAG_DESC_FRIEND + DEPARTMENT_DESC_AMY + SLOT_DESC_AMY + EMAIL_NUS_WORK_DESC_AMY,
                expectedMessage);

        // missing department
        assertParseFailure(parser, ROLE_DESC_AMY_INTVR + NAME_DESC_AMY + PHONE_DESC_AMY
                        + TAG_DESC_FRIEND + SLOT_DESC_AMY + EMAIL_NUS_WORK_DESC_AMY,
                expectedMessage);

        // missing slot
        assertParseFailure(parser, ROLE_DESC_AMY_INTVR + NAME_DESC_AMY + PHONE_DESC_AMY + TAG_DESC_FRIEND
    ...
    public void parse_intervieweeInvalidValue_failure() {
        // invalid name
        assertParseFailure(parser, ROLE_DESC_BOB_INTVE + INVALID_NAME_DESC + PHONE_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + FACULTY_DESC_BOB + YEAR_OF_STUDY_DESC_BOB
                        + DEPARTMENT_DESC_BOB + SLOT_DESC_BOB + EMAIL_PERSONAL_DESC_BOB + EMAIL_NUS_WORK_DESC_BOB,
                Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, ROLE_DESC_BOB_INTVE + NAME_DESC_BOB + INVALID_PHONE_DESC
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + FACULTY_DESC_BOB + YEAR_OF_STUDY_DESC_BOB
                        + DEPARTMENT_DESC_BOB + SLOT_DESC_BOB + EMAIL_PERSONAL_DESC_BOB + EMAIL_NUS_WORK_DESC_BOB,
        ...
        assertParseFailure(parser, ROLE_DESC_BOB_INTVE + INVALID_NAME_DESC + INVALID_PHONE_DESC
                        + FACULTY_DESC_BOB + YEAR_OF_STUDY_DESC_BOB + DEPARTMENT_DESC_BOB + SLOT_DESC_BOB
                        + EMAIL_PERSONAL_DESC_BOB + EMAIL_NUS_WORK_DESC_BOB,
                Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + ROLE_DESC_BOB_INTVE + NAME_DESC_BOB + PHONE_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + FACULTY_DESC_BOB + YEAR_OF_STUDY_DESC_BOB
                        + DEPARTMENT_DESC_BOB + SLOT_DESC_BOB + EMAIL_PERSONAL_DESC_BOB + EMAIL_NUS_WORK_DESC_BOB,
    ...
    public void parse_interviewerInvalidValue_failure() {
        // invalid name
        assertParseFailure(parser, ROLE_DESC_AMY_INTVR + INVALID_NAME_DESC + PHONE_DESC_AMY + TAG_DESC_FRIEND
                + DEPARTMENT_DESC_AMY + EMAIL_NUS_WORK_DESC_AMY + SLOT_DESC_AMY,
                Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, ROLE_DESC_AMY_INTVR + NAME_DESC_AMY + INVALID_PHONE_DESC + TAG_DESC_FRIEND
                        + DEPARTMENT_DESC_AMY + EMAIL_NUS_WORK_DESC_AMY + SLOT_DESC_AMY,
                Phone.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, ROLE_DESC_AMY_INTVR + NAME_DESC_AMY + PHONE_DESC_AMY + INVALID_TAG_DESC
                        + DEPARTMENT_DESC_AMY + EMAIL_NUS_WORK_DESC_AMY + SLOT_DESC_AMY,
                Tag.MESSAGE_CONSTRAINTS);
        ...
        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + ROLE_DESC_AMY_INTVR + NAME_DESC_AMY + PHONE_DESC_AMY
