...
public class MainWindow extends UiPart<Stage> {
    ...
    private static final String FXML = "MyMainWindow.fxml";
    ...
    // Independent MyUi parts residing in this MyUi container
     ...
     *
     * @see seedu.address.person.logic.Logic#execute(String)
     */
