...
+
image::view1.png[pdfwidth=70%, align="center"]
+
. Simply type *view budget* in the command box and press kbd:[Enter].
+
image::view2.png[pdfwidth=70%, align="center"]
+
. You can now view your budgets. Easy!
+
image::view3.png[pdfwidth=70%, align="center"]
...
+
image::undo3.png[pdfwidth=70%, align="center"]
// end::undo[]
