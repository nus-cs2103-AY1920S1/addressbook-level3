= ORGANice Transplant Manager - Developer Guide
...
* hospital administrative staff who needs to find matches between patients and organ donors
* prefer desktop apps over other types
* can type fast
* prefers typing over mouse input
* is reasonably comfortable using CLI apps

*Value proposition*: can find a match between a patient and potential organ donors faster than a typical mouse/GUI driven app
...
|`* * *` |user |find a patient/donor/doctor by certain keywords |locate details of persons without having to go through the entire list
...
[discrete]
=== Use case: Delete patient/donor/doctor

*MSS*

1.  User requests to list patients/donors/doctors
2.  ORGANice shows a list of patients/donors/doctors
3.  User requests to delete a specific patient/donor/doctor in the list
4.  ORGANice deletes the patient/donor/doctor
+
Use case ends.
...
+
[none]
** 3a1. ORGANice shows an error message.
+
