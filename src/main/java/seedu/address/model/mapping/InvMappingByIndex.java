...
public class InvMappingByIndex {

    private final Integer memberIndex;
    private final Integer taskIndex;
    private final Integer inventoryIndex;

    public InvMappingByIndex (Integer memberIndex, Integer taskIndex, Integer inventoryIndex) {
     ...
     */
    public boolean isSameMapping(InvMappingByIndex otherMapping) {
