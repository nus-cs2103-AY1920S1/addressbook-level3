    ...
    public static Spending[] getSampleSpendings() {
        return new Spending[]{
            ...
            new Spending(new Name("Other things"), new Date("31/10/2019"), new Remark(""),
                new Cost("30.75"),
                getTagSet()),
            new Spending(new Name("Cap"), new Date("31/10/2019"), new Remark("It says 3 on it"),
                new Cost("5.00"),
                getTagSet()),
            new Spending(new Name("Cap"), new Date("31/10/2019"), new Remark("It says 5 on it"),
                new Cost("5.00"),
                getTagSet()),
            new Spending(new Name("cap"), new Date("31/10/2019"), new Remark("got it cheap"),
                new Cost("2.50"),
                getTagSet()),
