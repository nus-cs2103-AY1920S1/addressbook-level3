...
* Documentation:
** Made modifications to the Developer Guide and improved readability: https://github.com/AY1920S1-CS2103T-W13-2/main/pull/25[#25]
...
include::../DeveloperGuide.adoc[lines=1223..1263]