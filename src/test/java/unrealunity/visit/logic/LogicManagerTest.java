...
import static unrealunity.visit.commons.core.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    public void getFilteredAppointmentList_modifyList_throwsUnsupportedOperationException() {
        Assert.assertThrows(UnsupportedOperationException.class, () -> logic.getFilteredAppointmentList().remove(0));
    }

    @Test
    public void outputReminders_throwsUnsupportedOperationException() {
        assertEquals(logic.outputReminders(),
                "Reminders:\nNo reminders found.\n\nFollow-ups:\nNo follow-ups found.\n");
    }
