...
Do refer to the syntax below that will be used across the documents for references. These will prove to be useful when you are reading this document.
...
The following is an Activity Diagram that describes the execution of the `switch` command.
