...
public class JsonSerializableShoppingListTest {
    ...
    private static final Path TYPICAL_SHOPPING_ITEMS_FILE = TEST_DATA_FOLDER.resolve("typicalShoppingItemsShoppingList.json");
    private static final Path INVALID_SHOPPING_ITEM_FILE = TEST_DATA_FOLDER.resolve("invalidShoppingItemShoppingList.json");
    private static final Path DUPLICATE_SHOPPING_ITEM_FILE = TEST_DATA_FOLDER.resolve("duplicateShoppingItemShoppingList.json");
