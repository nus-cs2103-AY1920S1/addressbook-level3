...
You type the command `*reminder* 1 t/11/11/2019 1900 n/Do the quiz` into the command box and press _Enter_ to execute it.
...
"New reminder added: Do the quiz Time: t/11/11/2019 1900 URL:https://luminus.nus.edu.sg/". +
...
* The result box will show the message: +
"Edited Reminder: Do the quiz and the assignment Time: t/11/11/2019 1900 URL:https://luminus.nus.edu.sg/". +
