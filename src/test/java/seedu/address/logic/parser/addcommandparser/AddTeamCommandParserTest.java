...
import static seedu.address.logic.commands.CommandTestUtil.INVALID_PROJECT_TYPE_DESC;
...
import static seedu.address.logic.commands.CommandTestUtil.PROJECT_TYPE_DESC_ALFRED;
...
class AddTeamCommandParserTest {
    ...
    void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_ALFRED + NAME_DESC_BRUCE
                + LOCATION_DESC_BRUCE + PROJECT_NAME_DESC_BRUCE + PROJECT_TYPE_DESC_BRUCE + SUBJECT_DESC_BRUCE,
                new AddTeamCommand(expectedTeam));
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + PROJECT_TYPE_DESC_ALFRED + NAME_DESC_BRUCE
                + LOCATION_DESC_BRUCE + PROJECT_NAME_DESC_BRUCE + PROJECT_TYPE_DESC_BRUCE + SUBJECT_DESC_BRUCE,
                new AddTeamCommand(expectedTeam));
    }
    ...
    void parse_compulsoryFieldsMissing_failure() {
        ...
        // Missing name prefix
        assertParseFailure(parser, LOCATION_DESC_BRUCE + PROJECT_NAME_DESC_BRUCE + PROJECT_TYPE_DESC_BRUCE
                + SUBJECT_DESC_BRUCE + VALID_NAME_BRUCE, expectedMessage);

        // Missing location prefix
        assertParseFailure(parser, NAME_DESC_BRUCE + VALID_LOCATION_BRUCE
                + PROJECT_NAME_DESC_BRUCE + PROJECT_TYPE_DESC_BRUCE + SUBJECT_DESC_BRUCE, expectedMessage);

        // Missing project name prefix
        assertParseFailure(parser, NAME_DESC_BRUCE + VALID_PROJECT_NAME_BRUCE
                + LOCATION_DESC_BRUCE + PROJECT_TYPE_DESC_BRUCE + SUBJECT_DESC_BRUCE, expectedMessage);

        // Missing subject prefix
        assertParseFailure(parser, NAME_DESC_BRUCE + VALID_SUBJECT_BRUCE
                + LOCATION_DESC_BRUCE + PROJECT_NAME_DESC_BRUCE + PROJECT_TYPE_DESC_BRUCE, expectedMessage);

        // Missing project type prefix
        assertParseFailure(parser, NAME_DESC_BRUCE + VALID_PROJECT_TYPE_BRUCE
                + LOCATION_DESC_BRUCE + PROJECT_NAME_DESC_BRUCE + SUBJECT_DESC_BRUCE, expectedMessage);

        // Missing all prefixes
        assertParseFailure(parser, VALID_NAME_BRUCE + VALID_PROJECT_NAME_BRUCE + VALID_PROJECT_TYPE_BRUCE
    ...
    void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BRUCE + INVALID_PROJECT_NAME_DESC
                + LOCATION_DESC_BRUCE + PROJECT_TYPE_DESC_BRUCE + SUBJECT_DESC_BRUCE, Name.MESSAGE_CONSTRAINTS);

        // Missing subject
        assertParseFailure(parser, NAME_DESC_BRUCE + INVALID_SUBJECT_DESC
                + LOCATION_DESC_BRUCE + PROJECT_NAME_DESC_BRUCE + PROJECT_TYPE_DESC_BRUCE,
                SubjectName.MESSAGE_CONSTRAINTS);

        // Missing project type
        assertParseFailure(parser, NAME_DESC_BRUCE + INVALID_PROJECT_TYPE_DESC
                + LOCATION_DESC_BRUCE + PROJECT_NAME_DESC_BRUCE + SUBJECT_DESC_BRUCE,
                ProjectType.MESSAGE_CONSTRAINTS);

        // Two invalid fields - first one reported
        assertParseFailure(parser, INVALID_NAME_DESC + INVALID_PROJECT_TYPE_DESC
                        + LOCATION_DESC_BRUCE + PROJECT_NAME_DESC_BRUCE + SUBJECT_DESC_BRUCE,
                Name.MESSAGE_CONSTRAINTS);

        // Non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BRUCE + PROJECT_TYPE_DESC_BRUCE
                + LOCATION_DESC_BRUCE + PROJECT_NAME_DESC_BRUCE + SUBJECT_DESC_BRUCE,
