...
=== Changing to calendar view : `tab b/calendar`
Changes the current view to the calendar view which displays daily engagement information.
More commands are provided for interaction with the calendar window.

Format: `tab b/calendar`
...
to change the display to the next month. The button will not work if calendar is displaying December 9999.
