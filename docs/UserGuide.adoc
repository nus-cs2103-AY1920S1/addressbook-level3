...
image::interactive_parsing_1.png[height='125' width="800"]
...
image::interactive_parsing_2.png[height='125' width='800']

.Typee's response to the above input. +
image::interactive_parsing_3.png[height='125' width='800']
...
image::interactive_parsing_6.png[width='800' height='125']
...
image::interactive_parsing_7.png[width='800' height='125']
...
image::interactive_parsing_4.png[height='125' width='800']

.Typee's response to the invalid input. +
image::interactive_parsing_5.png[height='125' width='800']
...
* `add t/Meeting s/18/10/2019/1500 e/18/10/2019/1800 l/COM-2-B1-03 d/CS2103T a/John | Elijah | Sam  Discussion p/High` +
...
[TIP]
The arguments to this command can be entered sequentially, leveraging the interaction offered by Typee. Example: `add` +
`t/meeting` `s/11/11/2019/1500` ... `p/High`
