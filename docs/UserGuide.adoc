...
image::InfoEditUI.png[width=250]
...
image::SavingsDisplay.png[width=400, align="center"]
...
image::SavingsAdded.png[width=300, align="center"]

.Example success message that appears after keying a successful saving.
image::SavingsSuccessMessage.png[width=300, align="center"]
