...
public class ListCommandParserTest {
    ...
    public void parse_invalidArgs_returnsListCommand() {
        ...
        assertParseFailure(parser, INVALID_TUTORIAL_INDEX_1,
                invalidIndexMessage);

        // Invalid index - character
        assertParseFailure(parser, INVALID_TUTORIAL_INDEX_2,
                invalidIndexMessage);

        // Invalid index - Index <= 0
        assertParseFailure(parser, INVALID_TUTORIAL_INDEX_3,
                invalidIndexMessage);
    }
}
