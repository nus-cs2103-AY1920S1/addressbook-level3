...
****
Here is an example of a part of what a user may type as a predicate expression: `p/outamt < 10`
...
****
Again, here is an example of a part of what a user may type as an action expression: `a/set_cat Cheap`
...
****
Predicate and action scripts are defined the same way. An example of both: `p/CheckIsTransport a/SetTransportFare`
