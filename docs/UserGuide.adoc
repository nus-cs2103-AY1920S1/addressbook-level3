...
image::GeneratePasswordScreenShot0.png[]

.Example outcome for generate password
image::GeneratePasswordScreenShot1.png[]
...
image::AnalysePasswordScreenShot0.png[]

.Example outcome for analyse
image::AnalysePasswordScreenShot1.png[]

.Example user input for analyse strong
image::AnalyseStrongPasswordScreenShot0.png[]

.Example outcome for analyse strong
image::AnalyseStrongPasswordScreenShot1.png[]
