...
MoneyGoWhere is a desktop application mainly targeted to students in National University of Singapore(NUS), who often have troubles managing their finance.
