...
Refer to the source code, the main overarching method is `executeCommand(String commandText)` in `MainWindow`,
in particular:
...
Here is the general sequence of steps taken by SMLJ in generating the chart:
