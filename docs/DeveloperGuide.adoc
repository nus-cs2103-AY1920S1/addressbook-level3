...
In the case of `loan paid 1 3 4`, `LoansManager#updateLoanStatus` is called once for each of the three loans.
...
.. Repeat from step i. until the sub-group contains less than two persons.
