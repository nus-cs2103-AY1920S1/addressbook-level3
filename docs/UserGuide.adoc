...
* `view a/1` +
Views the activity with ID 1, e.g. ChaletOK UG
* `view c/2` +
...
What you will see instead is that it is striked out.
...
CAUTION: This operation is very dangerous! The person might be included in expenses or other activities -- in that case, an error will be generated and the application will reset.G
