...
|`* * *` |driver manager |view all unfinished delivery tasks |know which tasks have yet to be delivered

|`* * *` |driver manager |view all delivered tasks |keep track of all delivered tasks in the past month

|`* * *` |driver manager |sort and display delivery tasks by their starting time |view pending tasks in an orderly manner

|`* * *` |driver Manager |search for tasks by a keyword |find a task more easily

|`* *` |driver Manager |toggle dark or light theme for the interface | the UI can change according to user preference.

|`*` |driver Manager |see the image of the drivers |can identify them easily
|=======================================================================
