...
import static seedu.jarvis.logic.commands.CommandTestUtil.ADDRESS_DESC_BOB;
...
import static seedu.jarvis.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
...
import static seedu.jarvis.logic.commands.CommandTestUtil.INVALID_TAG_DESC;
import static seedu.jarvis.logic.commands.CommandTestUtil.NAME_DESC_AMY;
import static seedu.jarvis.logic.commands.CommandTestUtil.NAME_DESC_BOB;
...
import static seedu.jarvis.logic.commands.CommandTestUtil.PREAMBLE_NON_EMPTY;
import static seedu.jarvis.logic.commands.CommandTestUtil.PREAMBLE_WHITESPACE;
import static seedu.jarvis.logic.commands.CommandTestUtil.TAG_DESC_FRIEND;
import static seedu.jarvis.logic.commands.CommandTestUtil.TAG_DESC_HUSBAND;
...
public class AddAddressCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddAddressCommand(expectedPerson));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, new AddAddressCommand(expectedPersonMultipleTags));
    }
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY,
                new AddAddressCommand(expectedPerson));
    }

    @Test
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddAddressCommand.MESSAGE_USAGE);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                ...
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddAddressCommand.MESSAGE_USAGE));
    }
}
