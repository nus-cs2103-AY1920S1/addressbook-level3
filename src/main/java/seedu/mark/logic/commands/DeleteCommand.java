...
/**
 * Deletes a bookmark identified using it's displayed index from the address book.
 */
public class DeleteCommand extends Command {
    ...
    public static final String MESSAGE_DELETE_PERSON_SUCCESS = "Deleted Bookmark: %1$s";
