...
For all predefined strings that match the input text, they are sorted according to their "closeness", and a maximum of 5 is displayed.
...
To achieve this, the underlying data structure used is a directed `Graph` with every `Node` storing a reference to a set of values,
...
1. Actor adds order to the system. SML displays the new order list.
...
.. Test case: `generate-s s/revenue d1/2018.12.13 d2/2019.11.13`
    Expeeted: Chart is displayed in pop-up window
