...
If the specified contact does not exist in the contact list, then the contact will not be added and a warning message indicating non-unique search result will be shown instead.
...
If the specified contact does not exist in the current activity, then the contact will not be removed and a warning message indicating that the contact does not exist in the current activity will be shown instead.
If the specified contact is involved in an expense, he cannot be removed since either people will owing him money or he will be owing people money and a warning message indicating that he/she is involved in an expense will be shown.
