...
image::interactive_parsing_1.png[height='125' width="520"]
...
image::interactive_parsing_2.png[height='125' width='520']

.Typee's response to the above input.
image::interactive_parsing_3.png[height='125' width='520']
...
image::interactive_parsing_4.png[height='125' width='520']

.Typee's response to the invalid input.
image::interactive_parsing_5.png[height='125' width='520']
