...
|`* * *` |secretary under a busy manager |find specific appointments |schedule meetings/appointments efficiently
...
|`*` |highly driven secretary |practise typing |improve my efficiency during work

|`*` |bored secretary |keep myself entertained|
...
[none]
** 2a1. System displays the list of appointments in specified order
...
3.  System finds and displays the list of relevant appointment(s)
+
Use case ends.
...
[discrete]
=== Use case: (UC05) Exit application ('bye')
...
//
[discrete]
=== Use case: (UC07) Update modified Appointment data (Save)
*MSS*

1. User make changes of the appointment via C.R.U.D
2. System updates the change in the appointment list to the external text file
3. System displays the updated appointment list in the main window
+
Use case ends.
...
[discrete]
=== Use case: (UC11) Switch to 'Calendar' view mode

//Updated by Jun Hao
[discrete]
=== Use case: (UC12) Typing game

*MSS*

1.  User requests to start the typing game
2.  Typing game shows the user the word(s) to type for a period of time
3.  User types the word(s) within the period of time
4.  Typing game updates the User's score and life points accordingly.
Steps 2-4 are repeated for as many rounds as required until User runs out of life points.
...
[discrete]
=== Use case: (UC13) Checking spelling errors

[discrete]
//Updated by Ko Gi Hun 30/09/19
=== Use case: (UC14) Generate appointment document in PDF format
*MSS*

1. User requests to list appointments
2. System displays the list of appointments
3. User request for generate PDF of an appointment, providing the index number
4. System generates a PDF file in a specific external directory
...
*Extensions*
[none]
* 4a. System fails to generate PDF
[none]
