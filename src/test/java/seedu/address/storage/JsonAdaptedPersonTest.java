...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_USERNAME = "xXsl@y3rXx";
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_USERNAME, VALID_PASSWORD, VALID_TAGS);
    ...
    public void toModelType_invalidUsername_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                INVALID_USERNAME, VALID_PASSWORD, VALID_TAGS);
    ...
    public void toModelType_nullUsername_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                null, VALID_PASSWORD, VALID_TAGS);
    ...
    public void toModelType_invalidPassword_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_USERNAME, INVALID_PASSWORD, VALID_TAGS);
    ...
    public void toModelType_nullPassword_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_USERNAME, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_USERNAME, VALID_PASSWORD, invalidTags);
