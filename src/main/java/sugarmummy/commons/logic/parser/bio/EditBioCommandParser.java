package sugarmummy.commons.logic.parser.bio;

import static java.util.Objects.requireNonNull;
import static sugarmummy.commons.core.Messages.MESSAGE_INCONSISTENT_SUBARGUMENT_INDEX;
import static sugarmummy.commons.core.Messages.MESSAGE_INVALID_COMMAND_FORMAT;
import static sugarmummy.commons.core.Messages.MESSAGE_INVALID_SUBARGUMENT_INDEX;
...
public class EditBioCommandParser implements Parser<EditBioCommand> {
    ...
    /**
     * Returns whether or not given stringList contains indexes. Ensures that presence of indexing given for each type
     * of prefix is consistent.
     *
     * @param stringList List of strings representing tokens for given prefixes.
     ...
     *
     * @param subArgs String containing items representing a one-based index and value to be validated respectively.
    ...
    /**
     * Parses the given {@code String} of arguments in the context of the EditBioCommand and returns an EditBioCommand
    ...
    /**
     * Parses {@code Collection<String> phones} into a {@code List<Phone>} if {@code phones} is non-empty. If {@code
     * phones} contain only one element which is an empty string, it will be parsed into a {@code List<Phone>}
     * containing zero phones.
     */
    ...
    /**
     * Parses {@code Collection<String> medicalConditions} into a {@code List<MedicalCondition>} if {@code
     * medicalConditions} is non-empty. If {@code medicalConditions} contain only one element which is an empty string,
    ...
    /**
     * Parses {@code Collection<String> goals} into a {@code List<Goal>} if {@code goals} is non-empty. If {@code goals}
     * contain only one element which is an empty string, it will be parsed into a {@code List<Goal>} containing zero
     * goals.
     */
