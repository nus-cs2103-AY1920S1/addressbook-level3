...
image::SavingsDisplay.png[width=400]
...
image::SavingsAdded.png[width=300]

.Example success message that appears after keying a successful saving.
image::SavingsSuccessMessage.png[width=300]
...
image::PurchaseHistory.png[width = 400]
