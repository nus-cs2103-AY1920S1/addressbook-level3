= NUStudy – portfolio for Jeremy Tan (Parcly Taxel)
...
* Whenever I could, I fixed bugs assigned to teammates other than me, e.g.
...
graphics-related objects required me to make certain critical decisions on the implementation of image support.

'''

include::../DeveloperGuide.adoc[tag=lecimagedesignconsiderations]
