...
Typee is an engagement management application, where users can manage engagements and schedule accordingly. Our main users are targeted in corporation's receptionists and secretaries
whose main tasks is to manage and arrange engagements.

.default window of Typee upon start-up
image::ppp_nordic96/ppp_1.png[width="550"]
...
*** Wrote additional tests for existing features to increase coverage by roughly 7% (Pull requests https://github.com/AY1920S1-CS2103T-F14-3/main/pull/201[#201], https://github.com/AY1920S1-CS2103T-F14-3/main/pull/200[#200])
** Documentation:
