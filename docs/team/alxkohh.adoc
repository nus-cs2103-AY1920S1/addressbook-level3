...
*** Modified AB3's `help` command to provide user with a quick overview of all commands used in Duke Academy (https://github.com/AY1920S1-CS2103T-F14-1/main/pull/175[#175])
** Documentation:
...
*** Contributed to the Developer Guide for Ui component, `dashboard`, `bookmark`, `deletebookmark`, `help` (https://github.com/AY1920S1-CS2103T-F14-1/main/pull/79[#79])
** Tools:
