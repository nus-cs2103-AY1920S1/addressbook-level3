...
*A*: Download the FlashCard Pro app on another computer. Copy the desired deck's JSON file into a folder and import. Refer to <<Importing flashcards from disk : `import`>> for more information.
