...
that no matter how small the event's duration is, it must still fit and not cause distortion in the schedule graphic. Lastly, I had to test my feature using TestFX to make sure that the graphic generated is correct.
...
page to make significant cosmetic improvement to the application. #86 #93 #125 #254
