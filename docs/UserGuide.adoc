...
Edits an existing book in the address book. +
...
* When editing genres, the existing genres of the book will be removed i.e adding of genres is not cumulative.
* You can remove all the book's genres by typing `t/` without specifying any genres after it.
****

Examples:

* `edit 1 p/91234567 e/johndoe@example.com` +
Edits the serialNumber number and author address of the 1st book to be `91234567` and `johndoe@example.com` respectively.
* `edit 2 n/Betsy Crower t/` +
Edits the title of the 2nd book to be `Betsy Crower` and clears all existing genres.
...
* `find Betsy Tim John` +
Returns any book having names `Betsy`, `Tim`, or `John`
...
* `list` +
`delete 2` +
Deletes the 2nd book in the address book.
* `find Betsy` +
`delete 1` +
