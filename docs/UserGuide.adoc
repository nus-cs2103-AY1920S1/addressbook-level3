...
image::health_overview.jpeg[width="900"]
...
image::health_details.jpeg[width="900"]
...
. Enter the command in the command box and hit the kbd:[Enter] key.
+
image::health_listRecord_before.jpeg[]
+
...
+
image::health_listRecord_after.jpeg[]
...
. Enter the command in the command box and hit the kbd:[Enter] key.
+
image::health_addRecord_before.jpeg[]
+
...
+
image::health_addRecord_after.jpeg[]
...
. Enter the command in the command box and hit the kbd:[Enter] key.
+
image::health_editRecord_before.jpeg[]
+
...
+
image::health_editRecord_after.jpeg[]
...
. Enter the command in the command box and hit the kbd:[Enter] key.
+
image::health_deleteRecord_before.jpeg[]
+
...
+
image::health_deleteRecord_after.jpeg[]
