...
public class AddCommandIntegrationTest {
    ...
    @BeforeEach
    public void setUp() {
        model = new ModelManager(getTypicalExpenseList(), getTypicalBudgetList(), getTypicalExchangeData(), new UserPrefs());
    }
    ...
    //
    //        Model expectedModel = new ModelManager(model.getExpenseList(), getTypicalBudgetList(), model.getExchangeData(), new UserPrefs());
