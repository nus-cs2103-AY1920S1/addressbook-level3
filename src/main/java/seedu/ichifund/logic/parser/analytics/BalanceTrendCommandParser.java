 ...
 */
public class BalanceTrendCommandParser implements Parser<BalanceTrendCommand> {
     ...
     */
    public BalanceTrendCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_YEAR);

        if (!argMultimap.getPreamble().isEmpty()) {
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, BalanceTrendCommand.MESSAGE_USAGE));
        }
        Year year = null;
        ...
        return new BalanceTrendCommand(optionalYear);
    }
}
