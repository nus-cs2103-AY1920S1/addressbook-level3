...
1. You want to tag the entry displayed at index 8 with the tag _Debt_.
2. You run `tag i/8 t/Debt`.

Expected output:

NOTE: Assume entry at index 8 of the list displayed on the GUI is +
`[-] Student Loan ($12,000.00) Date: 10/10/2019 Remarks:  Tags:`
....
Updated Transaction: [-] Student Loan ($12,000.00) Date: 10/10/2019 Remarks:  Tags: [Debt]

Original: [-] Student Loan ($12,000.00) Date: 10/10/2019 Remarks:  Tags:
....
...
1. You want to untag the tag _Important_ from the entry displayed at index 7.
2. You run `untag i/7 t/Important`.

**Expected output:**

NOTE: Assume entry at index 7 of the list displayed on the GUI is +
`[-]  DoTA Arcanas ($49.00) Date: 10/10/2019 Remarks:  Tags: [Game][Important]`
....
Updated Transaction: [-]  DoTA Arcanas ($49.00) Date: 10/10/2019 Remarks:  Tags: [Game]

Original: [-]  DoTA Arcanas ($49.00) Date: 10/10/2019 Remarks:  Tags: [Game][Important]
....
// end::untag[]
...
2. You run `convert v/1000 c/USD`.

**Expected output:**
....
Converting from SGD1,000.00
To USD: USD726.28
....
// end::convert[]
