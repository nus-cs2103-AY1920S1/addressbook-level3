...
This feature works in two parts. The first is centered around the commands itself and the second are the parameters that a command accepts. In both cases, users can use the same keyboard keys to select and autocomplete the commands and parameters.
+
{nbsp} +
