...
image::SaveSequenceDiagram.png[width=600]
...
The following sequence diagram shows how the making of a withdrawal works:

ADD SEQUENCE DIAGRAM HERE

The following activity diagram summarises what happens when a user wishes to withdraw $10 from his savings account:
...
The following sequence diagram shows how the displaying of only savings/withdrawals works:

ADD SEQUENCE DIAGRAM HERE

The following activity diagram summarises what happens when a user requests to only view his savings:
