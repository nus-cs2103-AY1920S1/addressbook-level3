...
public class AddDiaryCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        CommandParserTestUtil.assertParseSuccess(parser, CommandTestUtil.PREAMBLE_WHITESPACE + CommandTestUtil.NAME_DESC_BOB, new AddDiaryCommand(expectedDiary));

        // multiple names - last name accepted
        CommandParserTestUtil.assertParseSuccess(parser, CommandTestUtil.NAME_DESC_AMY + CommandTestUtil.NAME_DESC_BOB, new AddDiaryCommand(expectedDiary));
    }
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        CommandParserTestUtil.assertParseSuccess(parser, CommandTestUtil.NAME_DESC_AMY, new AddDiaryCommand(expectedDiary));
    }
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.INVALID_NAME_DESC, DiaryName.MESSAGE_CONSTRAINTS);
        ...
        CommandParserTestUtil.assertParseFailure(parser, CommandTestUtil.PREAMBLE_NON_EMPTY + CommandTestUtil.NAME_DESC_BOB,
                String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT, AddDiaryCommand.MESSAGE_USAGE));
    }
}
