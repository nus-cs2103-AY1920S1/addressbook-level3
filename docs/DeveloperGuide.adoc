...
(For all use cases below, the *System* is the `Financial Tracker` and the *Actor* is the `user`, unless specified otherwise)
...
2.  Financial tracker shows a list of recent expenses
3.  User requests to tag a specific expense in the list
4.  Financial tracker tags the specific expense with the input tag name
+
Use case ends.
...
+
[none]
** 2a1. Financial tracker displays an empty list
+
Use case ends.
...
+
[none]
** 3a1.  Financial Tracker shows an error message.
+
...
2. Financial tracker shows a list of tags
3. User requests to filter expenses by specific tag
4. Financial tracker shows a list of recent expenses under the specific tag.
+
Use case ends.
...
4. Financial Tracker shows a list of archives
5. User requests to add a specific expense into a specific archive
6. Financial Tracker removes the specific  expense from list of current records and adds it to the specific  archive
+
Use case ends.
...
+
[none]
** 4a1.  Financial Tracker shows an empty list.
+
Use case ends.
...
+
[none]
** 5a1.  Financial Tracker shows an error message.
+
...
2. Financial Tracker shows a list of expenses under the specific archive
3. User requests to delete a specific expense from the archive
4. Financial Tracker deletes the specific  expense from the specific  archive.
+
Use case ends.
...
+
[none]
** 2b1.  Financial Tracker shows an error.
+
Use case ends.
...
2. Financial Tracker shows a list of all existing archives
3. User requests to delete a specific archive from the list
4. Financial Tracker deletes the specific archive
...
+
[none]
** 3a1.  Financial Tracker shows an error.
+
Use case resumes at step 2.
...
2. Financial Tracker displays a list of records that contains the specified keyword
+
Use case ends.
