...
_`question question/How many sheeps? answer/5 type/mcq a/1 b/2 c/4 d/5` - creates an mcq question._
...
*Step 2.* Open the folder and double click the html file.

image::QuizHtml.png[]

*Step 3.* The quiz should be in the format displayed below:
