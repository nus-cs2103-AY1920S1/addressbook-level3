...
Undo the previous command. All commands except switch, find, list and history commands are undoable. +
...
==== Redo : `redo`
Redo the previous undone command. Inverse of undo. All commands except switch, find, list and history commands are undoable. +
