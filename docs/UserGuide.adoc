...
You can list all entries of bodies, workers, or fridges by entering a list command with the given format below.
...
You can generate an individual report in a PDF filename `[subheader]#Report <body_ID>.pdf#` located in the folder containing the jar file by entering a genReport command with the given format below.
...
You can generate all individual reports in a PDF filename `[subheader]#Report (ALL BODIES).pdf#` located in the folder containing the jar file by entering a genReports command with the given format below.
...
You can generate a tabular report overview containing key information for all bodies in a PDF filename `[subheader]#Report Summary.pdf#` located in the folder containing the jar file by entering a genReportSummary command with the given format below.
