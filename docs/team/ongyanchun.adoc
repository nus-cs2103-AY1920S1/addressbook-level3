...
* *Minor enhancements*: added a history command that allows the user to navigate to previous commands using up/down keys.
...
** Handled most of the overall GUI design, apart from the Result Display on the left side.
...
*** Spearheaded the conversion of GUI from AddressBook (Pull requests #120, #130, #146, #150, #153, #169)
*** Wrote tests.
** Documentation:
