...
* *Minor enhancement*: added a backend context feature that allows for various application contexts and contextual behaviour for various commands.
...
** Documentation:
*** Did the initial revamp of our User Guide: https://github.com[#14]
*** Updated some UML diagrams for the Developer Guide
** Community:
*** PRs reviewed: https://github.com[#12], https://github.com[#32], https://github.com[#19], https://github.com[#42]
*** Offer suggestions for other teams in the class (examples:  https://github.com[1], https://github.com[2], https://github.com[3])
