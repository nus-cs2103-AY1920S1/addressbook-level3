...
image::fillCommandNoParamsAfterScreenshot.png[width="600"]
...
* Usage and outcome:
Usage: `fill 1 p/90309049 desc/Traffic accident reported at FKU hospital junction` +
Outcome:

image::fillCommandWithParamsAfterScreenshot.png[width="600"]
...
image::submitCommandNoParamsAfterScreenshot.png[width="600"]
...
image::submitCommandWithParamsAfterScreenshot.png[width="600"]
