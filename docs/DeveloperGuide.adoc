...
`EventFactory` -- An Event object is generated by the EventFactory after executing the Command. +
|===
...
*Step 2.* The `UndoableCommand` is executed, generating the `CommandResult`.
