...
the "Pending To Pay" value may become negative. You may not pay an employee who's current pending pay is negative,
until the 'undo_pay' command is executed to reset the pending payment value to >= 0.
****
