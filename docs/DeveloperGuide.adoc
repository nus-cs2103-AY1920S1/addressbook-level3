...
[NOTE]
If the input file is not formatted as specified in the user guide, a ‘ParseException’ would be thrown to show error message as the result. No new window is opened.
