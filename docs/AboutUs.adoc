...
Role: Team Lead
{empty} Responsibilities: Team Lead, IntelliJ/Git Expert
...
Role: Developer
{empty} Responsibilities: Code Quality
...
Role: Developer
{empty} Responsibilities: Documentation
...
Role: Developer
{empty} Responsibilities: Integration, Scheduling and Tracking, JavaFX expert
...
Role: Developer
{empty} Responsibilities: Testing, Deliverables and Deadlines
