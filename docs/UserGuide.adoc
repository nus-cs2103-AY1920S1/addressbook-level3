...
This command brings you to the project dashboard page +
Format: `home`
...
==== Gets statistics of members: `member-stats` +
To get statistics relating to the members in +Work, use the command following the format below. +
Format: `member-stats`

Calling the 'member-stats' command will result in the following: 
image::member_stats.png[width="790"]

==== Gets statistics of tasks: `task-stats` +
To get statistics relating to the tasks in +Work, use the command following the format below. +
Format: `task-stats`

Calling the 'task-stats' command will result in the following: 
image::task_stats.png[width="790"] 
