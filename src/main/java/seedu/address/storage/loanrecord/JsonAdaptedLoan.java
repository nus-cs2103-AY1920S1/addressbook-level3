    ...
    public Loan toModelType() throws IllegalValueException {
        ...
        if (userName == null) {
            throw new IllegalValueException(String.format(
                MISSING_FIELD_MESSAGE_FORMAT, userName.class.getSimpleuserName()));
        }
        ...
        if (serialNumber == null) {
            throw new IllegalValueException(String.format(
                MISSING_FIELD_MESSAGE_FORMAT, serialNumber.class.getSimpleuserName()));
        }
        ...
        if (loanDateTime == null) {
            throw new IllegalValueException(String.format(
                MISSING_FIELD_MESSAGE_FORMAT, loanDateTime.class.getSimpleuserName()));
        }
        ...
        if (dueDateTime == null) {
            throw new IllegalValueException(String.format(
                MISSING_FIELD_MESSAGE_FORMAT, dueDateTime.class.getSimpleuserName()));
        }
        ...
        if (returnedDateTime == null) {
            throw new IllegalValueException(String.format(
                MISSING_FIELD_MESSAGE_FORMAT, returnedDateTime.class.getSimpleuserName()));
        }
