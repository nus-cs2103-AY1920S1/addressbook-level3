 ...
 */
public class MonthlyExpenditureRankingCommand extends TrendCommand {

    public static final String COMMAND_WORD = "mthrank";

    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Displays expenditure ranking chart by month for the "
            + "year specified, or current year if year is unspecified."
            + "Parameters: "
            + "[" + PREFIX_YEAR + "YEAR] "
            + "Example: " + COMMAND_WORD + " "
            + PREFIX_YEAR + "2019 ";

    public static final String MESSAGE_SUCCESS = "Expenditure ranking chart by month for %1$s displayed.";

    public static final String REPORT_DESCRIPTION = "Total expenditure for %1$s %2$s";

    /**
     * Constructs a {@code MonthlyExpenditureRankingCommand}.
     *
     * @param year A year.
     */
    public MonthlyExpenditureRankingCommand(Optional<Year> year) {
        super(year);
    }
     ...
     */
    private void fillMonthlyExpenditureRankingReport(Model model, TrendReport report) {
