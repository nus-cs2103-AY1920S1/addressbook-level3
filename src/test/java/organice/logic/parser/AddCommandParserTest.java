...
public class AddCommandParserTest {
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, TYPE_DESC_PATIENT_IRENE + NAME_DESC_PATIENT_IRENE + VALID_NRIC_PATIENT_IRENE
                + PHONE_DESC_PATIENT_IRENE + AGE_DESC_PATIENT_IRENE + PRIORITY_DESC_PATIENT_IRENE, expectedMessage);
        ...
        assertParseFailure(parser, TYPE_DESC_PATIENT_IRENE + NRIC_DESC_PATIENT_IRENE + NAME_DESC_PATIENT_IRENE
                + VALID_PHONE_PATIENT_IRENE + AGE_DESC_PATIENT_IRENE + PRIORITY_DESC_PATIENT_IRENE, expectedMessage);
        ...
        assertParseFailure(parser, TYPE_DESC_PATIENT_IRENE + NRIC_DESC_PATIENT_IRENE + NAME_DESC_PATIENT_IRENE
                + PHONE_DESC_PATIENT_IRENE + VALID_AGE_PATIENT_IRENE + PRIORITY_DESC_PATIENT_IRENE, expectedMessage);

        // missing priority prefix -- patient
        assertParseFailure(parser, TYPE_DESC_PATIENT_IRENE + NRIC_DESC_PATIENT_IRENE + NAME_DESC_PATIENT_IRENE
                + PHONE_DESC_PATIENT_IRENE + AGE_DESC_PATIENT_IRENE + VALID_PRIORITY_PATIENT_IRENE, expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, TYPE_DESC_PATIENT_IRENE + NRIC_DESC_PATIENT_IRENE + NAME_DESC_PATIENT_IRENE
                + INVALID_PHONE_DESC + AGE_DESC_PATIENT_IRENE + PRIORITY_DESC_PATIENT_IRENE, Phone.MESSAGE_CONSTRAINTS);
        ...
        // invalid age -- patient
        assertParseFailure(parser, TYPE_DESC_PATIENT_IRENE + NRIC_DESC_PATIENT_IRENE + NAME_DESC_PATIENT_IRENE
                + PHONE_DESC_PATIENT_IRENE + INVALID_AGE_DESC + PRIORITY_DESC_PATIENT_IRENE, Age.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, TYPE_DESC_PATIENT_BOB + NRIC_DESC_PATIENT_BOB + INVALID_NAME_DESC
                + INVALID_PHONE_DESC + AGE_DESC_PATIENT_BOB + PRIORITY_DESC_PATIENT_BOB, Name.MESSAGE_CONSTRAINTS);
